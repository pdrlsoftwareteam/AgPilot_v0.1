...
class RSTEmit(Emit):
    def blurb(self):
        return """This is a complete list of the parameters which can be set (e.g. via the AGPILOTLink protocol) to control vehicle behaviour. They are stored in persistent storage on the vehicle.
