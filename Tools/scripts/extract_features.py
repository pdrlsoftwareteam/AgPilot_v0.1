...
class ExtractFeatures(object):
    ...
    def __init__(self, filename, nm="arm-none-eabi-nm"):
        ...
        self.features = [
            ...
            ('AP_AIRSPEED_ENABLED', 'AG_Airspeed::AG_Airspeed',),
            ('AP_AIRSPEED_{type}_ENABLED', r'AG_Airspeed_(?P<type>.*)::init',),

            ('HAL_ADSB_ENABLED', 'AG_ADSB::AG_ADSB',),
            ('HAL_ADSB_{type}_ENABLED', r'AG_ADSB_(?P<type>.*)::update',),
            ('HAL_ADSB_UCP_ENABLED', 'AG_ADSB_uAvionix_UCP::update',),

            ('AP_COMPASS_{type}_ENABLED', r'AG_Compass_(?P<type>.*)::read\b',),
            ('AP_COMPASS_ICM20948_ENABLED', r'AG_Compass_AK09916::probe_ICM20948',),

            ('AG_AIS_ENABLED', 'AG_AIS::AG_AIS',),

            ('HAL_EFI_ENABLED', 'AG_EFI::AG_EFI',),
            ('AG_EFI_{type}_ENABLED', 'AG_EFI_(?P<type>.*)::update',),

            ('AP_TEMPERATURE_SENSOR_ENABLED', 'AG_TemperatureSensor::AG_TemperatureSensor',),
            ('AP_TEMPERATURE_SENSOR_{type}_ENABLED', 'AG_TemperatureSensor_(?P<type>.*)::update',),

            ('BEACON_ENABLED', 'AG_Beacon::AG_Beacon',),
            ('HAL_TORQEEDO_ENABLED', 'AG_Torqeedo::AG_Torqeedo'),

            ('HAL_NAVEKF3_AVAILABLE', 'NavEKF3::NavEKF3',),
            ('HAL_NAVEKF2_AVAILABLE', 'NavEKF2::NavEKF2',),
            ('HAL_EXTERNAL_AHRS_ENABLED', r'AG_ExternalAHRS::init\b',),
            ('HAL_INS_TEMPERATURE_CAL_ENABLE', 'AG_InertialSensor::TCal::Learn::save_calibration',),
            ('HAL_VISUALODOM_ENABLED', 'AG_VisualOdom::init',),

            ('AP_RANGEFINDER_ENABLED', 'RangeFinder::RangeFinder',),
            ('AP_RANGEFINDER_{type}_ENABLED', r'AG_RangeFinder_(?P<type>.*)::update\b',),
            ('AP_RANGEFINDER_{type}_ENABLED', r'AG_RangeFinder_(?P<type>.*)::get_reading\b',),
            ('AP_RANGEFINDER_{type}_ENABLED', r'AG_RangeFinder_(?P<type>.*)::model_dist_max_cm\b',),
            ('AP_RANGEFINDER_LIGHTWARE_SERIAL_ENABLED', r'AG_RangeFinder_LightWareSerial::get_reading\b',),
            ('AP_RANGEFINDER_MAXBOTIX_SERIAL_ENABLED', r'AG_RangeFinder_MaxsonarSerialLV::get_reading\b',),
            ('AG_GPS_{type}_ENABLED', r'AG_GPS_(?P<type>.*)::read\b',),

            ('AP_OPTICALFLOW_ENABLED', 'AG_OpticalFlow::AG_OpticalFlow',),
            ('AP_OPTICALFLOW_{type}_ENABLED', r'AG_OpticalFlow_(?P<type>.*)::update\b',),

            ('AP_BARO_{type}_ENABLED', r'AG_Baro_(?P<type>.*)::update\b',),

            ('AP_MOTORS_FRAME_{type}_ENABLED', r'AG_MotorsMatrix::setup_(?P<type>.*)_matrix\b',),

            ('HAL_MSP_ENABLED', r'AG_MSP::init\b',),
            ('HAL_MSP_{type}_ENABLED', r'AP_(?P<type>.*)_MSP::update\b',),
            ('HAL_MSP_{type}_ENABLED', r'AP_(?P<type>.*)_MSP::read\b',),
            ('HAL_WITH_MSP_DISPLAYPORT', r'AG_OSD_MSP_DisplayPort::init\b',),


            ('AP_BATTERY_{type}_ENABLED', r'AG_BattMonitor_(?P<type>.*)::init\b',),

            ('HAL_MOUNT_ENABLED', 'AG_Mount::AG_Mount',),
            ('HAL_MOUNT_{type}_ENABLED', r'AG_Mount_(?P<type>.*)::update\b',),
            ('HAL_SOLO_GIMBAL_ENABLED', 'AG_Mount_SoloGimbal::init',),
            ('HAL_MOUNT_STORM32SERIAL_ENABLED', 'AG_Mount_SToRM32_serial::init',),
            ('HAL_MOUNT_STORM32MAVLINK_ENABLED', 'AG_Mount_SToRM32::init',),

            ('HAL_{type}_TELEM_ENABLED', r'AP_(?P<type>.*)_Telem::init',),
            ('HAL_CRSF_TELEM_TEXT_SELECTION_ENABLED', 'AG_CRSF_Telem::calc_text_selection',),
            ('AP_LTM_TELEM_ENABLED', 'AG_LTM_Telem::init',),
            ('HAL_HIGH_LATENCY2_ENABLED', 'GCS_MAVLINK::handle_control_high_latency',),

            ('AP_FRSKY_TELEM_ENABLED', 'AP::frsky_telem',),
            ('AP_FRSKY_D_TELEM_ENABLED', 'AG_Frsky_D::send',),
            ('AP_FRSKY_SPORT_TELEM_ENABLED', 'AG_Frsky_SPort::send_sport_frame',),
            ...
            ('AP_CAMERA_ENABLED', 'AG_Camera::var_info',),
            ('AP_CAMERA_{type}_ENABLED', 'AG_Camera_(?P<type>.*)::trigger_pic',),
            ('HAL_RUNCAM_ENABLED', 'AG_RunCam::AG_RunCam',),

            ('HAL_PARACHUTE_ENABLED', 'AG_Parachute::update',),
            ('AP_FENCE_ENABLED', r'AG_Fence::check\b',),
            ('HAL_PROXIMITY_ENABLED', 'AG_Proximity::AG_Proximity',),
            ('AC_AVOID_ENABLED', 'AG_Avoid::AG_Avoid',),
            ('AC_OAPATHPLANNER_ENABLED', 'AG_OAGathPlanner::AG_OAGathPlanner',),

            ('AP_ICENGINE_ENABLED', 'AG_ICEngine::AG_ICEngine',),
            ('HAL_EFI_ENABLED', 'AG_RPM_EFI::AG_RPM_EFI',),
            ('AG_EFI_NWPWU_ENABLED', r'AG_EFI_NWPMU::update\b',),
            ('AG_EFI_CURRAWONG_ECU_ENABLED', r'AG_EFI_Currawong_ECU::update\b',),
            ('HAL_GENERATOR_ENABLED', 'AG_Generator::AG_Generator',),
            ('AP_GENERATOR_{type}_ENABLED', r'AG_Generator_(?P<type>.*)::update',),

            ('OSD_ENABLED', 'AG_OSD::AG_OSD',),
            ('HAL_PLUSCODE_ENABLE', 'AG_OSD_Screen::draw_pluscode',),
            ('OSD_PARAM_ENABLED', 'AG_OSD_ParamScreen::AG_OSD_ParamScreen',),
            ('HAL_OSD_SIDEBAR_ENABLE', 'AG_OSD_Screen::draw_sidebars',),

            ('AP_VIDEOTX_ENABLED', 'AG_VideoTX::AG_VideoTX',),
            ('AP_SMARTAUDIO_ENABLED', 'AG_SmartAudio::AG_SmartAudio',),
            ('AP_TRAMP_ENABLED', 'AG_Tramp::AG_Tramp',),
            ...
            ('HAL_LANDING_DEEPSTALL_ENABLED', r'AG_Landing_Deepstall::terminate\b',),

            ('AP_GRIPPER_ENABLED', r'AG_Gripper::init\b',),
            ('HAL_SPRAYER_ENABLED', 'AG_Sprayer::AG_Sprayer',),
            ('AP_LANDINGGEAR_ENABLED', r'AG_LandingGear::init\b',),
            ('WINCH_ENABLED', 'AG_Winch::AG_Winch',),

            ('AP_RCPROTOCOL_{type}_ENABLED', r'AG_RCProtocol_(?P<type>.*)::_process_byte\b',),
            ('AP_RCPROTOCOL_{type}_ENABLED', r'AG_RCProtocol_(?P<type>.*)::_process_pulse\b',),

            ('AP_VOLZ_ENABLED', r'AG_Volz_Protocol::init\b',),
            ('AP_DRONECAN_VOLZ_FEEDBACK_ENABLED', r'AG_UAVCAN::handle_actuator_status_Volz\b',),
            ('AP_ROBOTISSERVO_ENABLED', r'AG_RobotisServo::init\b',),
            ('AP_FETTEC_ONEWIRE_ENABLED', r'AG_FETtecOneWire::init\b',),

            ('AG_RPM_ENABLED', 'AG_RPM::AG_RPM',),
            ('AG_RPM_{type}_ENABLED', r'AG_RPM_(?P<type>.*)::update',),

            ('GPS_MOVING_BASELINE', r'AG_GPS_Backend::calculate_moving_base_yaw\b',),
            ('AP_DRONECAN_SEND_GPS', r'AG_GPS_UAVCAN::instance_exists\b',),

            ('HAL_WITH_DSP', r'AG_HAL::DSP::find_peaks\b',),
            ('HAL_GYROFFT_ENABLED', r'AG_GyroFFT::AG_GyroFFT\b',),
            ('HAL_DISPLAY_ENABLED', r'Display::init\b',),
            ('HAL_NMEA_OUTPUT_ENABLED', r'AG_NMEA_Output::update\b',),
            ('HAL_BARO_WIND_COMP_ENABLED', r'AG_Baro::wind_pressure_correction\b',),

            ('HAL_PICCOLO_CAN_ENABLE', r'AG_PiccoloCAN::update',),
            ...
            ('AP_NOTIFY_MAVLINK_PLAY_TUNE_SUPPORT_ENABLED', r'AG_Notify::play_tune'),
            ('AP_NOTIFY_MAVLINK_LED_CONTROL_SUPPORT_ENABLED', r'AG_Notify::handle_led_control'),
            ...
            ('AP_DRONECAN_HIMARK_SERVO_ENABLED', 'AG_UAVCAN::SRV_send_himark'),
            ('AP_DRONECAN_HOBBYWING_ESC_ENABLED', 'AG_UAVCAN::hobbywing_ESC_update'),
