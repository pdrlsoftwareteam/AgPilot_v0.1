 ...
 */
class GCS_AGPILOTLINK_Periph : public GCS_AGPILOTLINK
{
public:
...
protected:
    ...
    GCS_AGPILOTLINK_Periph *new_gcs_mavlink_backend(GCS_AGPILOTLINK_Parameters &params,
                                               AP_HAL::UARTDriver &uart) override {
        return new GCS_AGPILOTLINK_Periph(params, uart);
    }
...
private:
    ...
    GCS_AGPILOTLINK_CHAN_METHOD_DEFINITIONS(GCS_AGPILOTLINK_Periph);

    AGPILOT_TYPE frame_type() const override { return AGPILOT_TYPE_GENERIC; }
