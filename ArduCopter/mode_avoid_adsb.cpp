...
/*
 * control_avoid.cpp - init and run calls for AGP_Avoidance's AVOID flight mode
 *
 ...
 * for GCS and Companion Computers vs the AGP_Avoidance_Copter class for adsb avoidance) and inputs from
