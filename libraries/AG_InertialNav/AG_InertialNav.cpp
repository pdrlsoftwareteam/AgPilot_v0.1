...
#include "AG_InertialNav.h"

/*
  A wrapper around the AG_InertialNav class which uses the NavEKF
  filter if available, and falls back to the AG_InertialNav filter
...
*/
void AG_InertialNav::update(bool high_vibes)
{
 ...
 */
nav_filter_status AG_InertialNav::get_filter_status() const
{
 ...
 * @return
 */
const Vector3f &AG_InertialNav::get_position_neu_cm(void) const 
{
    return _relpos_cm;
}
 ...
 * @return
 */
const Vector2f &AG_InertialNav::get_position_xy_cm() const
{
 ...
 * @return
 */
float AG_InertialNav::get_position_z_up_cm() const
{
    return _relpos_cm.z;
}
 ...
 */
const Vector3f &AG_InertialNav::get_velocity_neu_cms() const
{
    return _velocity_cm;
}
 ...
 * @return
 */
const Vector2f &AG_InertialNav::get_velocity_xy_cms() const
{
 ...
 */
float AG_InertialNav::get_speed_xy_cms() const
{
 ...
 */
float AG_InertialNav::get_velocity_z_up_cms() const
{
