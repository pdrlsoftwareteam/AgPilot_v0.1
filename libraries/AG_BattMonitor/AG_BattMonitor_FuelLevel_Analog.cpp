...
const AG_Param::GroupInfo AG_BattMonitor_FuelLevel_Analog::var_info[] = {
    ...
    // @Units: V
    // @User: Advanced
    AP_GROUPINFO("FL_VLT_MIN", 40, AG_BattMonitor_FuelLevel_Analog, _fuel_level_empty_voltage, 0.5),
    ...
    // @Range: 0.01 10
    // @User: Advanced
    AP_GROUPINFO("FL_V_MULT", 41, AG_BattMonitor_FuelLevel_Analog, _fuel_level_voltage_mult, 0.5),
    ...
    // @Units: Hz
    // @RebootRequired: True
    AP_GROUPINFO("FL_FLTR", 42, AG_BattMonitor_FuelLevel_Analog, _fuel_level_filter_frequency, 0.3),
    ...
    AP_GROUPINFO("FL_PIN", 43, AG_BattMonitor_FuelLevel_Analog, _pin, -1),
...
// Constructor
AG_BattMonitor_FuelLevel_Analog::AG_BattMonitor_FuelLevel_Analog(AG_BattMonitor &mon, AG_BattMonitor::BattMonitor_State &mon_state, AG_BattMonitor_Params &params) :
...
*/
void AG_BattMonitor_FuelLevel_Analog::read()
{
