...
class AG_BattMonitor_ESC :public AG_BattMonitor_Backend
{
public:
    // constructor. This incorporates initialisation as well.
    AG_BattMonitor_ESC(AG_BattMonitor &mon, AG_BattMonitor::BattMonitor_State &mon_state, AG_BattMonitor_Params &params):
        AG_BattMonitor_Backend(mon, mon_state, params)
    {};

    virtual ~AG_BattMonitor_ESC(void) {};
