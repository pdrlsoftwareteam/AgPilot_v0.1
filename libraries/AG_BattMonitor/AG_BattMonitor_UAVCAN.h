...
class AG_BattMonitor_UAVCAN : public AG_BattMonitor_Backend
{
public:
    ...
    /// Constructor
    AG_BattMonitor_UAVCAN(AG_BattMonitor &mon, AG_BattMonitor::BattMonitor_State &mon_state, BattMonitor_UAVCAN_Type type, AG_BattMonitor_Params &params);
    ...
    static AG_BattMonitor_UAVCAN* get_uavcan_backend(AG_UAVCAN* ap_uavcan, uint8_t node_id, uint8_t battery_id);
    static void handle_battery_info_trampoline(AG_UAVCAN* ap_uavcan, uint8_t node_id, const BattInfoCb &cb);
    static void handle_battery_info_aux_trampoline(AG_UAVCAN* ap_uavcan, uint8_t node_id, const BattInfoAuxCb &cb);
    static void handle_mppt_stream_trampoline(AG_UAVCAN* ap_uavcan, uint8_t node_id, const MpptStreamCb &cb);
...
private:
    ...
    AG_BattMonitor::BattMonitor_State _interim_state;
