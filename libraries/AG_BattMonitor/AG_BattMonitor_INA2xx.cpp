...
const uint8_t AG_BattMonitor_INA2XX::i2c_probe_addresses[] { 0x41, 0x44, 0x45 };

const AG_Param::GroupInfo AG_BattMonitor_INA2XX::var_info[] = {
    ...
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO("I2C_BUS", 25, AG_BattMonitor_INA2XX, i2c_bus, HAL_BATTMON_INA2XX_BUS),
    ...
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO("I2C_ADDR", 26, AG_BattMonitor_INA2XX, i2c_address, HAL_BATTMON_INA2XX_ADDR),
    ...
    // @Units: A
    // @User: Advanced
    AP_GROUPINFO("MAX_AMPS", 27, AG_BattMonitor_INA2XX, max_amps, DEFAULT_BATTMON_INA2XX_MAX_AMPS),
    ...
    // @Units: Ohm
    // @User: Advanced
    AP_GROUPINFO("SHUNT", 28, AG_BattMonitor_INA2XX, rShunt, DEFAULT_BATTMON_INA2XX_SHUNT),

    AP_GROUPEND
};

AG_BattMonitor_INA2XX::AG_BattMonitor_INA2XX(AG_BattMonitor &mon,
...
void AG_BattMonitor_INA2XX::init(void)
{
    ...
    dev->register_periodic_callback(25000, FUNCTOR_BIND_MEMBER(&AG_BattMonitor_INA2XX::timer, void));
}

bool AG_BattMonitor_INA2XX::configure(DevType dtype)
{
    switch (dtype) {
...
void AG_BattMonitor_INA2XX::read(void)
{
...
*/
bool AG_BattMonitor_INA2XX::read_word16(const uint8_t reg, int16_t& data) const
{
...
/*
  ...
  returns true if read was successful, false if failed
*/
bool AG_BattMonitor_INA2XX::read_word24(const uint8_t reg, int32_t& data) const
{
    // read the appropriate register from the device
    uint8_t d[3];
...
*/
bool AG_BattMonitor_INA2XX::write_word(const uint8_t reg, const uint16_t data) const
{
...
/*
  ...
  not plugged in yet
*/
bool AG_BattMonitor_INA2XX::detect_device(void)
{
...
void AG_BattMonitor_INA2XX::timer(void)
{
