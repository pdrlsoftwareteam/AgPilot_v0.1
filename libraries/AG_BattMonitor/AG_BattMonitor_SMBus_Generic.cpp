...
// Constructor
AG_BattMonitor_SMBus_Generic::AG_BattMonitor_SMBus_Generic(AG_BattMonitor &mon,
                                                   AG_BattMonitor::BattMonitor_State &mon_state,
                                                   AG_BattMonitor_Params &params)
    : AG_BattMonitor_SMBus(mon, mon_state, params, AP_BATTMONITOR_SMBUS_BUS_EXTERNAL)
{}

void AG_BattMonitor_SMBus_Generic::timer()
{
...
bool AG_BattMonitor_SMBus_Generic::check_pec_support()
{
