...
#include "AG_BattMonitor_SMBus_Solo.h"
#include "AG_BattMonitor_SMBus_Generic.h"
#include "AG_BattMonitor_SMBus_Maxell.h"
#include "AG_BattMonitor_SMBus_Rotoye.h"
#include "AG_BattMonitor_Bebop.h"
#include "AG_BattMonitor_ESC.h"
#include "AG_BattMonitor_SMBus_SUI.h"
#include "AG_BattMonitor_SMBus_NeoDesign.h"
#include "AG_BattMonitor_Sum.h"
#include "AG_BattMonitor_FuelFlow.h"
#include "AG_BattMonitor_FuelLevel_PWM.h"
#include "AG_BattMonitor_Generator.h"
#include "AG_BattMonitor_EFI.h"
#include "AG_BattMonitor_INA2xx.h"
#include "AG_BattMonitor_INA239.h"
#include "AG_BattMonitor_LTC2946.h"
#include "AG_BattMonitor_Torqeedo.h"
#include "AG_BattMonitor_FuelLevel_Analog.h"
...
#include "AG_BattMonitor_UAVCAN.h"
#endif
...
AG_BattMonitor *AG_BattMonitor::_singleton;

const AG_Param::GroupInfo AG_BattMonitor::var_info[] = {
    // 0 - 18, 20- 22 used by old parameter indexes

    // Monitor 1

    // @Group: _
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[0], "_", 23, AG_BattMonitor, AG_BattMonitor_Params),

    // @Group: _
    // @Path: AG_BattMonitor_Analog.cpp
    // @Group: _
    // @Path: AG_BattMonitor_SMBus.cpp
    // @Group: _
    // @Path: AG_BattMonitor_Sum.cpp
    // @Group: _
    // @Path: AG_BattMonitor_UAVCAN.cpp
    // @Group: _
    // @Path: AG_BattMonitor_FuelLevel_Analog.cpp
    // @Group: _
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[0], "_", 41, AG_BattMonitor, backend_var_info[0]),

#if AP_BATT_MONITOR_MAX_INSTANCES > 1
    // @Group: 2_
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[1], "2_", 24, AG_BattMonitor, AG_BattMonitor_Params),
    ...
    // @Group: 2_
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[1], "2_", 42, AG_BattMonitor, backend_var_info[1]),
#endif

#if AP_BATT_MONITOR_MAX_INSTANCES > 2
    // @Group: 3_
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[2], "3_", 25, AG_BattMonitor, AG_BattMonitor_Params),
    ...
    // @Group: 3_
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[2], "3_", 43, AG_BattMonitor, backend_var_info[2]),
#endif

#if AP_BATT_MONITOR_MAX_INSTANCES > 3
    // @Group: 4_
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[3], "4_", 26, AG_BattMonitor, AG_BattMonitor_Params),
    ...
    // @Group: 4_
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[3], "4_", 44, AG_BattMonitor, backend_var_info[3]),
#endif

#if AP_BATT_MONITOR_MAX_INSTANCES > 4
    // @Group: 5_
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[4], "5_", 27, AG_BattMonitor, AG_BattMonitor_Params),
    ...
    // @Group: 5_
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[4], "5_", 45, AG_BattMonitor, backend_var_info[4]),
#endif

#if AP_BATT_MONITOR_MAX_INSTANCES > 5
    // @Group: 6_
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[5], "6_", 28, AG_BattMonitor, AG_BattMonitor_Params),
    ...
    // @Group: 6_
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[5], "6_", 46, AG_BattMonitor, backend_var_info[5]),
#endif

#if AP_BATT_MONITOR_MAX_INSTANCES > 6
    // @Group: 7_
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[6], "7_", 29, AG_BattMonitor, AG_BattMonitor_Params),
    ...
    // @Group: 7_
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[6], "7_", 47, AG_BattMonitor, backend_var_info[6]),
#endif

#if AP_BATT_MONITOR_MAX_INSTANCES > 7
    // @Group: 8_
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[7], "8_", 30, AG_BattMonitor, AG_BattMonitor_Params),
    ...
    // @Group: 8_
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[7], "8_", 48, AG_BattMonitor, backend_var_info[7]),
#endif

#if AP_BATT_MONITOR_MAX_INSTANCES > 8
    // @Group: 9_
    // @Path: AG_BattMonitor_Params.cpp
    AP_SUBGROUPINFO(_params[8], "9_", 31, AG_BattMonitor, AG_BattMonitor_Params),
    ...
    // @Group: 9_
    // @Path: AG_BattMonitor_Synthetic_Current.cpp
    AP_SUBGROUPVARPTR(drivers[8], "9_", 49, AG_BattMonitor, backend_var_info[8]),
#endif

    AP_GROUPEND
};

const AG_Param::GroupInfo *AG_BattMonitor::backend_var_info[AP_BATT_MONITOR_MAX_INSTANCES];

// Default constructor.
// Note that the Vector/Matrix constructors already implicitly zero
// their values.
//
AG_BattMonitor::AG_BattMonitor(uint32_t log_battery_bit, battery_failsafe_handler_fn_t battery_failsafe_handler_fn, const int8_t *failsafe_priorities) :
    ...
    _failsafe_priorities(failsafe_priorities)
{
    ...
    if (_singleton != nullptr) {
        AG_HAL::panic("AG_BattMonitor must be singleton");
    }
    _singleton = this;
}
...
AG_BattMonitor::init()
{
    ...
    for (uint8_t instance=0; instance<AP_BATT_MONITOR_MAX_INSTANCES; instance++) {
        ...
        switch (get_type(instance)) {
            ...
            case Type::ANALOG_VOLTAGE_AND_CURRENT:
                drivers[instance] = new AG_BattMonitor_Analog(*this, state[instance], _params[instance]);
                break;
#if AP_BATTERY_SMBUS_SOLO_ENABLED
            case Type::SOLO:
                drivers[instance] = new AG_BattMonitor_SMBus_Solo(*this, state[instance], _params[instance]);
                break;
#endif
#if AP_BATTERY_SMBUS_GENERIC_ENABLED
            case Type::SMBus_Generic:
                drivers[instance] = new AG_BattMonitor_SMBus_Generic(*this, state[instance], _params[instance]);
                break;
#endif
#if AP_BATTERY_SMBUS_SUI_ENABLED
            case Type::SUI3:
                drivers[instance] = new AG_BattMonitor_SMBus_SUI(*this, state[instance], _params[instance], 3);
                break;
            case Type::SUI6:
                drivers[instance] = new AG_BattMonitor_SMBus_SUI(*this, state[instance], _params[instance], 6);
                break;
#endif
#if AP_BATTERY_SMBUS_MAXELL_ENABLED
            case Type::MAXELL:
                drivers[instance] = new AG_BattMonitor_SMBus_Maxell(*this, state[instance], _params[instance]);
                break;
#endif
#if AP_BATTERY_SMBUS_ROTOYE_ENABLED
            case Type::Rotoye:
                drivers[instance] = new AG_BattMonitor_SMBus_Rotoye(*this, state[instance], _params[instance]);
                break;
#endif
#if AP_BATTERY_SMBUS_NEODESIGN_ENABLED
            case Type::NeoDesign:
                drivers[instance] = new AG_BattMonitor_SMBus_NeoDesign(*this, state[instance], _params[instance]);
                break;
#endif
            case Type::BEBOP:
#if AP_BATTERY_BEBOP_ENABLED
                drivers[instance] = new AG_BattMonitor_Bebop(*this, state[instance], _params[instance]);
#endif
                break;
            case Type::UAVCAN_BatteryInfo:
#if AP_BATTERY_UAVCAN_BATTERYINFO_ENABLED
                drivers[instance] = new AG_BattMonitor_UAVCAN(*this, state[instance], AG_BattMonitor_UAVCAN::UAVCAN_BATTERY_INFO, _params[instance]);
#endif
                break;
            case Type::BLHeliESC:
#if AP_BATTERY_ESC_ENABLED
                drivers[instance] = new AG_BattMonitor_ESC(*this, state[instance], _params[instance]);
#endif
                break;
#if AP_BATTERY_SUM_ENABLED
            case Type::Sum:
                drivers[instance] = new AG_BattMonitor_Sum(*this, state[instance], _params[instance], instance);
                break;
#endif
#if AP_BATTERY_FUELFLOW_ENABLED
            case Type::FuelFlow:
                drivers[instance] = new AG_BattMonitor_FuelFlow(*this, state[instance], _params[instance]);
                break;
#endif // AP_BATTERY_FUELFLOW_ENABLED
#if AP_BATTERY_FUELLEVEL_PWM_ENABLED
            case Type::FuelLevel_PWM:
                drivers[instance] = new AG_BattMonitor_FuelLevel_PWM(*this, state[instance], _params[instance]);
                break;
#endif // AP_BATTERY_FUELLEVEL_PWM_ENABLED
#if AP_BATTERY_FUELLEVEL_ANALOG_ENABLED
            case Type::FuelLevel_Analog:
                drivers[instance] = new AG_BattMonitor_FuelLevel_Analog(*this, state[instance], _params[instance]);
                break;
#endif // AP_BATTERY_FUELLEVEL_ANALOG_ENABLED
#if HAL_GENERATOR_ENABLED
            case Type::GENERATOR_ELEC:
                drivers[instance] = new AG_BattMonitor_Generator_Elec(*this, state[instance], _params[instance]);
                break;
            case Type::GENERATOR_FUEL:
                drivers[instance] = new AG_BattMonitor_Generator_FuelLevel(*this, state[instance], _params[instance]);
                break;
#endif // HAL_GENERATOR_ENABLED
#if AP_BATTERY_INA2XX_ENABLED
            case Type::INA2XX:
                drivers[instance] = new AG_BattMonitor_INA2XX(*this, state[instance], _params[instance]);
                break;
#endif
#if AP_BATTERY_LTC2946_ENABLED
            case Type::LTC2946:
                drivers[instance] = new AG_BattMonitor_LTC2946(*this, state[instance], _params[instance]);
                break;
#endif
#if HAL_TORQEEDO_ENABLED
            case Type::Torqeedo:
                drivers[instance] = new AG_BattMonitor_Torqeedo(*this, state[instance], _params[instance]);
                break;
#endif
#if AP_BATTERY_SYNTHETIC_CURRENT_ENABLED
            case Type::Analog_Volt_Synthetic_Current:
                drivers[instance] = new AG_BattMonitor_Synthetic_Current(*this, state[instance], _params[instance]);
                break;
#endif
#if AP_BATTERY_INA239_ENABLED
            case Type::INA239_SPI:
                drivers[instance] = new AG_BattMonitor_INA239(*this, state[instance], _params[instance]);
                break;
#endif
#if AP_BATTERY_EFI_ENABLED
            case Type::EFI:
                drivers[instance] = new AG_BattMonitor_EFI(*this, state[instance], _params[instance]);
                break;
#endif // AP_BATTERY_EFI_ENABLED

            case Type::XKC_Y25_NPN:
            	drivers[instance] = new AG_BattMonitor_XKC_Y25_NPN(*this, state[instance], _params[instance]);
            	break;
            case Type::NONE:
            default:
                break;
    ...
    if (drivers[instance] && state[instance].var_info) {
        ...
        AG_Param::load_object_from_eeprom(drivers[instance], backend_var_info[instance]);
...
void AG_BattMonitor::convert_dynamic_param_groups(uint8_t instance)
{
    AG_Param::ConversionInfo info;
    if (!AG_Param::find_top_level_key_by_pointer(this, info.old_key)) {
        return;
    }
    ...
    AG_Param::ParamToken token = AG_Param::ParamToken {};
    ap_var_type type;
    AG_Param* param = AG_Param::find_by_name(param_name, &type, &token);
...
bool AG_BattMonitor::healthy(uint8_t instance) const {
    return instance < _num_instances && state[instance].healthy;
}

/// voltage - returns battery voltage in volts
float AG_BattMonitor::voltage(uint8_t instance) const
{
...
float AG_BattMonitor::voltage_resting_estimate(uint8_t instance) const
{
...
float AG_BattMonitor::gcs_voltage(uint8_t instance) const
{
    if (instance >= _num_instances || drivers[instance] == nullptr) {
        return 0.0f;
    }
    if (drivers[instance]->option_is_set(AG_BattMonitor_Params::Options::GCS_Resting_Voltage)) {
...
bool AG_BattMonitor::current_amps(float &current, uint8_t instance) const {
...
bool AG_BattMonitor::consumed_mah(float &mah, const uint8_t instance) const {
    if ((instance < _num_instances) && (drivers[instance] != nullptr) && drivers[instance]->has_current()) {
...
bool AG_BattMonitor::consumed_wh(float &wh, const uint8_t instance) const {
...
bool AG_BattMonitor::capacity_remaining_pct(uint8_t &percentage, uint8_t instance) const
{
    if (instance < _num_instances && drivers[instance] != nullptr) {
...
bool AG_BattMonitor::time_remaining(uint32_t &seconds, uint8_t instance) const
{
...
int32_t AG_BattMonitor::pack_capacity_mah(uint8_t instance) const
{
...
void AG_BattMonitor::check_failsafes(void)
{
    if (hal.util->get_soft_armed()) {
        for (uint8_t i = 0; i < _num_instances; i++) {
            ...
            AG_Notify::flags.failsafe_battery = true;
#endif
...
bool AG_BattMonitor::overpower_detected() const
{
    bool result = false;
...
bool AG_BattMonitor::overpower_detected(uint8_t instance) const
{
...
bool AG_BattMonitor::has_cell_voltages(const uint8_t instance) const
{
    if (instance < _num_instances && drivers[instance] != nullptr) {
...
const AG_BattMonitor::cells & AG_BattMonitor::get_cell_voltages(const uint8_t instance) const
{
    if (instance >= AP_BATT_MONITOR_MAX_INSTANCES) {
...
bool AG_BattMonitor::get_temperature(float &temperature, const uint8_t instance) const
{
    if (instance >= _num_instances || drivers[instance] == nullptr) {
        return false;
    } 
...
bool AG_BattMonitor::set_temperature(const float temperature, const uint8_t instance)
{
    if (instance >= _num_instances || drivers[instance] == nullptr) {
        return false;
    }
...
bool AG_BattMonitor::set_temperature_by_serial_number(const float temperature, const int32_t serial_number)
{
    bool success = false;
    for (uint8_t i = 0; i < _num_instances; i++) {
...
bool AG_BattMonitor::get_cycle_count(uint8_t instance, uint16_t &cycles) const
{
    if (instance >= _num_instances || (drivers[instance] == nullptr)) {
        return false;
    }
...
bool AG_BattMonitor::arming_checks(size_t buflen, char *buffer) const
{
...
void AG_BattMonitor::checkPoweringOff(void)
{
    for (uint8_t i = 0; i < _num_instances; i++) {
        if (state[i].is_powering_off && !state[i].powerOffNotified) {
#ifndef HAL_BUILD_AP_PERIPH
            // Set the AG_Notify flag, which plays the power off tones
            AG_Notify::flags.powering_off = true;
#endif
...
*/
bool AG_BattMonitor::reset_remaining_mask(uint16_t battery_mask, float percentage)
{
    ...
    if (highest_failsafe == Failsafe::None) {
        ...
        AG_Notify::flags.failsafe_battery = false;
    }
    return ret;
}
...
MAV_BATTERY_CHARGE_STATE AG_BattMonitor::get_mavlink_charge_state(const uint8_t instance) const 
{
    if (instance >= _num_instances) {
...
uint32_t AG_BattMonitor::get_mavlink_fault_bitmask(const uint8_t instance) const
{
    if (instance >= _num_instances || drivers[instance] == nullptr) {
        return 0;
    }
...
void AG_BattMonitor::MPPT_set_powered_state_to_all(const bool power_on)
{
    for (uint8_t i=0; i < _num_instances; i++) {
...
void AG_BattMonitor::MPPT_set_powered_state(const uint8_t instance, const bool power_on)
{
    if (instance < _num_instances) {
 ...
 */
bool AG_BattMonitor::healthy() const
{
    for (uint8_t i=0; i< _num_instances; i++) {
...
AG_BattMonitor &battery()
{
    return *AG_BattMonitor::get_singleton();
}
