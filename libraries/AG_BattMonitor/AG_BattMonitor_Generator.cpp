...
bool AG_BattMonitor_Generator_FuelLevel::has_current(void) const
{
...
bool AG_BattMonitor_Generator_FuelLevel::has_consumed_energy(void) const
{
...
void AG_BattMonitor_Generator_FuelLevel::init()
{
...
void AG_BattMonitor_Generator_FuelLevel::read()
{
    ...
    _state.healthy = true;
    _state.last_time_micros = AG_HAL::micros();
}

/*
    Electrical class
*/
bool AG_BattMonitor_Generator_Elec::has_current(void) const
{
    // Get pointer to generator singleton
    AG_Generator *generator = AP::generator();
...
bool AG_BattMonitor_Generator_Elec::has_consumed_energy(void) const
{
    // Get pointer to generator singleton
    AG_Generator *generator = AP::generator();
...
void AG_BattMonitor_Generator_Elec::read()
{
    _state.healthy = false;
    ...
    // Always reset consumed value, integration is done in AG_Generator library
...
AG_BattMonitor::Failsafe AG_BattMonitor_Generator_Elec::update_failsafes()
{
    AG_BattMonitor::Failsafe failsafe = AG_BattMonitor::Failsafe::None;
    ...
    return MAX(AG_BattMonitor_Backend::update_failsafes(), failsafe);
}
