...
/// Constructor
AG_BattMonitor_FuelLevel_PWM::AG_BattMonitor_FuelLevel_PWM(AG_BattMonitor &mon, AG_BattMonitor::BattMonitor_State &mon_state, AG_BattMonitor_Params &params) :
...
*/
void AG_BattMonitor_FuelLevel_PWM::read()
{
