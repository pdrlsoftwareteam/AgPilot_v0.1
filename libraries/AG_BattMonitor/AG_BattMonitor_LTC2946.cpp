...
void AG_BattMonitor_LTC2946::init(void)
{
    ...
    if (dev) {
        dev->register_periodic_callback(25000, FUNCTOR_BIND_MEMBER(&AG_BattMonitor_LTC2946::timer, void));
    }
}

/// read the battery_voltage and current, should be called at 10hz
void AG_BattMonitor_LTC2946::read(void)
{
...
*/
bool AG_BattMonitor_LTC2946::read_word(const uint8_t reg, uint16_t& data) const
{
...
void AG_BattMonitor_LTC2946::timer(void)
{
    uint16_t amps, volts;
