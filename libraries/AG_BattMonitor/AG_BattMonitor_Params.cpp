...
const AG_Param::GroupInfo AG_BattMonitor_Params::var_info[] = {
    // @Param: MONITOR
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO_FLAGS("MONITOR", 1, AG_BattMonitor_Params, _type, int8_t(AG_BattMonitor::Type::NONE), AP_PARAM_FLAG_ENABLE),
    ...
    // @Increment: 50
    // @User: Standard
    AP_GROUPINFO("CAPACITY", 7, AG_BattMonitor_Params, _pack_capacity, 3300),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO_FRAME("WATT_MAX", 8, AG_BattMonitor_Params, _watt_max, 0, AP_PARAM_FRAME_PLANE),
    ...
    // @User: Advanced
    AP_GROUPINFO("SERIAL_NUM", 9, AG_BattMonitor_Params, _serial_number, AP_BATT_SERIAL_NUMBER_DEFAULT),
    ...
    // @Range: 0 120
    // @User: Advanced
    AP_GROUPINFO("LOW_TIMER", 10, AG_BattMonitor_Params, _low_voltage_timeout, 10),
    ...
    // @User: Advanced
    AP_GROUPINFO("FS_VOLTSRC", 11, AG_BattMonitor_Params, _failsafe_voltage_source, BattMonitor_LowVoltageSource_Raw),
    ...
    // @Increment: 0.1
    // @User: Standard
    AP_GROUPINFO("LOW_VOLT", 12, AG_BattMonitor_Params, _low_voltage, DEFAULT_LOW_BATTERY_VOLTAGE),
    ...
    // @Increment: 50
    // @User: Standard
    AP_GROUPINFO("LOW_MAH", 13, AG_BattMonitor_Params, _low_capacity, 0),
    ...
    // @Increment: 0.1
    // @User: Standard
    AP_GROUPINFO("CRT_VOLT", 14, AG_BattMonitor_Params, _critical_voltage, 0),
    ...
    // @Increment: 50
    // @User: Standard
    AP_GROUPINFO("CRT_MAH", 15, AG_BattMonitor_Params, _critical_capacity, 0),
    ...
    // @User: Standard
    AP_GROUPINFO("FS_LOW_ACT", 16, AG_BattMonitor_Params, _failsafe_low_action, 0),
    ...
    // @Values{Blimp}: 0:None,1:Land
    // @User: Standard
    AP_GROUPINFO("FS_CRT_ACT", 17, AG_BattMonitor_Params, _failsafe_critical_action, 0),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("ARM_VOLT", 18, AG_BattMonitor_Params, _arming_minimum_voltage, 0),
    ...
    // @Increment: 50
    // @User: Advanced
    AP_GROUPINFO("ARM_MAH", 19, AG_BattMonitor_Params, _arming_minimum_capacity, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("OPTIONS", 21, AG_BattMonitor_Params, _options, 0),
#endif // HAL_BUILD_AP_PERIPH
...
AG_BattMonitor_Params::AG_BattMonitor_Params(void) {
