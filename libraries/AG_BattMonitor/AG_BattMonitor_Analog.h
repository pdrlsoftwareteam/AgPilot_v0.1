...
class AG_BattMonitor_Analog : public AG_BattMonitor_Backend
{
public:

    /// Constructor
    AG_BattMonitor_Analog(AG_BattMonitor &mon, AG_BattMonitor::BattMonitor_State &mon_state, AG_BattMonitor_Params &params);
...
protected:
    ...
    AG_HAL::AnalogSource *_volt_pin_analog_source;
    AG_HAL::AnalogSource *_curr_pin_analog_source;
