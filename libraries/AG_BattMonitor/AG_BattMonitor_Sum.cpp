...
const AG_Param::GroupInfo AG_BattMonitor_Sum::var_info[] = {
    ...
    // @User: Standard
    AP_GROUPINFO("SUM_MASK", 20, AG_BattMonitor_Sum, _sum_mask, 0),
...
/// Constructor
AG_BattMonitor_Sum::AG_BattMonitor_Sum(AG_BattMonitor &mon,
...
AG_BattMonitor_Sum::read()
{
    ...
    const uint32_t tnow_us = AG_HAL::micros();
