...
const AG_Param::GroupInfo AG_BattMonitor_Analog::var_info[] = {
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO("VOLT_PIN", 1, AG_BattMonitor_Analog, _volt_pin, AP_BATT_VOLT_PIN),
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO("CURR_PIN", 2, AG_BattMonitor_Analog, _curr_pin, AP_BATT_CURR_PIN),
    ...
    // @User: Advanced
    AP_GROUPINFO("VOLT_MULT", 3, AG_BattMonitor_Analog, _volt_multiplier, AP_BATT_VOLTDIVIDER_DEFAULT),
    ...
    // @Units: A/V
    // @User: Standard
    AP_GROUPINFO("AMP_PERVLT", 4, AG_BattMonitor_Analog, _curr_amp_per_volt, AP_BATT_CURR_AMP_PERVOLT_DEFAULT),
    ...
    // @Units: V
    // @User: Standard
    AP_GROUPINFO("AMP_OFFSET", 5, AG_BattMonitor_Analog, _curr_amp_offset, AP_BATT_CURR_AMP_OFFSET_DEFAULT),
    ...
    // @Units: V
    // @User: Advanced
    AP_GROUPINFO("VLT_OFFSET", 6, AG_BattMonitor_Analog, _volt_offset, 0),
...
/// Constructor
AG_BattMonitor_Analog::AG_BattMonitor_Analog(AG_BattMonitor &mon,
...
bool AG_BattMonitor_Analog::has_current() const
{
    return ((AG_BattMonitor::Type)_params._type.get() == AG_BattMonitor::Type::ANALOG_VOLTAGE_AND_CURRENT);
}
