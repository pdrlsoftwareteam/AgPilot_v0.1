 ...
 *
 * AG_OSD partially based on betaflight and inav osd.c implemention.
...
#include <AG_WindVane/AG_WindVane.h>
#endif
...
const AG_Param::GroupInfo AG_OSD_Screen::var_info[] = {
    ...
    // @User: Standard
    AP_GROUPINFO_FLAGS("ENABLE", 1, AG_OSD_Screen, enabled, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @Range: 900 2100
    // @User: Standard
    AP_GROUPINFO("CHAN_MIN", 2, AG_OSD_Screen, channel_min, 900),
    ...
    // @Range: 900 2100
    // @User: Standard
    AP_GROUPINFO("CHAN_MAX", 3, AG_OSD_Screen, channel_max, 2100),
    ...
    // @Range: 0 15
    AP_SUBGROUPINFO(altitude, "ALTITUDE", 4, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(bat_volt, "BAT_VOLT", 5, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(rssi, "RSSI", 6, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(current, "CURRENT", 7, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(batused, "BATUSED", 8, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(sats, "SATS", 9, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(fltmode, "FLTMODE", 10, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(message, "MESSAGE", 11, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(gspeed, "GSPEED", 12, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(horizon, "HORIZON", 13, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(home, "HOME", 14, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(heading, "HEADING", 15, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(throttle, "THROTTLE", 16, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(compass, "COMPASS", 17, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(wind, "WIND", 18, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(aspeed, "ASPEED", 19, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(vspeed, "VSPEED", 20, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(esc_temp, "ESCTEMP", 21, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(esc_rpm, "ESCRPM", 22, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(esc_amps, "ESCAMPS", 23, AG_OSD_Screen, AG_OSD_Setting),
#endif
    // @Param: GPSLAT_EN
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(gps_latitude, "GPSLAT", 24, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(gps_longitude, "GPSLONG", 25, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(roll_angle, "ROLL", 26, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(pitch_angle, "PITCH", 27, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(temp, "TEMP", 28, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(hdop, "HDOP", 29, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(waypoint, "WAYPOINT", 30, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(xtrack_error, "XTRACK", 31, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(dist, "DIST", 32, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(stat, "STATS", 33, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(flightime, "FLTIME", 34, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(climbeff, "CLIMBEFF", 35, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(eff, "EFF", 36, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(btemp, "BTEMP", 37, AG_OSD_Screen, AG_OSD_Setting),
#endif
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(atemp, "ATEMP", 38, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(bat2_vlt, "BAT2_VLT", 39, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(bat2used, "BAT2USED", 40, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(aspd2, "ASPD2", 41, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(aspd1, "ASPD1", 42, AG_OSD_Screen, AG_OSD_Setting),

    // @Param: CLK_EN
    // @DisplayName: CLK_EN
    // @Description: Displays a clock panel based on AG_RTC local time
    // @Values: 0:Disabled,1:Enabled
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(clk, "CLK", 43, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(sidebars, "SIDEBARS", 44, AG_OSD_Screen, AG_OSD_Setting),
#endif
    ...
    // @Range: 0 15
    AP_SUBGROUPINFO(crosshair, "CRSSHAIR", 45, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen (MSP OSD only)
    // @Range: 0 15
    AP_SUBGROUPINFO(home_dist, "HOMEDIST", 46, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(home_dir, "HOMEDIR", 47, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(power, "POWER", 48, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(cell_volt, "CELLVOLT", 49, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(batt_bar, "BATTBAR", 50, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(arming, "ARMING", 51, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(pluscode, "PLUSCODE", 52, AG_OSD_Screen, AG_OSD_Setting),
#endif
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(callsign, "CALLSIGN", 53, AG_OSD_Screen, AG_OSD_Setting),
#endif
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(current2, "CURRENT2", 54, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(vtx_power, "VTX_PWR", 55, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(hgt_abvterr, "TER_HGT", 56, AG_OSD_Screen, AG_OSD_Setting),
#endif
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(avgcellvolt, "AVGCELLV", 57, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(restvolt, "RESTVOLT", 58, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(fence, "FENCE", 59, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(rngf, "RNGF", 60, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(avgcellrestvolt, "ACRVOLT", 61, AG_OSD_Screen, AG_OSD_Setting),

    AP_GROUPEND
};

const AG_Param::GroupInfo AG_OSD_Screen::var_info2[] = {
    // duplicate of OSDn_ENABLE to ensure params are hidden when not enabled
    AP_GROUPINFO_FLAGS("ENABLE", 2, AG_OSD_Screen, enabled, 0, AP_PARAM_FLAG_ENABLE | AP_PARAM_FLAG_HIDDEN),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 15
    AP_SUBGROUPINFO(link_quality, "LINK_Q", 1, AG_OSD_Screen, AG_OSD_Setting),
    ...
    // @User: Standard
    AP_GROUPINFO("TXT_RES", 3, AG_OSD_Screen, txt_resolution, 0),
    ...
    // @Range: 0 15
    // @User: Standard
    AP_GROUPINFO("FONT", 4, AG_OSD_Screen, font_index, 0),
#endif
    AP_GROUPEND
};


uint8_t AG_OSD_AbstractScreen::symbols_lookup_table[AG_OSD_NUM_SYMBOLS];
...
#define SYMBOL(n) AG_OSD_AbstractScreen::symbols_lookup_table[n]

// constructor
AG_OSD_Screen::AG_OSD_Screen()
{
    AG_Param::setup_object_defaults(this, var_info);
    AG_Param::setup_object_defaults(this, var_info2);
}

void AG_OSD_AbstractScreen::set_backend(AG_OSD_Backend *_backend)
{
    backend = _backend;
    osd = _backend->get_osd();
};

bool AG_OSD_AbstractScreen::check_option(uint32_t option)
{
 ...
 */
char AG_OSD_AbstractScreen::u_icon(enum unit_type unit)
{
    ...
    static const uint8_t* icons[AG_OSD::UNITS_LAST] = {
        icons_metric,
        icons_imperial,
        icons_SI,
        icons_aviation,
    };
    return (char)SYMBOL(icons[constrain_int16(osd->units, 0, AG_OSD::UNITS_LAST-1)][unit]);
}

/*
  scale a value for the user selected units
 */
float AG_OSD_AbstractScreen::u_scale(enum unit_type unit, float value)
{
    ...
    static const float *scale[AG_OSD::UNITS_LAST] = {
        scale_metric,
        scale_imperial,
        scale_SI,
        scale_aviation
    };
    static const float *offsets[AG_OSD::UNITS_LAST] = {
        nullptr,
        offset_imperial,
        nullptr,
        nullptr
    };
    uint8_t units = constrain_int16(osd->units, 0, AG_OSD::UNITS_LAST-1);
    return value * scale[units][unit] + (offsets[units]?offsets[units][unit]:0);
}

char AG_OSD_Screen::get_arrow_font_index(int32_t angle_cd)
{
    uint32_t interval = 36000 / SYMBOL(SYM_ARROW_COUNT);
    angle_cd = wrap_360_cd(angle_cd);
    // if using BF font table must translate arrows
    if (check_option(AG_OSD::OPTION_BF_ARROWS)) {
...
void AG_OSD_Screen::draw_altitude(uint8_t x, uint8_t y)
{
    float alt;
...
void AG_OSD_Screen::draw_bat_volt(uint8_t instance, VoltageType type, uint8_t x, uint8_t y)
{
    AG_BattMonitor &battery = AP::battery();
...
void AG_OSD_Screen::draw_bat_volt(uint8_t x, uint8_t y)
{
    draw_bat_volt(0,VoltageType::VOLTAGE,x,y);
}

void AG_OSD_Screen::draw_avgcellvolt(uint8_t x, uint8_t y)
{
    draw_bat_volt(0,VoltageType::AVG_CELL,x,y);
}

void AG_OSD_Screen::draw_avgcellrestvolt(uint8_t x, uint8_t y)
{
    draw_bat_volt(0,VoltageType::RESTING_CELL,x, y);
}

void AG_OSD_Screen::draw_restvolt(uint8_t x, uint8_t y)
{
    draw_bat_volt(0,VoltageType::RESTING_VOLTAGE,x,y);
}

void AG_OSD_Screen::draw_rssi(uint8_t x, uint8_t y)
{
    AG_RSSI *ap_rssi = AG_RSSI::get_singleton();
    if (ap_rssi) {
...
void AG_OSD_Screen::draw_link_quality(uint8_t x, uint8_t y)
{
    AG_RSSI *ap_rssi = AG_RSSI::get_singleton();
    if (ap_rssi) {
...
void AG_OSD_Screen::draw_current(uint8_t instance, uint8_t x, uint8_t y)
{
    float amps;
...
void AG_OSD_Screen::draw_current(uint8_t x, uint8_t y)
{
    draw_current(0, x, y);
}

void AG_OSD_Screen::draw_fltmode(uint8_t x, uint8_t y)
{
    AG_Notify * notify = AG_Notify::get_singleton();
    char arm;
    if (AG_Notify::flags.armed) {
...
void AG_OSD_Screen::draw_sats(uint8_t x, uint8_t y)
{
    AG_GPS & gps = AP::gps();
    uint8_t nsat = gps.num_sats();
    bool flash = (nsat < osd->warn_nsat) || (gps.status() < AG_GPS::GPS_OK_FIX_3D);
    backend->write(x, y, flash, "%c%c%2u", SYMBOL(SYM_SAT_L), SYMBOL(SYM_SAT_R), nsat);
}

void AG_OSD_Screen::draw_batused(uint8_t instance, uint8_t x, uint8_t y)
{
    float mah;
...
void AG_OSD_Screen::draw_batused(uint8_t x, uint8_t y)
{
    draw_batused(0, x, y);
}
...
void AG_OSD_Screen::draw_message(uint8_t x, uint8_t y)
{
    AG_Notify * notify = AG_Notify::get_singleton();
    if (notify) {
        int32_t visible_time = AG_HAL::millis() - notify->get_text_updated_millis();
...
void AG_OSD_Screen::draw_speed(uint8_t x, uint8_t y, float angle_rad, float magnitude)
{
...
void AG_OSD_Screen::draw_gspeed(uint8_t x, uint8_t y)
{
    AG_AHRS &ahrs = AP::ahrs();
    WITH_SEMAPHORE(ahrs.get_semaphore());
...
void AG_OSD_Screen::draw_horizon(uint8_t x, uint8_t y)
{
    AG_AHRS &ahrs = AP::ahrs();
    WITH_SEMAPHORE(ahrs.get_semaphore());
    float roll;
    ...
    //inverted roll AH
    if (check_option(AG_OSD::OPTION_INVERTED_AH_ROLL)) {
        roll = -roll;
    }
    ...
    if (!check_option(AG_OSD::OPTION_DISABLE_CROSSHAIR)) {
        backend->write(x-1,y, false, "%c%c%c", SYMBOL(SYM_AH_CENTER_LINE_LEFT), SYMBOL(SYM_AH_CENTER), SYMBOL(SYM_AH_CENTER_LINE_RIGHT));
    }

}

void AG_OSD_Screen::draw_distance(uint8_t x, uint8_t y, float distance)
{
    char unit_icon = u_icon(DISTANCE);
    float distance_scaled = u_scale(DISTANCE, distance);
    const char *fmt = "%4.0f%c";
    if (distance_scaled > 9999.0f || (osd->units == AG_OSD::UNITS_IMPERIAL && distance_scaled > 5280.0f && (osd->options & AG_OSD::OPTION_IMPERIAL_MILES))) {
...
void AG_OSD_Screen::draw_home(uint8_t x, uint8_t y)
{
    AG_AHRS &ahrs = AP::ahrs();
    WITH_SEMAPHORE(ahrs.get_semaphore());
    Location loc;
...
void AG_OSD_Screen::draw_heading(uint8_t x, uint8_t y)
{
    AG_AHRS &ahrs = AP::ahrs();
...
void AG_OSD_Screen::draw_throttle(uint8_t x, uint8_t y)
{
...
void AG_OSD_Screen::draw_sidebars(uint8_t x, uint8_t y)
{
    ...
    int alt_interval = (osd->units == AG_OSD::UNITS_AVIATION || osd->units == AG_OSD::UNITS_IMPERIAL) ? 20 : 10;
...
void AG_OSD_Screen::draw_compass(uint8_t x, uint8_t y)
{
...
void AG_OSD_Screen::draw_wind(uint8_t x, uint8_t y)
{
#if !APM_BUILD_TYPE(APM_BUILD_Rover)
    AG_AHRS &ahrs = AP::ahrs();
    WITH_SEMAPHORE(ahrs.get_semaphore());
    ...
    const float length = v.length();
    if (length > 1.0f) {
        if (check_option(AG_OSD::OPTION_INVERTED_WIND)) {
            angle = M_PI;
        }
...
#else
    const AG_WindVane* windvane = AG_WindVane::get_singleton();
    if (windvane != nullptr) {
...
void AG_OSD_Screen::draw_aspeed(uint8_t x, uint8_t y)
{
    float aspd = 0.0f;
    AG_AHRS &ahrs = AP::ahrs();
    WITH_SEMAPHORE(ahrs.get_semaphore());
...
void AG_OSD_Screen::draw_vspeed(uint8_t x, uint8_t y)
{
    Vector3f v;
    float vspd;
    float vs_scaled;
    ...
    if ((osd->units != AG_OSD::UNITS_AVIATION) && (vs_scaled < 9.95f)) {
        backend->write(x, y, false, "%c%.1f%c", sym, (float)vs_scaled, u_icon(VSPEED));
    } else {
        const char *fmt = osd->units == AG_OSD::UNITS_AVIATION ? "%c%4d%c" : "%c%2d%c";
        backend->write(x, y, false, fmt, sym, (int)roundf(vs_scaled), u_icon(VSPEED));
    }
}

#if HAL_WITH_ESC_TELEM
void AG_OSD_Screen::draw_esc_temp(uint8_t x, uint8_t y)
{
    int16_t etemp;
...
void AG_OSD_Screen::draw_esc_rpm(uint8_t x, uint8_t y)
{
    float rpm;
    // first parameter is index into array of ESC's.  Hardwire to zero (first) for now.
...
void AG_OSD_Screen::draw_esc_amps(uint8_t x, uint8_t y)
{
    float amps;
    // first parameter is index into array of ESC's.  Hardwire to zero (first) for now.
...
void AG_OSD_Screen::draw_gps_latitude(uint8_t x, uint8_t y)
{
    AG_GPS & gps = AP::gps();
...
void AG_OSD_Screen::draw_gps_longitude(uint8_t x, uint8_t y)
{
    AG_GPS & gps = AP::gps();
    const Location &loc = gps.location();   // loc.lat and loc.lng
    int32_t dec_portion, frac_portion;
...
void AG_OSD_Screen::draw_roll_angle(uint8_t x, uint8_t y)
{
    AG_AHRS &ahrs = AP::ahrs();
...
void AG_OSD_Screen::draw_pitch_angle(uint8_t x, uint8_t y)
{
    AG_AHRS &ahrs = AP::ahrs();
...
void AG_OSD_Screen::draw_temp(uint8_t x, uint8_t y)
{
    AG_Baro &barometer = AP::baro();
    float tmp = barometer.get_temperature();
    backend->write(x, y, false, "%3d%c", (int)u_scale(TEMPERATURE, tmp), u_icon(TEMPERATURE));
}


void AG_OSD_Screen::draw_hdop(uint8_t x, uint8_t y)
{
    AG_GPS & gps = AP::gps();
...
void AG_OSD_Screen::draw_waypoint(uint8_t x, uint8_t y)
{
    AG_AHRS &ahrs = AP::ahrs();
...
void AG_OSD_Screen::draw_xtrack_error(uint8_t x, uint8_t y)
{
    backend->write(x, y, false, "%c", SYMBOL(SYM_XERR));
    draw_distance(x+1, y, osd->nav_info.wp_xtrack_error);
}

void AG_OSD_Screen::draw_stat(uint8_t x, uint8_t y)
{
...
void AG_OSD_Screen::draw_dist(uint8_t x, uint8_t y)
{
    backend->write(x, y, false, "%c", SYMBOL(SYM_DIST));
    draw_distance(x+1, y, osd->_stats.last_distance_m);
}

void  AG_OSD_Screen::draw_flightime(uint8_t x, uint8_t y)
{
    AG_Stats *stats = AP::stats();
    if (stats) {
...
void AG_OSD_Screen::draw_eff(uint8_t x, uint8_t y)
{
    AG_BattMonitor &battery = AP::battery();
    Vector2f v;
    {
...
void AG_OSD_Screen::draw_climbeff(uint8_t x, uint8_t y)
{
    char unit_icon = u_icon(DISTANCE);
    Vector3f v;
    float vspd;
...
#if BARO_MAX_INSTANCES > 1
void AG_OSD_Screen::draw_btemp(uint8_t x, uint8_t y)
{
    AG_Baro &barometer = AP::baro();
...
void AG_OSD_Screen::draw_atemp(uint8_t x, uint8_t y)
{
#if AP_AIRSPEED_ENABLED
    AG_Airspeed *airspeed = AG_Airspeed::get_singleton();
    if (!airspeed) {
        return;
    }
    float temperature = 0;
...
void AG_OSD_Screen::draw_bat2_vlt(uint8_t x, uint8_t y)
{
    draw_bat_volt(1,VoltageType::VOLTAGE,x,y);
}

void AG_OSD_Screen::draw_bat2used(uint8_t x, uint8_t y)
{
    draw_batused(1, x, y);
}

void AG_OSD_Screen::draw_aspd1(uint8_t x, uint8_t y)
{
#if AP_AIRSPEED_ENABLED
    AG_Airspeed *airspeed = AG_Airspeed::get_singleton();
    if (!airspeed) {
...
void AG_OSD_Screen::draw_aspd2(uint8_t x, uint8_t y)
{
#if AP_AIRSPEED_ENABLED
    AG_Airspeed *airspeed = AG_Airspeed::get_singleton();
    if (!airspeed) {
...
void AG_OSD_Screen::draw_clk(uint8_t x, uint8_t y)
{
    AG_RTC &rtc = AP::rtc();
...
#if HAL_PLUSCODE_ENABLE
void AG_OSD_Screen::draw_pluscode(uint8_t x, uint8_t y)
{
    AG_GPS & gps = AP::gps();
    const Location &loc = gps.location();
    char buff[16];
    if (gps.status() == AG_GPS::NO_GPS || gps.status() == AG_GPS::NO_FIX){
        backend->write(x, y, false, "--------+--");
    } else {
        AG_OLC::olc_encode(loc.lat, loc.lng, 10, buff, sizeof(buff));
 ...
 */
void AG_OSD_Screen::draw_callsign(uint8_t x, uint8_t y)
{
#if HAVE_FILESYSTEM_SUPPORT
...
void AG_OSD_Screen::draw_current2(uint8_t x, uint8_t y)
{
    draw_current(1, x, y);
}

#if AP_VIDEOTX_ENABLED
void AG_OSD_Screen::draw_vtx_power(uint8_t x, uint8_t y)
{
    AG_VideoTX *vtx = AG_VideoTX::get_singleton();
    if (!vtx) {
        return;
    }
    uint16_t powr = 0;
    // If currently in pit mode, just render 0mW to the screen
    if(!vtx->has_option(AG_VideoTX::VideoOptions::VTX_PITMODE)){
...
#if AP_TERRAIN_AVAILABLE
void AG_OSD_Screen::draw_hgt_abvterr(uint8_t x, uint8_t y)
{
...
#if AP_FENCE_ENABLED
void AG_OSD_Screen::draw_fence(uint8_t x, uint8_t y)
{
    AG_Fence *fenceptr = AP::fence();
    if (fenceptr == nullptr) {
       return;
    }
...
void AG_OSD_Screen::draw_rngf(uint8_t x, uint8_t y)
{
