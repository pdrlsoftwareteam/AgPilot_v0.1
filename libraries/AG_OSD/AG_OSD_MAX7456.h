...
class AG_OSD_MAX7456 : public AG_OSD_Backend
{

public:

    static AG_OSD_Backend *probe(AG_OSD &osd, AG_HAL::OwnPtr<AG_HAL::Device> dev);
...
private:
    ...
    //constructor
    AG_OSD_MAX7456(AG_OSD &osd, AG_HAL::OwnPtr<AG_HAL::Device> dev);
