...
#include <AG_OpenDroneID/AG_OpenDroneID_config.h>
...
class AG_CheckFirmware {
public:
#if HAL_GCS_ENABLED
    // handle a message from the GCS. This is static as we don't have an AG_CheckFirmware object
