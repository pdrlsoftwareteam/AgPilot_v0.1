...
class AG_MSP_Telem_Backend : AG_RCTelemetry
{
friend AG_MSP;
public:
    AG_MSP_Telem_Backend(AG_HAL::UARTDriver *uart);
...
protected:
    ...
    */
    ...
    virtual AG_SerialManager::SerialProtocol get_serial_protocol() const = 0;
