...
MSPCommandResult AG_MSP_Telem_DisplayPort::msp_process_out_fc_variant(sbuf_t *dst)
{
    ...
    if (msp->is_option_enabled(AG_MSP::Option::DISPLAYPORT_BTFL_SYMBOLS)) {
...
bool AG_MSP_Telem_DisplayPort::init_uart()
{
