...
class AG_MSP_Telem_DisplayPort : public AG_MSP_Telem_Backend
{
    using AG_MSP_Telem_Backend::AG_MSP_Telem_Backend;
public:
    ...
    AG_SerialManager::SerialProtocol get_serial_protocol() const override { return AG_SerialManager::SerialProtocol::SerialProtocol_MSP_DisplayPort; };
