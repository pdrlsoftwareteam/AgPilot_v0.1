...
class AG_MSP_Telem_DJI : public AG_MSP_Telem_Backend
{
...
public:
    ...
    AG_SerialManager::SerialProtocol get_serial_protocol() const override { return AG_SerialManager::SerialProtocol::SerialProtocol_DJI_FPV; };
