...
Note that this uses AGPILOTLink1 messaging, due to it's smaller message size compared
to AGPILOTLink2.
...
- A single HIGH_LATENCY2 packet will be sent every RCK_PERIOD sec, in addition to receiving 
   a single AGPILOTLink packet from the GCS. This is known as a mailbox check.
