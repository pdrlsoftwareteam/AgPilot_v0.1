...
const AG_Param::GroupInfo AG_CANManager::CANIface_Params::var_info[] = {
    // @Param: DRIVER
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO_FLAGS("DRIVER", 1, AG_CANManager::CANIface_Params, _driver_number, HAL_CAN_DRIVER_DEFAULT, AP_PARAM_FLAG_ENABLE),
    ...
    // @Range: 10000 1000000
    // @User: Advanced
    AP_GROUPINFO("BITRATE", 2, AG_CANManager::CANIface_Params, _bitrate, 1000000),
    ...
    // @User: Advanced
    AP_GROUPINFO("FDBITRATE", 3, AG_CANManager::CANIface_Params, _fdbitrate, HAL_CANFD_SUPPORTED),
#endif
