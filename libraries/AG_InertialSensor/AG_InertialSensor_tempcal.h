...
#include <AG_Math/polyfit.h>
#include <Filter/LowPassFilter2p.h>

// AG_InertialSensor_TCal class is public for use by SITL
class AG_InertialSensor_TCal {
public:
    ...
    class Learn {
    public:
        Learn(AG_InertialSensor_TCal &_tcal, float _start_temp);
