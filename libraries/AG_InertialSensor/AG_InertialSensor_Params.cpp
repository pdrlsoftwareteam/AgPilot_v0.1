...
const AG_Param::GroupInfo AG_InertialSensor_Params::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("USE", 1, AG_InertialSensor_Params, _use,  1),
    ...
    // @ReadOnly: True
    // @User: Advanced
    AP_GROUPINFO("ACC_ID", 2, AG_InertialSensor_Params, _accel_id, 0),
    ...
    // @User: Advanced
    // @Calibration: 1
    AP_GROUPINFO("ACCSCAL",     3, AG_InertialSensor_Params, _accel_scale,  1.0),
    ...
    // @User: Advanced
    // @Calibration: 1
    AP_GROUPINFO("ACCOFFS",     4, AG_InertialSensor_Params, _accel_offset, 0),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("POS", 5, AG_InertialSensor_Params, _accel_pos, 0.0f),
    ...
    // @Units: degC
    // @Calibration: 1
    AP_GROUPINFO("ACC_CALTEMP", 6, AG_InertialSensor_Params, caltemp_accel, -300),
    ...
    // @ReadOnly: True
    // @User: Advanced
    AP_GROUPINFO("GYR_ID", 7, AG_InertialSensor_Params, _gyro_id, 0),
    ...
    // @User: Advanced
    // @Calibration: 1
    AP_GROUPINFO("GYROFFS",     8, AG_InertialSensor_Params, _gyro_offset,  0),
    ...
    // @Units: degC
    // @Calibration: 1
    AP_GROUPINFO("GYR_CALTEMP", 9, AG_InertialSensor_Params, caltemp_gyro, -300),

#if HAL_INS_TEMPERATURE_CAL_ENABLE
    // @Group: TCAL_
    // @Path: AG_InertialSensor_tempcal.cpp
    AP_SUBGROUPINFO(tcal, "TCAL_", 10, AG_InertialSensor_Params, AG_InertialSensor_TCal),
#endif
    AP_GROUPEND
...
AG_InertialSensor_Params::AG_InertialSensor_Params(void) {
