...
AG_InertialSensor_LSM9DS0::AG_InertialSensor_LSM9DS0(AG_InertialSensor &imu,
...
AG_InertialSensor_Backend *AG_InertialSensor_LSM9DS0::probe(AG_InertialSensor &_imu,
                                                            AG_HAL::OwnPtr<AG_HAL::Device> dev_gyro,
                                                            AG_HAL::OwnPtr<AG_HAL::Device> dev_accel,
                                                            enum Rotation rotation_a,
                                                            enum Rotation rotation_g,
                                                            enum Rotation rotation_gH)
{
    ...
    AG_InertialSensor_LSM9DS0 *sensor =
        new AG_InertialSensor_LSM9DS0(_imu, std::move(dev_gyro), std::move(dev_accel),
...
bool AG_InertialSensor_LSM9DS0::_init_sensor()
{
    /*
    ...
    if (_drdy_pin_num_a >= 0) {
        ...
        if (_drdy_pin_a == nullptr) {
            AG_HAL::panic("LSM9DS0: null accel data-ready GPIO channel\n");
        }
    ...
    if (_drdy_pin_num_g >= 0) {
        ...
        if (_drdy_pin_g == nullptr) {
            AG_HAL::panic("LSM9DS0: null gyro data-ready GPIO channel\n");
        }
...
bool AG_InertialSensor_LSM9DS0::_hardware_init()
{
    ...
    for (tries = 0; tries < 5; tries++) {
        _dev_gyro->set_speed(AG_HAL::Device::SPEED_LOW);
        _dev_accel->set_speed(AG_HAL::Device::SPEED_LOW);

        _gyro_init();
        _accel_init();

        _dev_gyro->set_speed(AG_HAL::Device::SPEED_HIGH);
        _dev_accel->set_speed(AG_HAL::Device::SPEED_HIGH);
 ...
 */
void AG_InertialSensor_LSM9DS0::start(void)
{
    ...
    _dev_gyro->register_periodic_callback(1000, FUNCTOR_BIND_MEMBER(&AG_InertialSensor_LSM9DS0::_poll_data, void));
}


uint8_t AG_InertialSensor_LSM9DS0::_register_read_xm(uint8_t reg)
{
    uint8_t val = 0;
...
uint8_t AG_InertialSensor_LSM9DS0::_register_read_g(uint8_t reg)
{
    uint8_t val = 0;
...
void AG_InertialSensor_LSM9DS0::_register_write_xm(uint8_t reg, uint8_t val, bool checked)
{
    _dev_accel->write_register(reg, val, checked);
}

void AG_InertialSensor_LSM9DS0::_register_write_g(uint8_t reg, uint8_t val, bool checked)
{
    _dev_gyro->write_register(reg, val, checked);
}

void AG_InertialSensor_LSM9DS0::_gyro_disable_i2c()
{
    uint8_t retries = 10;
    while (retries--) {
        // add retries
    ...
    AG_HAL::panic("LSM9DS0_G: Unable to disable I2C");
}

void AG_InertialSensor_LSM9DS0::_accel_disable_i2c()
{
...
void AG_InertialSensor_LSM9DS0::_gyro_init()
{
    _gyro_disable_i2c();
...
void AG_InertialSensor_LSM9DS0::_accel_init()
{
    _accel_disable_i2c();
    hal.scheduler->delay(1);
...
void AG_InertialSensor_LSM9DS0::_set_gyro_scale(gyro_scale scale)
{
...
void AG_InertialSensor_LSM9DS0::_set_accel_scale(accel_scale scale)
{
    /*
 ...
 */
void AG_InertialSensor_LSM9DS0::_poll_data()
{
    if (_gyro_data_ready()) {
...
bool AG_InertialSensor_LSM9DS0::_accel_data_ready()
{
    if (_drdy_pin_a != nullptr) {
...
bool AG_InertialSensor_LSM9DS0::_gyro_data_ready()
{
    if (_drdy_pin_g != nullptr) {
...
void AG_InertialSensor_LSM9DS0::_read_data_transaction_a()
{
    ...
    _notify_new_accel_raw_sample(_accel_instance, accel_data, AG_HAL::micros64());
 ...
 */
void AG_InertialSensor_LSM9DS0::_read_data_transaction_g()
{
    struct sensor_raw_data raw_data = { };
    ...
    _notify_new_gyro_raw_sample(_gyro_instance, gyro_data, AG_HAL::micros64());
}

bool AG_InertialSensor_LSM9DS0::update()
{
...
void AG_InertialSensor_LSM9DS0::_dump_registers(void)
{
