...
class AG_InertialSensor_Invensensev2 : public AG_InertialSensor_Backend
{
    friend AP_Invensensev2_AuxiliaryBus;
    friend AP_Invensensev2_AuxiliaryBusSlave;

public:
    virtual ~AG_InertialSensor_Invensensev2();

    static AG_InertialSensor_Invensensev2 &from(AG_InertialSensor_Backend &backend) {
        return static_cast<AG_InertialSensor_Invensensev2&>(backend);
    }
...
private:
    AG_InertialSensor_Invensensev2(AG_InertialSensor &imu,
    ...
    AG_HAL::DigitalSource *_drdy_pin;
...
{
    friend class AG_InertialSensor_Invensensev2;

public:
    AG_HAL::Semaphore *get_semaphore() override;
    AG_HAL::Device::PeriodicHandle register_periodic_callback(uint32_t period_usec, AG_HAL::Device::PeriodicCb cb) override;

protected:
    AP_Invensensev2_AuxiliaryBus(AG_InertialSensor_Invensensev2 &backend, uint32_t devid);
