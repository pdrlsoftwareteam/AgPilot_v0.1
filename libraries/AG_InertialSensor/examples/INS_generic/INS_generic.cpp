//
// Simple test for the AG_InertialSensor driver.
//
...
static AG_BoardConfig BoardConfig;
static AP_Int32 log_bitmask;
static AG_Logger logger{log_bitmask};
...
void setup(void)
{
    ...
    hal.console->printf("AG_InertialSensor startup...\n");
