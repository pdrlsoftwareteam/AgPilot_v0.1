...
AG_InertialSensor_BMI055::AG_InertialSensor_BMI055(AG_InertialSensor &imu,
...
AG_InertialSensor_BMI055::probe(AG_InertialSensor &imu,
                                ...
                                enum Rotation rotation)
{
    ...
    auto sensor = new AG_InertialSensor_BMI055(imu, std::move(dev_accel), std::move(dev_gyro), rotation);
...
void AG_InertialSensor_BMI055::start()
{
    ...
    dev_accel->register_periodic_callback(1000000UL / ACCEL_BACKEND_SAMPLE_RATE,
                                          FUNCTOR_BIND_MEMBER(&AG_InertialSensor_BMI055::read_fifo_accel, void));
    dev_gyro->register_periodic_callback(1000000UL / GYRO_BACKEND_SAMPLE_RATE,
                                         FUNCTOR_BIND_MEMBER(&AG_InertialSensor_BMI055::read_fifo_gyro, void));
}

/*
  probe and initialise accelerometer
 */
bool AG_InertialSensor_BMI055::accel_init()
{
 ...
 */
bool AG_InertialSensor_BMI055::gyro_init()
{
...
bool AG_InertialSensor_BMI055::init()
{
...
/*
  read accel fifo
 */
void AG_InertialSensor_BMI055::read_fifo_accel(void)
{
    uint8_t num_frames;
...
/*
  read gyro fifo
 */
void AG_InertialSensor_BMI055::read_fifo_gyro(void)
{
    uint8_t num_frames;
...
bool AG_InertialSensor_BMI055::update()
{
