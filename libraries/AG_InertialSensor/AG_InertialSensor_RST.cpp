...
// constructor
AG_InertialSensor_RST::AG_InertialSensor_RST(AG_InertialSensor &imu,
...
AG_InertialSensor_RST::~AG_InertialSensor_RST()
{
}
...
/*
  detect the sensor
 */
AG_InertialSensor_Backend *AG_InertialSensor_RST::probe(AG_InertialSensor &imu,
                                              AG_HAL::OwnPtr<AG_HAL::SPIDevice> dev_gyro,
                                              AG_HAL::OwnPtr<AG_HAL::SPIDevice> dev_accel,
                                              enum Rotation rotation_g,
                                              enum Rotation rotation_a)
{
    ...
    AG_InertialSensor_RST *sensor
        = new AG_InertialSensor_RST(imu, std::move(dev_gyro), std::move(dev_accel), rotation_g, rotation_a);
 ...
 * init gyro
 */
bool AG_InertialSensor_RST::_init_gyro(void)
{
    uint8_t whoami;
 ...
 * init accel
 */
bool AG_InertialSensor_RST::_init_accel(void)
{
    uint8_t whoami;
...
bool AG_InertialSensor_RST::_init_sensor(void)
{
...
/*
  startup the sensor
 */
void AG_InertialSensor_RST::start(void)
{
    ...
    _dev_gyro->register_periodic_callback(1150, FUNCTOR_BIND_MEMBER(&AG_InertialSensor_RST::gyro_measure, void));
    _dev_accel->register_periodic_callback(800, FUNCTOR_BIND_MEMBER(&AG_InertialSensor_RST::accel_measure, void));
}

/*
  copy filtered data to the frontend
 */
bool AG_InertialSensor_RST::update(void)
{
...
void AG_InertialSensor_RST::gyro_measure(void)
{
    Vector3f gyro;
    uint8_t status = 0;
    int16_t raw_data[3];
...
void AG_InertialSensor_RST::accel_measure(void)
{
    Vector3f accel;
    uint8_t status = 0;
    int16_t raw_data[3];
