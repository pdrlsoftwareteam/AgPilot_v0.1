...
// constructor
AG_InertialSensor_L3G4200D::AG_InertialSensor_L3G4200D(AG_InertialSensor &imu,
...
AG_InertialSensor_L3G4200D::~AG_InertialSensor_L3G4200D()
{
}
...
/*
  detect the sensor
 */
AG_InertialSensor_Backend *AG_InertialSensor_L3G4200D::probe(AG_InertialSensor &imu,
                                                            AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev_gyro,
                                                            AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev_accel)
{
    ...
    AG_InertialSensor_L3G4200D *sensor
        = new AG_InertialSensor_L3G4200D(imu, std::move(dev_gyro), std::move(dev_accel));
...
bool AG_InertialSensor_L3G4200D::_accel_init()
{
    ...
    if (data != ADXL345_ACCELEROMETER_XL345_DEVID) {
        AG_HAL::panic("AG_InertialSensor_L3G4200D: could not find ADXL345 accelerometer sensor");
    }
    // Full resolution, 8g:
...
bool AG_InertialSensor_L3G4200D::_gyro_init()
{
    uint8_t data = 0;
    // Init the Gyro
    ...
    if (data != L3G4200D_REG_WHO_AM_I_VALUE) {
        AG_HAL::panic("AG_InertialSensor_L3G4200D: could not find L3G4200D gyro sensor");
    }
...
bool AG_InertialSensor_L3G4200D::_init_sensor(void)
{
...
/*
  startup the sensor
 */
void AG_InertialSensor_L3G4200D::start(void)
{
    ...
    _dev_accel->register_periodic_callback(1250, FUNCTOR_BIND_MEMBER(&AG_InertialSensor_L3G4200D::_accumulate_accel, void));
    _dev_gyro->register_periodic_callback(1250, FUNCTOR_BIND_MEMBER(&AG_InertialSensor_L3G4200D::_accumulate_gyro, void));
}
 ...
 */
void AG_InertialSensor_L3G4200D::_set_filter_frequency(uint8_t filter_hz)
{
 ...
 */
bool AG_InertialSensor_L3G4200D::update(void)
{
...
void AG_InertialSensor_L3G4200D::_accumulate_gyro (void)
{
...
void AG_InertialSensor_L3G4200D::_accumulate_accel (void)
{
    uint8_t num_samples_available;
    uint8_t fifo_status = 0;
