...
AG_InertialSensor_NONE::AG_InertialSensor_NONE(AG_InertialSensor &imu, const uint16_t sample_rates[]) :
...
/*
  detect the sensor
 */
AG_InertialSensor_Backend *AG_InertialSensor_NONE::detect(AG_InertialSensor &_imu, const uint16_t sample_rates[])
{
    AG_InertialSensor_NONE *sensor = new AG_InertialSensor_NONE(_imu, sample_rates);
    if (sensor == nullptr) {
...
bool AG_InertialSensor_NONE::init_sensor(void)
{
...
void AG_InertialSensor_NONE::accumulate()
{
    // nothing to do
}
 ...
 */
void AG_InertialSensor_NONE::generate_accel()
{
 ...
 */
void AG_InertialSensor_NONE::generate_gyro()
{
    Vector3f gyro_accum;
...
void AG_InertialSensor_NONE::timer_update(void)
{
...
float AG_InertialSensor_NONE::gyro_drift(void)
{
...
bool AG_InertialSensor_NONE::update(void) 
{
...
uint8_t AG_InertialSensor_NONE::bus_id = 0;

void AG_InertialSensor_NONE::start()
{
    ...
    bus_id++;
    hal.scheduler->register_timer_process(FUNCTOR_BIND_MEMBER(&AG_InertialSensor_NONE::timer_update, void));
