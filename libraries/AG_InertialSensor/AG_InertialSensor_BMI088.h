...
class AG_InertialSensor_BMI088 : public AG_InertialSensor_Backend {
public:
...
private:
    AG_InertialSensor_BMI088(AG_InertialSensor &imu,
                             AG_HAL::OwnPtr<AG_HAL::Device> dev_accel,
                             AG_HAL::OwnPtr<AG_HAL::Device> dev_gyro,
                             enum Rotation rotation);
    ...
    AG_HAL::OwnPtr<AG_HAL::Device> dev_accel;
    AG_HAL::Device::PeriodicHandle accel_periodic_handle;
    AG_HAL::OwnPtr<AG_HAL::Device> dev_gyro;
    AG_HAL::Device::PeriodicHandle gyro_periodic_handle;
