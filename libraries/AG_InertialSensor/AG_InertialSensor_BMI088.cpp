...
AG_InertialSensor_BMI088::AG_InertialSensor_BMI088(AG_InertialSensor &imu,
...
AG_InertialSensor_BMI088::probe(AG_InertialSensor &imu,
                                ...
                                enum Rotation rotation)
{
    ...
    auto sensor = new AG_InertialSensor_BMI088(imu, std::move(dev_accel), std::move(dev_gyro), rotation);
...
void AG_InertialSensor_BMI088::start()
{
    ...
    accel_periodic_handle = dev_accel->register_periodic_callback(ACCEL_BACKEND_PERIOD_US,
                                                                  FUNCTOR_BIND_MEMBER(&AG_InertialSensor_BMI088::read_fifo_accel, void));
    gyro_periodic_handle = dev_gyro->register_periodic_callback(GYRO_BACKEND_PERIOD_US,
                                                                FUNCTOR_BIND_MEMBER(&AG_InertialSensor_BMI088::read_fifo_gyro, void));
}

/*
  read from accelerometer registers, special SPI handling needed
*/
bool AG_InertialSensor_BMI088::read_accel_registers(uint8_t reg, uint8_t *data, uint8_t len)
{
    // when on I2C we just read normally
    if (dev_accel->bus_type() != AG_HAL::Device::BUS_TYPE_SPI) {
...
*/
bool AG_InertialSensor_BMI088::write_accel_register(uint8_t reg, uint8_t v)
{
...
bool AG_InertialSensor_BMI088::setup_accel_config(void)
{
 ...
 */
bool AG_InertialSensor_BMI088::accel_init()
{
 ...
 */
bool AG_InertialSensor_BMI088::gyro_init()
{
...
bool AG_InertialSensor_BMI088::init()
{
...
/*
  read accel fifo
 */
void AG_InertialSensor_BMI088::read_fifo_accel(void)
{
    if (!setup_accel_config()) {
        return;
    }
...
/*
  read gyro fifo
 */
void AG_InertialSensor_BMI088::read_fifo_gyro(void)
{
    uint8_t num_frames;
...
bool AG_InertialSensor_BMI088::update()
{
