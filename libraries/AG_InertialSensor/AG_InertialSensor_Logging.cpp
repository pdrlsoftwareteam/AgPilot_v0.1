...
void AG_InertialSensor_Backend::Write_ACC(const uint8_t instance, const uint64_t sample_us, const Vector3f &accel) const
{
...
void AG_InertialSensor_Backend::Write_GYR(const uint8_t instance, const uint64_t sample_us, const Vector3f &gyro) const
{
        const uint64_t now = AG_HAL::micros64();
...
void AG_InertialSensor::Write_IMU_instance(const uint64_t time_us, const uint8_t imu_instance) const
{
...
void AG_InertialSensor::Write_IMU() const
{
...
void AG_InertialSensor::Write_Vibration() const
{
    const uint64_t time_us = AG_HAL::micros64();
...
bool AG_InertialSensor::BatchSampler::Write_ISBH(const float sample_rate_hz) const
{
...
bool AG_InertialSensor::BatchSampler::Write_ISBD() const
{
    struct log_ISBD pkt = {
...
void AG_InertialSensor::write_notch_log_messages() const
{
