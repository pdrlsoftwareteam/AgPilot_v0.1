...
#include <AG_Motors/AG_Motors_Class.h>
#endif
#include <GCS_MAVLink/GCS.h>

#include "AG_InertialSensor_BMI160.h"
#include "AG_InertialSensor_BMI270.h"
#include "AG_InertialSensor_Backend.h"
#include "AG_InertialSensor_L3G4200D.h"
#include "AG_InertialSensor_LSM9DS0.h"
#include "AG_InertialSensor_LSM9DS1.h"
#include "AG_InertialSensor_Invensense.h"
#include "AG_InertialSensor_SITL.h"
#include "AG_InertialSensor_RST.h"
#include "AG_InertialSensor_BMI055.h"
#include "AG_InertialSensor_BMI088.h"
#include "AG_InertialSensor_Invensensev2.h"
#include "AG_InertialSensor_ADIS1647x.h"
#include "AG_InertialSensor_ExternalAHRS.h"
#include "AG_InertialSensor_Invensensev3.h"
#include "AG_InertialSensor_NONE.h"
#include "AG_InertialSensor_SCHA63T.h"
...
const AG_Param::GroupInfo AG_InertialSensor::var_info[] = {
    // 0 was PRODUCT_ID
    ...
    // @User: Advanced
    // @Calibration: 1
    AP_GROUPINFO("_GYROFFS",     3, AG_InertialSensor, _gyro_offset_old_param[0],  0),
    ...
    AP_GROUPINFO("_GYR2OFFS",    7, AG_InertialSensor, _gyro_offset_old_param[1],   0),
#endif
    ...
    AP_GROUPINFO("_GYR3OFFS",   10, AG_InertialSensor, _gyro_offset_old_param[2],   0),
#endif
    ...
    // @User: Advanced
    // @Calibration: 1
    AP_GROUPINFO("_ACCSCAL",     12, AG_InertialSensor, _accel_scale_old_param[0],  1.0),
    ...
    // @User: Advanced
    // @Calibration: 1
    AP_GROUPINFO("_ACCOFFS",     13, AG_InertialSensor, _accel_offset_old_param[0], 0),
...
#if INS_MAX_INSTANCES > 1
    AP_GROUPINFO("_ACC2SCAL",    14, AG_InertialSensor, _accel_scale_old_param[1],   1.0),
#endif
...
#if INS_MAX_INSTANCES > 1
    AP_GROUPINFO("_ACC2OFFS",    15, AG_InertialSensor, _accel_offset_old_param[1],  0),
#endif
...
#if INS_MAX_INSTANCES > 2
    AP_GROUPINFO("_ACC3SCAL",    16, AG_InertialSensor, _accel_scale_old_param[2],   1.0),
#endif
...
#if INS_MAX_INSTANCES > 2
    AP_GROUPINFO("_ACC3OFFS",    17, AG_InertialSensor, _accel_offset_old_param[2],  0),
#endif
    ...
    // @Range: 0 256
    // @User: Advanced
    AP_GROUPINFO("_GYRO_FILTER", 18, AG_InertialSensor, _gyro_filter_cutoff,  DEFAULT_GYRO_FILTER),
    ...
    // @Range: 0 256
    // @User: Advanced
    AP_GROUPINFO("_ACCEL_FILTER", 19, AG_InertialSensor, _accel_filter_cutoff,  DEFAULT_ACCEL_FILTER),
    ...
    // @User: Advanced
    AP_GROUPINFO("_USE", 20, AG_InertialSensor, _use_old_param[0],  1),
...
#if INS_MAX_INSTANCES > 1
    AP_GROUPINFO("_USE2", 21, AG_InertialSensor, _use_old_param[1],  1),
#endif
...
#if INS_MAX_INSTANCES > 2
    AP_GROUPINFO("_USE3", 22, AG_InertialSensor, _use_old_param[2],  1),
#endif
    ...
    // @Range: 0.05 50
    // @User: Advanced
    AP_GROUPINFO("_STILL_THRESH", 23, AG_InertialSensor, _still_threshold,  DEFAULT_STILL_THRESH),
    ...
    // @User: Advanced
    AP_GROUPINFO("_GYR_CAL", 24, AG_InertialSensor, _gyro_cal_timing, 1),
    ...
    AP_GROUPINFO("_TRIM_OPTION", 25, AG_InertialSensor, _trim_option, 1),
    ...
    AP_GROUPINFO("_ACC_BODYFIX", 26, AG_InertialSensor, _acc_body_aligned, 2),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("_POS1", 27, AG_InertialSensor, _accel_pos_old_param[0], 0.0f),
...
#if INS_MAX_INSTANCES > 1
    AP_GROUPINFO("_POS2", 28, AG_InertialSensor, _accel_pos_old_param[1], 0.0f),
#endif
...
#if INS_MAX_INSTANCES > 2
    AP_GROUPINFO("_POS3", 29, AG_InertialSensor, _accel_pos_old_param[2], 0.0f),
#endif
    ...
    // @ReadOnly: True
    // @User: Advanced
    AP_GROUPINFO("_GYR_ID", 30, AG_InertialSensor, _gyro_id_old_param[0], 0),
...
#if INS_MAX_INSTANCES > 1
    AP_GROUPINFO("_GYR2_ID", 31, AG_InertialSensor, _gyro_id_old_param[1], 0),
#endif
...
#if INS_MAX_INSTANCES > 2
    AP_GROUPINFO("_GYR3_ID", 32, AG_InertialSensor, _gyro_id_old_param[2], 0),
#endif
    ...
    // @ReadOnly: True
    // @User: Advanced
    AP_GROUPINFO("_ACC_ID", 33, AG_InertialSensor, _accel_id_old_param[0], 0),
...
#if INS_MAX_INSTANCES > 1
    AP_GROUPINFO("_ACC2_ID", 34, AG_InertialSensor, _accel_id_old_param[1], 0),
#endif
...
#if INS_MAX_INSTANCES > 2
    AP_GROUPINFO("_ACC3_ID", 35, AG_InertialSensor, _accel_id_old_param[2], 0),
#endif
    ...
    AP_GROUPINFO("_FAST_SAMPLE",  36, AG_InertialSensor, _fast_sampling_mask,   HAL_DEFAULT_INS_FAST_SAMPLE),

    // index 37 was NOTCH_

#if AP_INERTIALSENSOR_BATCHSAMPLER_ENABLED
    // @Group: _LOG_
    // @Path: ../AG_InertialSensor/BatchSampler.cpp
    AP_SUBGROUPINFO(batchsampler, "_LOG_",  39, AG_InertialSensor, AG_InertialSensor::BatchSampler),
#endif
    ...
    AP_GROUPINFO("_ENABLE_MASK",  40, AG_InertialSensor, _enable_mask, 0x7F),

    // @Group: _HNTCH_
    // @Path: ../Filter/HarmonicNotchFilter.cpp
    AP_SUBGROUPINFO(harmonic_notches[0].params, "_HNTCH_",  41, AG_InertialSensor, HarmonicNotchFilterParams),

#if HAL_INS_NUM_HARMONIC_NOTCH_FILTERS > 1
    // @Group: _HNTC2_
    // @Path: ../Filter/HarmonicNotchFilter.cpp
    AP_SUBGROUPINFO(harmonic_notches[1].params, "_HNTC2_",  53, AG_InertialSensor, HarmonicNotchFilterParams),
#endif
    ...
    // @RebootRequired: True
    AP_GROUPINFO("_GYRO_RATE",  42, AG_InertialSensor, _fast_sampling_rate, MPU_FIFO_FASTSAMPLE_DEFAULT),


#if HAL_INS_TEMPERATURE_CAL_ENABLE
    // @Group: _TCAL1_
    // @Path: AG_InertialSensor_tempcal.cpp
    AP_SUBGROUPINFO(tcal_old_param[0], "_TCAL1_", 43, AG_InertialSensor, AG_InertialSensor_TCal),

#if INS_MAX_INSTANCES > 1
    // @Group: _TCAL2_
    // @Path: AG_InertialSensor_tempcal.cpp
    AP_SUBGROUPINFO(tcal_old_param[1], "_TCAL2_", 44, AG_InertialSensor, AG_InertialSensor_TCal),
#endif

#if INS_MAX_INSTANCES > 2
    // @Group: _TCAL3_
    // @Path: AG_InertialSensor_tempcal.cpp
    AP_SUBGROUPINFO(tcal_old_param[2], "_TCAL3_", 45, AG_InertialSensor, AG_InertialSensor_TCal),
#endif
    ...
    // @Units: degC
    // @Calibration: 1
    AP_GROUPINFO("_ACC1_CALTEMP", 46, AG_InertialSensor, caltemp_accel_old_param[0], -300),
    ...
    // @Units: degC
    // @Calibration: 1
    AP_GROUPINFO("_GYR1_CALTEMP", 47, AG_InertialSensor, caltemp_gyro_old_param[0], -300),
    ...
    // @Units: degC
    // @Calibration: 1
    AP_GROUPINFO("_ACC2_CALTEMP", 48, AG_InertialSensor, caltemp_accel_old_param[1], -300),
    ...
    // @Units: degC
    // @Calibration: 1
    AP_GROUPINFO("_GYR2_CALTEMP", 49, AG_InertialSensor, caltemp_gyro_old_param[1], -300),
#endif
    ...
    // @Units: degC
    // @Calibration: 1
    AP_GROUPINFO("_ACC3_CALTEMP", 50, AG_InertialSensor, caltemp_accel_old_param[2], -300),
    ...
    // @Units: degC
    // @Calibration: 1
    AP_GROUPINFO("_GYR3_CALTEMP", 51, AG_InertialSensor, caltemp_gyro_old_param[2], -300),
#endif
    ...
    // @User: Advanced
    AP_GROUPINFO("_TCAL_OPTIONS", 52, AG_InertialSensor, tcal_options, 0),
    ...
    // @Group: 4_
    // @Path: AG_InertialSensor_Params.cpp
    AP_SUBGROUPINFO(params[0], "4_", 54, AG_InertialSensor, AG_InertialSensor_Params),
#endif

#if INS_MAX_INSTANCES > 4
    // @Group: 5_
    // @Path: AG_InertialSensor_Params.cpp
    AP_SUBGROUPINFO(params[1], "5_", 55, AG_InertialSensor, AG_InertialSensor_Params),
#endif
...
AG_InertialSensor *AG_InertialSensor::_singleton = nullptr;

AG_InertialSensor::AG_InertialSensor() :
    _board_orientation(ROTATION_NONE),
    _log_raw_bit(-1)
{
    if (_singleton) {
        AG_HAL::panic("Too many inertial sensors");
    }
    _singleton = this;
    ...
    AG_AccelCal::register_client(this);
#endif
}

/*
 * Get the AG_InertialSensor singleton
 */
AG_InertialSensor *AG_InertialSensor::get_singleton()
{
    if (!_singleton) {
        _singleton = new AG_InertialSensor();
    }
    return _singleton;
}
 ...
 */
bool AG_InertialSensor::register_gyro(uint8_t &instance, uint16_t raw_sample_rate_hz, uint32_t id)
{
 ...
 */
bool AG_InertialSensor::register_accel(uint8_t &instance, uint16_t raw_sample_rate_hz, uint32_t id)
{
 ...
 */
void AG_InertialSensor::_start_backends()

{
    ...
    if (_gyro_count == 0 || _accel_count == 0) {
        AG_HAL::panic("INS needs at least 1 gyro and 1 accel");
    }
...
AG_InertialSensor_Backend *AG_InertialSensor::_find_backend(int16_t backend_id, uint8_t instance)
{
    uint8_t found = 0;
...
bool AG_InertialSensor::set_gyro_window_size(uint16_t size) {
#if HAL_WITH_DSP
...
#if HAL_WITH_DSP
bool AG_InertialSensor::has_fft_notch() const
{
...
void
AG_InertialSensor::init(uint16_t loop_rate)
{
...
#if HAL_WITH_DSP
            if (notch.params.tracking_mode() == HarmonicNotchDynamicMode::UpdateGyroFFT) {
                notch.num_dynamic_notches = AG_HAL::DSP::MAX_TRACKED_PEAKS; // only 3 peaks supported currently
            } else
#endif
            {
                AG_Motors *motors = AP::motors();
                if (motors != nullptr) {
    ...
    if (num_filters > HAL_HNF_MAX_FILTERS) {
        AG_BoardConfig::config_error("Too many notches: %u > %u", num_filters, HAL_HNF_MAX_FILTERS);
    }
        ...
        if (_use(i)) {
            for (auto &notch : harmonic_notches) {
                if (notch.params.enabled() || fft_enabled) {
                    ...
                    // initialise default settings, these will be subsequently changed in AG_InertialSensor_Backend::update_gyro()
...
bool AG_InertialSensor::_add_backend(AG_InertialSensor_Backend *backend)
{
    ...
    if (_backend_count == INS_MAX_BACKENDS) {
        AG_HAL::panic("Too many INS backends");
    }
 ...
 */
void
AG_InertialSensor::detect_backends(void)
{
...
#define BOARD_MATCH(board_type) AG_BoardConfig::get_board_type()==AG_BoardConfig::board_type
...
#define GET_I2C_DEVICE(bus, address) hal.i2c_mgr->get_device(bus, address)
    ...
    const int8_t serial_port = AP::externalAHRS().get_port(AG_ExternalAHRS::AvailableSensor::IMU);
    if (serial_port >= 0) {
        ADD_BACKEND(new AG_InertialSensor_ExternalAHRS(*this, serial_port));
    }
#endif

#if AP_SIM_INS_ENABLED
    for (uint8_t i=0; i<AP::sitl()->imu_count; i++) {
        ADD_BACKEND(AG_InertialSensor_SITL::detect(*this, i==1?INS_SITL_SENSOR_B:INS_SITL_SENSOR_A));
    }
    return;
#endif
    ...
    ADD_BACKEND(AG_InertialSensor_Invensensev3::probe(*this, hal.i2c_mgr->get_device(1, 1), ROTATION_NONE));
#endif
#elif AP_FEATURE_BOARD_DETECT
    switch (AG_BoardConfig::get_board_type()) {
    case AG_BoardConfig::PX4_BOARD_PX4V1:
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU60x0_NAME), ROTATION_NONE));
        break;

    case AG_BoardConfig::PX4_BOARD_PIXHAWK:
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU60x0_NAME), ROTATION_ROLL_180));
        ADD_BACKEND(AG_InertialSensor_LSM9DS0::probe(*this,
    ...
    case AG_BoardConfig::PX4_BOARD_PIXHAWK2:
        // older Pixhawk2 boards have the MPU6000 instead of MPU9250
        _fast_sampling_mask.set_default(1);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_EXT_NAME), ROTATION_PITCH_180));
        ADD_BACKEND(AG_InertialSensor_LSM9DS0::probe(*this,
                                                      ...
                                                      ROTATION_ROLL_180_YAW_90));
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_NAME), ROTATION_YAW_270));
        // new cubes have ICM20602, ICM20948, ICM20649
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device("icm20602_ext"), ROTATION_ROLL_180_YAW_270));
        ADD_BACKEND(AG_InertialSensor_Invensensev2::probe(*this, hal.spi->get_device("icm20948_ext"), ROTATION_PITCH_180));
        ADD_BACKEND(AG_InertialSensor_Invensensev2::probe(*this, hal.spi->get_device("icm20948"), ROTATION_YAW_270));
        break;

    case AG_BoardConfig::PX4_BOARD_FMUV5:
    case AG_BoardConfig::PX4_BOARD_FMUV6:
        _fast_sampling_mask.set_default(1);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device("icm20689"), ROTATION_NONE));
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device("icm20602"), ROTATION_NONE));
        // allow for either BMI055 or BMI088
        ADD_BACKEND(AG_InertialSensor_BMI055::probe(*this,
                                                    hal.spi->get_device("bmi055_a"),
                                                    hal.spi->get_device("bmi055_g"),
                                                    ROTATION_ROLL_180_YAW_90));
        ADD_BACKEND(AG_InertialSensor_BMI088::probe(*this,
                                                    hal.spi->get_device("bmi055_a"),
                                                    hal.spi->get_device("bmi055_g"),
                                                    ROTATION_ROLL_180_YAW_90));
        break;
        
    case AG_BoardConfig::PX4_BOARD_SP01:
        _fast_sampling_mask.set_default(1);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_EXT_NAME), ROTATION_NONE));
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_NAME), ROTATION_NONE));
        break;
        
    case AG_BoardConfig::PX4_BOARD_PIXHAWK_PRO:
        _fast_sampling_mask.set_default(3);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_ICM20608_NAME), ROTATION_ROLL_180_YAW_90));
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_NAME), ROTATION_ROLL_180_YAW_90));
        break;		

    case AG_BoardConfig::PX4_BOARD_PHMINI:
        // PHMINI uses ICM20608 on the ACCEL_MAG device and a MPU9250 on the old MPU6000 CS line
        _fast_sampling_mask.set_default(3);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_ICM20608_AM_NAME), ROTATION_ROLL_180));
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_NAME), ROTATION_ROLL_180));
        break;

    case AG_BoardConfig::PX4_BOARD_AUAV21:
        // AUAV2.1 uses ICM20608 on the ACCEL_MAG device and a MPU9250 on the old MPU6000 CS line
        _fast_sampling_mask.set_default(3);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_ICM20608_AM_NAME), ROTATION_ROLL_180_YAW_90));
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_NAME), ROTATION_ROLL_180_YAW_90));
        break;
        
    case AG_BoardConfig::PX4_BOARD_PH2SLIM:
        _fast_sampling_mask.set_default(1);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_NAME), ROTATION_YAW_270));
        break;

    case AG_BoardConfig::PX4_BOARD_AEROFC:
        _fast_sampling_mask.set_default(1);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU6500_NAME), ROTATION_YAW_270));
        break;

    case AG_BoardConfig::PX4_BOARD_MINDPXV2:
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU6500_NAME), ROTATION_NONE));
        ADD_BACKEND(AG_InertialSensor_LSM9DS0::probe(*this,
                                                      hal.spi->get_device(HAL_INS_LSM9DS0_G_NAME),
                                                      hal.spi->get_device(HAL_INS_LSM9DS0_A_NAME),
                                                      ROTATION_YAW_90,
    ...
    case AG_BoardConfig::VRX_BOARD_BRAIN54:
        _fast_sampling_mask.set_default(7);
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU60x0_NAME), ROTATION_YAW_180));
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU60x0_EXT_NAME), ROTATION_YAW_180));
#ifdef HAL_INS_MPU60x0_IMU_NAME
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU60x0_IMU_NAME), ROTATION_YAW_180));
#endif
        break;

    case AG_BoardConfig::VRX_BOARD_BRAIN51:
    case AG_BoardConfig::VRX_BOARD_BRAIN52:
    case AG_BoardConfig::VRX_BOARD_BRAIN52E:
    case AG_BoardConfig::VRX_BOARD_CORE10:
    case AG_BoardConfig::VRX_BOARD_UBRAIN51:
    case AG_BoardConfig::VRX_BOARD_UBRAIN52:
        ADD_BACKEND(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU60x0_NAME), ROTATION_YAW_180));
        break;
        
    case AG_BoardConfig::PX4_BOARD_PCNC1:
        _add_backend(AG_InertialSensor_Invensense::probe(*this, hal.spi->get_device(HAL_INS_MPU60x0_NAME), ROTATION_ROLL_180));
        break;
    ...
    if (_backend_count == 0) {
        ...
        ADD_BACKEND(AG_InertialSensor_NONE::detect(*this, INS_NONE_SENSOR_A));
        #else
        DEV_PRINTF("INS: unable to initialise driver\n");
        GCS_SEND_TEXT(MAV_SEVERITY_DEBUG, "INS: unable to initialise driver");
        AG_BoardConfig::config_error("INS: unable to initialise driver");
        #endif
    }
}
...
void AG_InertialSensor::periodic()
{
#if AP_INERTIALSENSOR_BATCHSAMPLER_ENABLED
...
*/
bool AG_InertialSensor::_calculate_trim(const Vector3f &accel_sample, Vector3f &trim)
{
    Rotation rotation = ROTATION_NONE;
#if APM_BUILD_TYPE(APM_BUILD_ArduPlane)
    AG_AHRS_View *view = AP::ahrs().get_view();
    if (view != nullptr) {
...
bool AG_InertialSensor::get_output_banner(uint8_t backend_id, char* banner, uint8_t banner_len)
{
...
uint32_t AG_InertialSensor::get_accel_clip_count(uint8_t instance) const
{
...
bool AG_InertialSensor::get_gyro_health_all(void) const
{
    for (uint8_t i=0; i<get_gyro_count(); i++) {
...
bool AG_InertialSensor::gyro_calibrated_ok_all() const
{
    for (uint8_t i=0; i<get_gyro_count(); i++) {
...
bool AG_InertialSensor::use_gyro(uint8_t instance) const
{
...
bool AG_InertialSensor::get_accel_health_all(void) const
{
 ...
 */
bool AG_InertialSensor::calibrate_trim(Vector3f &trim_rad)
{
 ...
 */
bool AG_InertialSensor::accel_calibrated_ok_all() const
{
...
bool AG_InertialSensor::use_accel(uint8_t instance) const
{
    if (instance >= INS_MAX_INSTANCES) {
        return false;
    }
...
AG_InertialSensor::_init_gyro()
{
    ...
    */
    ...
    // stop flashing leds
    AG_Notify::flags.initialising = false;
}

// save parameters to eeprom
void AG_InertialSensor::_save_gyro_calibration()
{
 ...
 */
void AG_InertialSensor::HarmonicNotch::update_params(uint8_t instance, bool converging, float gyro_rate)
{
 ...
 */
void AG_InertialSensor::update(void)
{
    ...
    wait_for_sample();
        ...
        if (!_startup_error_counts_set) {
            ...
            if (_startup_ms == 0) {
                _startup_ms = AG_HAL::millis();
            } else if (AG_HAL::millis()-_startup_ms > 2000) {
    ...
    _last_update_usec = AG_HAL::micros();
    
    _have_sample = false;

#if HAL_INS_TEMPERATURE_CAL_ENABLE
    if (tcal_learning && !temperature_cal_running()) {
        AG_Notify::flags.temp_cal_running = false;
        AG_Notify::events.temp_cal_saved = 1;
        tcal_learning = false;
...
/*
  ...
  sample_rate argument given to AG_InertialSensor::init().
 ...
 */
void AG_InertialSensor::wait_for_sample(void)
{
    if (_have_sample) {
...
/*
  get delta angles
 */
bool AG_InertialSensor::get_delta_angle(uint8_t i, Vector3f &delta_angle, float &delta_angle_dt) const
{
...
*/
bool AG_InertialSensor::get_delta_velocity(uint8_t i, Vector3f &delta_velocity, float &delta_velocity_dt) const
{
 ...
 */
AuxiliaryBus *AG_InertialSensor::get_auxiliary_bus(int16_t backend_id, uint8_t instance)
{
    detect_backends();

    AG_InertialSensor_Backend *backend = _find_backend(backend_id, instance);
    if (backend == nullptr) {
        return nullptr;
    }
...
void AG_InertialSensor::calc_vibration_and_clipping(uint8_t instance, const Vector3f &accel, float dt)
{
    // check for clipping
...
void AG_InertialSensor::set_accel_peak_hold(uint8_t instance, const Vector3f &accel)
{
...
Vector3f AG_InertialSensor::get_vibration_levels(uint8_t instance) const
{
    Vector3f vibe;
    if (instance < INS_VIBRATION_CHECK_INSTANCES) {
...
bool AG_InertialSensor::is_still()
{
...
bool AG_InertialSensor::calibrating() const
{
...
bool AG_InertialSensor::temperature_cal_running() const
{
#if HAL_INS_TEMPERATURE_CAL_ENABLE
    for (uint8_t i=0; i<INS_MAX_INSTANCES; i++) {
        if (tcal(i).enable == AG_InertialSensor_TCal::Enable::LearnCalibration) {
            return true;
        }
    }
#endif
...
void AG_InertialSensor::acal_update()
{
    if(_acal == nullptr) {
        return;
    }
...
void AG_InertialSensor::HarmonicNotch::update_freq_hz(float scaled_freq)
{
...
// Update the harmonic notch frequency
void AG_InertialSensor::HarmonicNotch::update_frequencies_hz(uint8_t num_freqs, const float scaled_freq[]) {
    // protect against zero as the scaled frequency
...
bool AG_InertialSensor::setup_throttle_gyro_harmonic_notch(float center_freq_hz, float lower_freq_hz, float ref, uint8_t harmonics)
{
    for (auto &notch : harmonic_notches) {
...
*/
void AG_InertialSensor::_acal_save_calibrations()
{
    Vector3f bias, gain;
    for (uint8_t i=0; i<_accel_count; i++) {
...
void AG_InertialSensor::_acal_event_failure()
{
    for (uint8_t i=0; i<_accel_count; i++) {
...
*/
bool AG_InertialSensor::get_new_trim(Vector3f &trim_rad)
{
    if (_new_trim) {
        trim_rad = _trim_rad;
        _new_trim = false;
...
*/
bool AG_InertialSensor::get_fixed_mount_accel_cal_sample(uint8_t sample_num, Vector3f& ret) const
{
...
*/
bool AG_InertialSensor::get_primary_accel_cal_sample_avg(uint8_t sample_num, Vector3f& ret) const
{
    uint8_t count = 0;
 ...
 */
#if HAL_GCS_ENABLED
MAV_RESULT AG_InertialSensor::simple_accel_cal()
{
    ...
    */
    ...
    uint32_t start_ms = AG_HAL::millis();
    while (AG_HAL::millis() - start_ms < 500) {
        update();
    }
 ...
 */
AG_InertialSensor::Gyro_Calibration_Timing AG_InertialSensor::gyro_calibration_timing()
{
 ...
 */
void AG_InertialSensor::kill_imu(uint8_t imu_idx, bool kill_it)
{
    if (kill_it) {
...
#if HAL_EXTERNAL_AHRS_ENABLED
void AG_InertialSensor::handle_external(const AG_ExternalAHRS::ins_data_message_t &pkt)
{
    for (uint8_t i = 0; i < _backend_count; i++) {
...
void AG_InertialSensor::force_save_calibration(void)
{
    for (uint8_t i=0; i<_accel_count; i++) {
        if (_accel_id(i) != 0) {
            _accel_id(i).save();
...
{
    return *AG_InertialSensor::get_singleton();
}
