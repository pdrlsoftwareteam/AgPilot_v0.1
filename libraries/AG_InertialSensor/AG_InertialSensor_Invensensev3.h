...
class AG_InertialSensor_Invensensev3 : public AG_InertialSensor_Backend
{
public:
    virtual ~AG_InertialSensor_Invensensev3();
...
private:
    AG_InertialSensor_Invensensev3(AG_InertialSensor &imu,
                                   AG_HAL::OwnPtr<AG_HAL::Device> dev,
                                   enum Rotation rotation);
    ...
    */
    ...
    AG_HAL::OwnPtr<AG_HAL::Device> dev;
    AG_HAL::Device::PeriodicHandle periodic_handle;
