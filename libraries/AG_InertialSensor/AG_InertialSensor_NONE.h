...
class AG_InertialSensor_NONE : public AG_InertialSensor_Backend
{
public:
    AG_InertialSensor_NONE(AG_InertialSensor &imu, const uint16_t sample_rates[]);
    ...
    // detect the sensor
    static AG_InertialSensor_Backend *detect(AG_InertialSensor &imu, const uint16_t sample_rates[]);
