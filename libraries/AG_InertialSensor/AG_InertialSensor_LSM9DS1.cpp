...
AG_InertialSensor_LSM9DS1::AG_InertialSensor_LSM9DS1(AG_InertialSensor &imu,
...
AG_InertialSensor_Backend *AG_InertialSensor_LSM9DS1::probe(AG_InertialSensor &_imu,
                                                            AG_HAL::OwnPtr<AG_HAL::SPIDevice> dev,
                                                            enum Rotation rotation)
{
    if (!dev) {
    ...
    AG_InertialSensor_LSM9DS1 *sensor =
        new AG_InertialSensor_LSM9DS1(_imu,std::move(dev),
                                      LSM9DS1_DRY_XG_PIN,
                                      rotation);
...
bool AG_InertialSensor_LSM9DS1::_init_sensor()
{
    ...
    if (_drdy_pin_num_xg >= 0) {
        ...
        if (_drdy_pin_xg == nullptr) {
            AG_HAL::panic("LSM9DS1: null accel data-ready GPIO channel\n");
        }
...
bool AG_InertialSensor_LSM9DS1::_hardware_init()
{
...
void AG_InertialSensor_LSM9DS1::_fifo_reset()
{
    _dev->set_speed(AG_HAL::Device::SPEED_LOW);
 ...
 */
void AG_InertialSensor_LSM9DS1::start(void)
{
    ...
    _dev->register_periodic_callback(1000, FUNCTOR_BIND_MEMBER(&AG_InertialSensor_LSM9DS1::_poll_data, void));
}

uint8_t AG_InertialSensor_LSM9DS1::_register_read(uint8_t reg)
{
    uint8_t val = 0;
...
void AG_InertialSensor_LSM9DS1::_register_write(uint8_t reg, uint8_t val, bool checked)
{
    _dev->write_register(reg, val, checked);
}

void AG_InertialSensor_LSM9DS1::_gyro_init()
{
...
void AG_InertialSensor_LSM9DS1::_accel_init()
{
...
void AG_InertialSensor_LSM9DS1::_set_gyro_scale()
{
...
void AG_InertialSensor_LSM9DS1::_set_accel_scale(accel_scale scale)
{
    /*
 ...
 */
void AG_InertialSensor_LSM9DS1::_poll_data()
{
...
void AG_InertialSensor_LSM9DS1::_read_data_transaction_x(uint16_t samples)
{
 ...
 */
void AG_InertialSensor_LSM9DS1::_read_data_transaction_g(uint16_t samples)
{
    struct sensor_raw_data raw_data = { };
...
bool AG_InertialSensor_LSM9DS1::update()
{
...
*/
void AG_InertialSensor_LSM9DS1::_dump_registers(void)
{
