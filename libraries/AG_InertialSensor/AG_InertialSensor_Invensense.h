...
class AG_InertialSensor_Invensense : public AG_InertialSensor_Backend
{
    friend AP_Invensense_AuxiliaryBus;
    friend AP_Invensense_AuxiliaryBusSlave;

public:
    virtual ~AG_InertialSensor_Invensense();
    static AG_InertialSensor_Invensense &from(AG_InertialSensor_Backend &backend) {
        return static_cast<AG_InertialSensor_Invensense&>(backend);
    }
...
private:
    AG_InertialSensor_Invensense(AG_InertialSensor &imu,
...
{
    friend class AG_InertialSensor_Invensense;
...
protected:
    AP_Invensense_AuxiliaryBus(AG_InertialSensor_Invensense &backend, uint32_t devid);
