...
class AG_InertialSensor_SCHA63T : public AG_InertialSensor_Backend
{
public:
...
private:
    AG_InertialSensor_SCHA63T(AG_InertialSensor &imu,
    ...
    AG_HAL::OwnPtr<AG_HAL::Device> dev_uno;
    AG_HAL::OwnPtr<AG_HAL::Device> dev_due;
