...
public:
    AG_InertialSensor_Backend &get_backend() { return _ins_backend; }
    ...
    void set_device_type(uint8_t devtype) {
        _devid = AG_HAL::Device::change_bus_id(_devid, devtype);
    }
...
protected:
    /* Only AG_InertialSensor_Backend is able to create a bus */
    AuxiliaryBus(AG_InertialSensor_Backend &backend, uint8_t max_slaves, uint32_t devid);
    ...
    AG_InertialSensor_Backend &_ins_backend;
    uint32_t _devid;
};
