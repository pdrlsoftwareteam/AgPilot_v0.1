 ...
 */
const AG_RAMTRON::ramtron_id AG_RAMTRON::ramtron_ids[] = {
 ...
 */
void AG_RAMTRON::send_offset(uint8_t cmd, uint32_t offset) const
{
...
// read from device
bool AG_RAMTRON::read(uint32_t offset, uint8_t *buf, uint32_t size)
{
...
// write to device
bool AG_RAMTRON::write(uint32_t offset, const uint8_t *buf, uint32_t size)
{
