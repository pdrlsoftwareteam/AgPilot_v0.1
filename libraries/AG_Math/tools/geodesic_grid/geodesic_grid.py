...
def print_code_gen_notice():
    ...
    print(" * libraries/AG_Math/tools/geodesic_grid/geodesic_grid.py */")
...
parser = argparse.ArgumentParser(
    description="""
Utility script for helping to understand concepts used by AG_GeodesicGrid as
...
AG_GeodesicGrid.h. The special value "all" for INDEX is also accepted, which
...
described in AG_GeodesicGrid.h.
""",
)
...
if args.neighbor_umbrella_gen:
    ...
    print("const struct AG_GeodesicGrid::neighbor_umbrella")
    print("AG_GeodesicGrid::_neighbor_umbrellas[3]{")
    for i in range(6):
        u, order_edge = header_neighbor_umbrella(i)
...
if args.inverses_gen:
    ...
    print_code_gen_notice()
    print("const Matrix3f AG_GeodesicGrid::_inverses[10]{")
    for i in range(10):
    ...
    print()
    print_code_gen_notice()
    print("const Matrix3f AG_GeodesicGrid::_mid_inverses[10]{")
    for i in range(10):
        a, b, c = ico.triangles[i]
