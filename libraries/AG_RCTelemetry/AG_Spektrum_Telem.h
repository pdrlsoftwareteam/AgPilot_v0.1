...
class AG_Spektrum_Telem : public AG_RCTelemetry {
public:
    AG_Spektrum_Telem();
    ~AG_Spektrum_Telem() override;

    /* Do not allow copies */
    CLASS_NO_COPY(AG_Spektrum_Telem);

    // init - perform required initialisation
    virtual bool init() override;

    static AG_Spektrum_Telem *get_singleton(void) {
        return singleton;
    }
...
private:
    ...
    static AG_Spektrum_Telem *singleton;
};
