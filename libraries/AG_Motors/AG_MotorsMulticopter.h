...
/// @class      AG_MotorsMulticopter
class AG_MotorsMulticopter : public AG_Motors {
public:

    // Constructor
    AG_MotorsMulticopter(uint16_t speed_hz = AP_MOTORS_SPEED_DEFAULT);
