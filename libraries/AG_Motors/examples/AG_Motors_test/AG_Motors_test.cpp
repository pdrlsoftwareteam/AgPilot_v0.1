...
//AG_MotorsTri  motors(400);
AG_MotorsMatrix   motors(400);
//AG_MotorsHeli_Single motors(rc7, rsc, h1, h2, h3, h4, 400);
//AG_MotorsSingle motors(400);
//AG_MotorsCoax motors(400);

AG_BattMonitor _battmonitor{0, nullptr, nullptr};

// setup
void setup()
{
    hal.console->printf("AG_Motors library test ver 1.0\n");

    // motor initialisation
    motors.set_update_rate(490);
    motors.init(AG_Motors::MOTOR_FRAME_QUAD, AG_Motors::MOTOR_FRAME_TYPE_X);
#if HELI_TEST == 0
