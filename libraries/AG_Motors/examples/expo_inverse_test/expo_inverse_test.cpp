...
class AG_MotorsMulticopter_test : public AG_MotorsMulticopter {
public:

    AG_MotorsMulticopter_test(uint16_t speed_hz = AP_MOTORS_SPEED_DEFAULT) :
...
AG_MotorsMulticopter_test motors;
