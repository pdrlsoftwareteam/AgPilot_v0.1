...
/// @class      AG_MotorsTailsitter
class AG_MotorsTailsitter : public AG_MotorsMulticopter {
public:

    /// Constructor
    AG_MotorsTailsitter(uint16_t speed_hz = AP_MOTORS_SPEED_DEFAULT);
