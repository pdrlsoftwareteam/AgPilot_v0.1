...
public:
    ...
    // Constructor
    AG_Motors(uint16_t speed_hz = AP_MOTORS_SPEED_DEFAULT);

    // singleton support
    static AG_Motors    *get_singleton(void) { return _singleton; }
...
protected:
    ...
    */
    ...
    AG_Motors_limit external_limits;
#endif
