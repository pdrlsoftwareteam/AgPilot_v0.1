...
// init
void AG_MotorsCoax::init(motor_frame_class frame_class, motor_frame_type frame_type)
{
...
void AG_MotorsCoax::set_frame_class_and_type(motor_frame_class frame_class, motor_frame_type frame_type)
{
    set_initialised_ok(frame_class == MOTOR_FRAME_COAX);
}

// set update rate to motors - a value in hertz
void AG_MotorsCoax::set_update_rate(uint16_t speed_hz)
{
...
void AG_MotorsCoax::output_to_motors()
{
    switch (_spool_state) {
...
uint32_t AG_MotorsCoax::get_motor_mask()
{
    uint32_t motor_mask =
        1U << AP_MOTORS_MOT_5 |
        1U << AP_MOTORS_MOT_6;
...
void AG_MotorsCoax::output_armed_stabilizing()
{
...
void AG_MotorsCoax::_output_test_seq(uint8_t motor_seq, int16_t pwm)
{
