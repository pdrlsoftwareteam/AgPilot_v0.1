...
/// @class      AG_MotorsSingle
class AG_MotorsSingle : public AG_MotorsMulticopter {
public:

    /// Constructor
    AG_MotorsSingle(uint16_t speed_hz = AP_MOTORS_SPEED_DEFAULT) :
    ...
    // Run arming checks
    bool arming_checks(size_t buflen, char *buffer) const override { return AG_Motors::arming_checks(buflen, buffer); }
