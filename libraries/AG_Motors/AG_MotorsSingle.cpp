...
// init
void AG_MotorsSingle::init(motor_frame_class frame_class, motor_frame_type frame_type)
{
...
void AG_MotorsSingle::set_frame_class_and_type(motor_frame_class frame_class, motor_frame_type frame_type)
{
    // nothing to do
}

// set update rate to motors - a value in hertz
void AG_MotorsSingle::set_update_rate(uint16_t speed_hz)
{
...
void AG_MotorsSingle::output_to_motors()
{
    if (!initialised_ok()) {
        return;
    }
...
uint32_t AG_MotorsSingle::get_motor_mask()
{
    uint32_t motor_mask =
        1U << AP_MOTORS_MOT_5 |
        1U << AP_MOTORS_MOT_6;
...
void AG_MotorsSingle::output_armed_stabilizing()
{
...
void AG_MotorsSingle::_output_test_seq(uint8_t motor_seq, int16_t pwm)
{
