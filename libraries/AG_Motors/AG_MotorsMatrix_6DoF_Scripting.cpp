...
#include "AG_MotorsMatrix_6DoF_Scripting.h"
...
void AG_MotorsMatrix_6DoF_Scripting::output_to_motors()
{
    switch (_spool_state) {
...
void AG_MotorsMatrix_6DoF_Scripting::output_armed_stabilizing()
{
...
void AG_MotorsMatrix_6DoF_Scripting::set_roll_pitch(float roll_deg, float pitch_deg)
{
...
void AG_MotorsMatrix_6DoF_Scripting::add_motor(int8_t motor_num, float roll_factor, float pitch_factor, float yaw_factor, float throttle_factor, float forward_factor, float right_factor, bool reversible, uint8_t testing_order)
{
    if (initialised_ok()) {
...
bool AG_MotorsMatrix_6DoF_Scripting::init(uint8_t expected_num_motors) {
...
// singleton instance
AG_MotorsMatrix_6DoF_Scripting *AG_MotorsMatrix_6DoF_Scripting::_singleton;
