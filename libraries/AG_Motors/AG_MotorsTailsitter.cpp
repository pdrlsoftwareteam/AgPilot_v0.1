...
/*
 *       AG_MotorsTailsitter.cpp - ArduCopter motors library for tailsitters and bicopters
 *
 */

#include <AG_HAL/AG_HAL.h>
#include <AG_Math/AG_Math.h>
#include "AG_MotorsTailsitter.h"
...
// init
void AG_MotorsTailsitter::init(motor_frame_class frame_class, motor_frame_type frame_type)
{
...
/// Constructor
AG_MotorsTailsitter::AG_MotorsTailsitter(uint16_t speed_hz) :
    AG_MotorsMulticopter(speed_hz)
{
...
void AG_MotorsTailsitter::set_update_rate(uint16_t speed_hz)
{
...
void AG_MotorsTailsitter::output_to_motors()
{
    if (!initialised_ok()) {
        return;
    }
...
uint32_t AG_MotorsTailsitter::get_motor_mask()
{
    ...
    // add parent's mask
    motor_mask |= AG_MotorsMulticopter::get_motor_mask();

    return motor_mask;
}

// calculate outputs to the motors
void AG_MotorsTailsitter::output_armed_stabilizing()
{
...
void AG_MotorsTailsitter::_output_test_seq(uint8_t motor_seq, int16_t pwm)
{
