...
// AG_Stats is used to collect and put to permanent storage data about
...
public:
    ...
    uint32_t reset;   // last time AG_Stats parameters were reset (in seconds since AG_Stats Jan 1st 2016)
    ...
    // get singleton
    static AG_Stats *get_singleton(void) {
        return _singleton;
    }
