...
public:
    // constructor
    AG_ICEngine(const class AG_RPM &_rpm);
    ...
    static AG_ICEngine *get_singleton() { return _singleton; }

private:
    static AG_ICEngine *_singleton;

    const class AG_RPM &rpm;
