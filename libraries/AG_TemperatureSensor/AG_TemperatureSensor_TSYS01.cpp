...
void AG_TemperatureSensor_TSYS01::init()
{
    ...
    _dev->register_periodic_callback(50 * AP_USEC_PER_MSEC,
                                     FUNCTOR_BIND_MEMBER(&AG_TemperatureSensor_TSYS01::_timer, void));
}
...
//      6       0xAC -> unused
//      7       0xAE -> unused
bool AG_TemperatureSensor_TSYS01::read_prom()
{
    bool success = false;
...
uint16_t AG_TemperatureSensor_TSYS01::read_prom_word(const uint8_t word) const
{
...
uint32_t AG_TemperatureSensor_TSYS01::read_adc() const
{
    uint8_t val[3];
...
void AG_TemperatureSensor_TSYS01::_timer(void)
{
...
void AG_TemperatureSensor_TSYS01::start_next_sample()
{
    _dev->transfer(&TSYS01_CMD_CONVERT, 1, nullptr, 0);
}

float AG_TemperatureSensor_TSYS01::calculate(const uint32_t adc) const
{
