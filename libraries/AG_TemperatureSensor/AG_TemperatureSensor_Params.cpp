...
const AG_Param::GroupInfo AG_TemperatureSensor_Params::var_info[] = {
    // @Param: TYPE
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO_FLAGS("TYPE", 1, AG_TemperatureSensor_Params, type, (float)Type::NONE, AP_PARAM_FLAG_ENABLE),
    ...
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO("BUS", 2, AG_TemperatureSensor_Params, bus, AP_TEMPERATURE_SENSOR_I2C_BUS_DEFAULT),
    ...
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO("ADDR", 3, AG_TemperatureSensor_Params, bus_address, AP_TEMPERATURE_SENSOR_I2C_ADDR_DEFAULT),
    ...
    // @User: Standard
    AP_GROUPINFO("SRC", 4, AG_TemperatureSensor_Params, source, (float)Source::None),
    ...
    AP_GROUPINFO("SRC_ID", 5, AG_TemperatureSensor_Params, source_id, AP_TEMPERATURE_SENSOR_SOURCE_ID_DEFAULT),

    AP_GROUPEND
};

AG_TemperatureSensor_Params::AG_TemperatureSensor_Params(void) {
