...
#include "AG_TemperatureSensor_config.h"

#if AP_TEMPERATURE_SENSOR_ENABLED

#include "AG_TemperatureSensor_Params.h"

// declare backend class
class AG_TemperatureSensor_Backend;
class AG_TemperatureSensor_TSYS01;
class AG_TemperatureSensor_MCP9600;
class AG_TemperatureSensor_MAX31865;

class AG_TemperatureSensor
{
    friend class AG_TemperatureSensor_Backend;
    friend class AG_TemperatureSensor_TSYS01;
    friend class AG_TemperatureSensor_MCP9600;
    friend class AG_TemperatureSensor_MAX31865;
...
public:
    ...
    CLASS_NO_COPY(AG_TemperatureSensor);

    static AG_TemperatureSensor *get_singleton() { return _singleton; }
    ...
    // accessors to params
    AG_TemperatureSensor_Params::Type get_type(const uint8_t instance = AP_TEMPERATURE_SENSOR_PRIMARY_INSTANCE) const;
    AG_TemperatureSensor_Params::Source get_source(const uint8_t instance = AP_TEMPERATURE_SENSOR_PRIMARY_INSTANCE) const;
...
protected:
    // parameters
    AG_TemperatureSensor_Params _params[AP_TEMPERATURE_SENSOR_MAX_INSTANCES];

private:
    static AG_TemperatureSensor *_singleton;
    ...
    AG_TemperatureSensor_Backend *drivers[AP_TEMPERATURE_SENSOR_MAX_INSTANCES];
