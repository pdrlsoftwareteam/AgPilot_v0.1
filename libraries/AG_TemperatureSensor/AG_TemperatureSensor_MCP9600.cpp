...
#define AG_TemperatureSensor_MCP9600_UPDATE_INTERVAL_MS     500
#define AG_TemperatureSensor_MCP9600_SCALE_FACTOR           (0.0625f)

#ifndef AG_TemperatureSensor_MCP9600_ADDR_DEFAULT
    #define AG_TemperatureSensor_MCP9600_ADDR_DEFAULT    MCP9600_ADDR_LOW
#endif

#ifndef AG_TemperatureSensor_MCP9600_ENFORCE_KNOWN_VALID_I2C_ADDRESS
#define AG_TemperatureSensor_MCP9600_ENFORCE_KNOWN_VALID_I2C_ADDRESS 1
#endif

#ifndef AG_TemperatureSensor_MCP9600_Filter
    #define AG_TemperatureSensor_MCP9600_Filter         2   // can be values 0 through 7 where 0 is no filtering (fast) and 7 is lots of smoothing (very very slow)
#endif

void AG_TemperatureSensor_MCP9600::init()
{
    constexpr char name[] = "MCP9600";

#if AG_TemperatureSensor_MCP9600_ENFORCE_KNOWN_VALID_I2C_ADDRESS
    ...
    if (!set_config(ThermocoupleType::K, AG_TemperatureSensor_MCP9600_Filter)) {
    ...
    _dev->register_periodic_callback(100 * AP_USEC_PER_MSEC,
                                     FUNCTOR_BIND_MEMBER(&AG_TemperatureSensor_MCP9600::_timer, void));
}

void AG_TemperatureSensor_MCP9600::_timer()
{
    float temperature;
...
bool AG_TemperatureSensor_MCP9600::set_config(const ThermocoupleType thermoType, const uint8_t filter)
{
...
bool AG_TemperatureSensor_MCP9600::read_temperature(float &temperature)
{
    uint8_t data[2];
    ...
    temperature = int16_t(UINT16_VALUE(data[0], data[1])) * AG_TemperatureSensor_MCP9600_SCALE_FACTOR;
    return true;
}
