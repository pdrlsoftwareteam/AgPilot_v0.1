...
void AG_TemperatureSensor_MAX31865::init()
{
    if (_dev) {
        return;
    }
    ...
    _dev->register_periodic_callback(100 * AP_USEC_PER_MSEC,
                                     FUNCTOR_BIND_MEMBER(&AG_TemperatureSensor_MAX31865::thread_tick, void));
}

void AG_TemperatureSensor_MAX31865::thread_tick()
{
    uint16_t raw_data;
