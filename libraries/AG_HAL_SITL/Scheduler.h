...
class HALSITL::Scheduler : public AG_HAL::Scheduler {
public:
    ...
    /*
      create a new thread
     */
    bool thread_create(AG_HAL::MemberProc, const char *name,
...
private:
    ...
    static AG_HAL::Proc _failsafe;

    static void _run_timer_procs();

    static volatile bool _timer_event_missed;
    static AG_HAL::MemberProc _timer_proc[SITL_SCHEDULER_MAX_TIMER_PROCS];
    static AG_HAL::MemberProc _io_proc[SITL_SCHEDULER_MAX_TIMER_PROCS];
