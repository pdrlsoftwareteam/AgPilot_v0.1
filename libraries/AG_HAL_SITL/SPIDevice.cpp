...
public:
    ...
    AG_HAL::Device::PeriodicHandle register_periodic_callback(uint32_t period_usec, AG_HAL::Device::PeriodicCb cb);
...
AG_HAL::Device::PeriodicHandle SPIBus::register_periodic_callback(uint32_t period_usec, AG_HAL::Device::PeriodicCb cb)
{
    ...
    callback->next_usec = AG_HAL::micros64() + period_usec;
...
{
    // this was swiped from AG_HAL_ChibiOS
