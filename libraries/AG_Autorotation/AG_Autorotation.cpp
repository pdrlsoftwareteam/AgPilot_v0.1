...
const AG_Param::GroupInfo AG_Autorotation::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO_FLAGS("ENABLE", 1, AG_Autorotation, _param_enable, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_SUBGROUPINFO(_p_hs, "HS_", 2, AG_Autorotation, AG_P),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("HS_SET_PT", 3, AG_Autorotation, _param_head_speed_set_point, 1500),
    ...
    // @Increment: 50
    // @User: Advanced
    AP_GROUPINFO("TARG_SP", 4, AG_Autorotation, _param_target_speed, FWD_SPD_CONTROLLER_GND_SPEED_TARGET),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("COL_FILT_E", 5, AG_Autorotation, _param_col_entry_cutoff_freq, HS_CONTROLLER_ENTRY_COL_FILTER),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("COL_FILT_G", 6, AG_Autorotation, _param_col_glide_cutoff_freq, HS_CONTROLLER_GLIDE_COL_FILTER),
    ...
    // @Increment: 10
    // @User: Advanced
    AP_GROUPINFO("AS_ACC_MAX", 7, AG_Autorotation, _param_accel_max, FWD_SPD_CONTROLLER_MAX_ACCEL),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("BAIL_TIME", 8, AG_Autorotation, _param_bail_time, AROT_BAIL_OUT_TIME),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("HS_SENSOR", 9, AG_Autorotation, _param_rpm_instance, 0),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_SUBGROUPINFO(_p_fw_vel, "FW_V_", 10, AG_Autorotation, AG_P),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("FW_V_FF", 11, AG_Autorotation, _param_fwd_k_ff, AP_FW_VEL_FF),

    AP_GROUPEND
};

// Constructor
AG_Autorotation::AG_Autorotation() :
...
void AG_Autorotation::init_hs_controller()
{
...
bool AG_Autorotation::update_hs_glide_controller(float dt)
{
...
void AG_Autorotation::set_collective(float collective_filter_cutoff) const
{
...
float AG_Autorotation::get_rpm(bool update_counter)
{
    float current_rpm = 0.0f;

#if AG_RPM_ENABLED
    // Get singleton for RPM library
    const AG_RPM *rpm = AG_RPM::get_singleton();
...
void AG_Autorotation::Log_Write_Autorotation(void) const
{
// @LoggerMessage: AROT
// @Vehicles: Copter
...
void AG_Autorotation::init_fwd_spd_controller(void)
{
...
void AG_Autorotation::set_dt(float delta_sec)
{
    _dt = delta_sec;
}
...
void AG_Autorotation::update_forward_speed_controller(void)
{
...
float AG_Autorotation::calc_speed_forward(void)
{
    auto &ahrs = AP::ahrs();
