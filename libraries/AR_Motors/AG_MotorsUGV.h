...
public:
    // Constructor
    AG_MotorsUGV(AG_ServoRelayEvents &relayEvents, AG_WheelRateControl& rate_controller);

    // singleton support
    static AG_MotorsUGV    *get_singleton(void) { return _singleton; }
...
private:
    ...
    // external references
    AG_ServoRelayEvents &_relayEvents;
    AG_WheelRateControl &_rate_controller;
    ...
    static AG_MotorsUGV *_singleton;
};
