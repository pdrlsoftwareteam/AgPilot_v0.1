...
class AG_Proximity_Backend_Serial : public AG_Proximity_Backend
{
public:
    AG_Proximity_Backend_Serial(AG_Proximity &_frontend,
...
protected:
    ...
    AG_HAL::UARTDriver *_uart;              // uart for communicating with sensor
};
