...
class AG_Proximity_LightWareSF45B : public AG_Proximity_LightWareSerial
{

public:
    // constructor
    AG_Proximity_LightWareSF45B(AG_Proximity &_frontend,
                                AG_Proximity::Proximity_State &_state,
                                AG_Proximity_Params& _params,
                                uint8_t serial_instance) :
            AG_Proximity_LightWareSerial(_frontend, _state, _params, serial_instance) {}
...
private:
    ...
    AG_Proximity_Boundary_3D::Face _face;   // face of most recently received distance
