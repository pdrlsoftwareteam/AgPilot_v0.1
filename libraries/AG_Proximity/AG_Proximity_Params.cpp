#include "AG_Proximity_Params.h"

// table of user settable parameters
const AG_Param::GroupInfo AG_Proximity_Params::var_info[] = {
    ...
    // @RebootRequired: True
    // @User: Standard
    AP_GROUPINFO_FLAGS("_TYPE",   1, AG_Proximity_Params, type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @User: Standard
    AP_GROUPINFO("_ORIENT", 2, AG_Proximity_Params, orientation, 0),
    ...
    // @Range: -180 180
    // @User: Standard
    AP_GROUPINFO("_YAW_CORR", 3, AG_Proximity_Params, yaw_correction, 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("_IGN_ANG1", 4, AG_Proximity_Params, ignore_angle_deg[0], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("_IGN_WID1", 5, AG_Proximity_Params, ignore_width_deg[0], 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("_IGN_ANG2", 6, AG_Proximity_Params, ignore_angle_deg[1], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("_IGN_WID2", 7, AG_Proximity_Params, ignore_width_deg[1], 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("_IGN_ANG3", 8, AG_Proximity_Params, ignore_angle_deg[2], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("_IGN_WID3", 9, AG_Proximity_Params, ignore_width_deg[2], 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("_IGN_ANG4", 10, AG_Proximity_Params, ignore_angle_deg[3], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("_IGN_WID4", 11, AG_Proximity_Params, ignore_width_deg[3], 0),
    ...
    // @Range: 0 500
    // @User: Advanced
    AP_GROUPINFO("_MIN", 16, AG_Proximity_Params, min_m, 0.0f),
    ...
    // @Range: 0 500
    // @User: Advanced
    AP_GROUPINFO("_MAX", 17, AG_Proximity_Params, max_m, 0.0f),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_ADDR", 25, AG_Proximity_Params, address, 0),

    AP_GROUPEND
};

AG_Proximity_Params::AG_Proximity_Params(void) {
