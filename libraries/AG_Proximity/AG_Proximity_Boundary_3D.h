...
class AG_Proximity_Boundary_3D
{
public:
    // constructor. This incorporates initialisation as well.
	AG_Proximity_Boundary_3D();
...
class AG_Proximity_Temp_Boundary
{
public:
    // constructor. This incorporates initialisation as well.
	AG_Proximity_Temp_Boundary() { reset(); }
    ...
    void add_distance(const AG_Proximity_Boundary_3D::Face &face, float pitch, float yaw, float distance);
    void add_distance(const AG_Proximity_Boundary_3D::Face &face, float yaw, float distance) { add_distance(face, 0.0f, yaw, distance); }

    // fill the original 3D boundary with the contents of this temporary boundary
    // prx_instance should be set to the proximity sensor's backend instance number
    void update_3D_boundary(uint8_t prx_instance, AG_Proximity_Boundary_3D &boundary);
