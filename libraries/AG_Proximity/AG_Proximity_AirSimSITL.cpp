...
void AG_Proximity_AirSimSITL::update(void)
{
...
float AG_Proximity_AirSimSITL::distance_max() const
{
    return PROXIMITY_MAX_RANGE;
}

float AG_Proximity_AirSimSITL::distance_min() const
{
    return 0.0f;
}

// get distance upwards in meters. returns true on success
bool AG_Proximity_AirSimSITL::get_upward_distance(float &distance) const
{
