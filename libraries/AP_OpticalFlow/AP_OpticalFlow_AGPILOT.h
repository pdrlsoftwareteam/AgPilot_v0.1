...
#ifndef AP_OPTICALFLOW_AGPILOT_ENABLED
#define AP_OPTICALFLOW_AGPILOT_ENABLED AP_OPTICALFLOW_ENABLED
#endif
...
class AP_OpticalFlow_AGPILOT : public OpticalFlow_backend
{
public:
    /// constructor
    ...
    static AP_OpticalFlow_AGPILOT *detect(AP_OpticalFlow &_frontend);
