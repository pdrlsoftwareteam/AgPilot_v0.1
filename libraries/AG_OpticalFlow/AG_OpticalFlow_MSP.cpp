...
// detect the device
AG_OpticalFlow_MSP *AG_OpticalFlow_MSP::detect(AG_OpticalFlow &_frontend)
{
    // we assume msp messages will be sent into this driver
    return new AG_OpticalFlow_MSP(_frontend);
}

// read latest values from sensor and fill in x,y and totals.
void AG_OpticalFlow_MSP::update(void)
{
...
void AG_OpticalFlow_MSP::handle_msp(const MSP::msp_opflow_data_message_t &pkt)
{
