...
// constructor
AG_OpticalFlow_UPFLOW::AG_OpticalFlow_UPFLOW(AG_OpticalFlow &_frontend, AG_HAL::UARTDriver *_uart) :
...
// detect the device
AG_OpticalFlow_UPFLOW *AG_OpticalFlow_UPFLOW::detect(AG_OpticalFlow &_frontend)
{
    ...
    AG_OpticalFlow_UPFLOW *sensor = new AG_OpticalFlow_UPFLOW(_frontend, uart);
    return sensor;
}

// initialise the sensor
void AG_OpticalFlow_UPFLOW::init()
{
    // sanity check uart
    if (uart == nullptr) {
        return;
...
void AG_OpticalFlow_UPFLOW::update(void)
{
    // sanity check uart
    if (uart == nullptr) {
        return;
