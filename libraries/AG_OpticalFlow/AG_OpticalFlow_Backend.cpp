...
OpticalFlow_backend::OpticalFlow_backend(AG_OpticalFlow &_frontend) :
    frontend(_frontend)
{
}
...
// update the frontend
void OpticalFlow_backend::_update_frontend(const struct AG_OpticalFlow::OpticalFlow_state &state)
{
