...
// detect the device
AG_OpticalFlow_MAV *AG_OpticalFlow_MAV::detect(AG_OpticalFlow &_frontend)
{
    // we assume mavlink messages will be sent into this driver
    AG_OpticalFlow_MAV *sensor = new AG_OpticalFlow_MAV(_frontend);
    return sensor;
}

// read latest values from sensor and fill in x,y and totals.
void AG_OpticalFlow_MAV::update(void)
{
...
void AG_OpticalFlow_MAV::handle_msg(const mavlink_message_t &msg)
{
    ...
    latest_frame_us = AG_HAL::micros64();
