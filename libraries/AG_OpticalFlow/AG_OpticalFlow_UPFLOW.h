...
class AG_OpticalFlow_UPFLOW : public OpticalFlow_backend
{
public:
    /// constructor
    AG_OpticalFlow_UPFLOW(AG_OpticalFlow &_frontend, AG_HAL::UARTDriver *uart);
    ...
    static AG_OpticalFlow_UPFLOW *detect(AG_OpticalFlow &_frontend);
...
private:
    ...
    AG_HAL::UARTDriver *uart;               // uart connected to flow sensor
