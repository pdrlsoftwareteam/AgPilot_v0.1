...
#include "AG_OpticalFlow_Calibrator.h"
...
void AG_OpticalFlow_Calibrator::start()
{
...
void AG_OpticalFlow_Calibrator::stop()
{
...
bool AG_OpticalFlow_Calibrator::update()
{
...
Vector2f AG_OpticalFlow_Calibrator::get_scalars()
{
...
void AG_OpticalFlow_Calibrator::add_sample(uint32_t timestamp_ms, const Vector2f& flow_rate, const Vector2f& body_rate, const Vector2f& los_pred)
{
...
bool AG_OpticalFlow_Calibrator::sample_buffers_full() const
{
...
bool AG_OpticalFlow_Calibrator::run_calibration()
{
...
bool AG_OpticalFlow_Calibrator::calc_scalars(uint8_t axis, float& scalar, float& fitness)
{
    // prefix for reporting
    const char* prefix_str = "FlowCal:";
...
float AG_OpticalFlow_Calibrator::calc_sample_residual(const sample_t& sample, float scalar) const
{
...
bool AG_OpticalFlow_Calibrator::calc_sample_best_scalar(const sample_t& sample, float& best_scalar) const
{
...
float AG_OpticalFlow_Calibrator::calc_mean_squared_residuals(uint8_t axis, float scalar) const
{
    // sanity check axis
    if (axis >= 2) {
...
// log all samples
void AG_OpticalFlow_Calibrator::log_sample(uint8_t axis, uint8_t sample_num, float flow_rate, float body_rate, float los_pred)
{
    // @LoggerMessage: OFCA
