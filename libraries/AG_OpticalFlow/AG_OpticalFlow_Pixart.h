...
class AG_OpticalFlow_Pixart : public OpticalFlow_backend
{
public:
    /// constructor
    AG_OpticalFlow_Pixart(const char *devname, AG_OpticalFlow &_frontend);
    ...
    static AG_OpticalFlow_Pixart *detect(const char *devname, AG_OpticalFlow &_frontend);
