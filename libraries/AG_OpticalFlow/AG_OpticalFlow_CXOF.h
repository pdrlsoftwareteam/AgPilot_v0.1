...
class AG_OpticalFlow_CXOF : public OpticalFlow_backend
{
public:
    /// constructor
    AG_OpticalFlow_CXOF(AG_OpticalFlow &_frontend, AG_HAL::UARTDriver *uart);
    ...
    static AG_OpticalFlow_CXOF *detect(AG_OpticalFlow &_frontend);
