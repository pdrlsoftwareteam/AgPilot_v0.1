...
class AG_OpticalFlow_PX4Flow : public OpticalFlow_backend
{
public:
    /// constructor
    using OpticalFlow_backend::OpticalFlow_backend;

    CLASS_NO_COPY(AG_OpticalFlow_PX4Flow);
    ...
    static AG_OpticalFlow_PX4Flow *detect(AG_OpticalFlow &_frontend);
