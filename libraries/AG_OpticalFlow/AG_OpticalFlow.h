...
/*
 * AG_OpticalFlow.h - OpticalFlow Base Class for ArduPilot
 */
...
public:
    ...
    CLASS_NO_COPY(AG_OpticalFlow);

    // get singleton instance
    static AG_OpticalFlow *get_singleton() {
        return _singleton;
    }
...
private:
    ...
    static AG_OpticalFlow *_singleton;

    OpticalFlow_backend *backend;

    struct AG_OpticalFlow_Flags {
    ...
    // calibrator
    AG_OpticalFlow_Calibrator *_calibrator;
...
#include "AG_OpticalFlow_Backend.h"
