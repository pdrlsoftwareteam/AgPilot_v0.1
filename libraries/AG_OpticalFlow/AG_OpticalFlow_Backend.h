...
/*
  AG_OpticalFlow backend class for ArduPilot
 */
...
{
    friend class AG_OpticalFlow;

public:
    // constructor
    OpticalFlow_backend(AG_OpticalFlow &_frontend);
...
protected:
    // access to frontend
    AG_OpticalFlow &frontend;

    // update the frontend
    void _update_frontend(const struct AG_OpticalFlow::OpticalFlow_state &state);
