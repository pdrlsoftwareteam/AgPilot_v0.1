...
void GCS_MAVLINK::handle_param_set(const mavlink_message_t &msg)
{
    ...
    char ParamName[6][17]={
                ...
                "BATT_AMP_OFFSET","BATT_VLT_OFFSET","BATT2_MONITOR","FLTMODE_CH","BATT2_VOLT_PIN",
                "BATT2_CURR_PIN","FRAME_TYPE","FRAME_CLASS","FENCE_ALT_MAX","FENCE_RADIUS",
                "LOIT_SPEED","RNGFND1_TYPE","RNGFND1_MIN_CM","RNGFND1_MAX_CM","RNGFND1_GNDCLEAR",
