...
public:
    AG_ExternalAHRS_backend(AG_ExternalAHRS *frontend, AG_ExternalAHRS::state_t &state);
...
protected:
    AG_ExternalAHRS::state_t &state;
    uint16_t get_rate(void) const;
    bool option_is_set(AG_ExternalAHRS::OPTIONS option) const;

private:
    AG_ExternalAHRS &frontend;
};
