...
#include "AG_ExternalAHRS_config.h"
...
#include <AG_NavEKF/AG_Nav_Common.h>

class AG_ExternalAHRS_backend;

class AG_ExternalAHRS {

public:
    friend class AG_ExternalAHRS_backend;
    friend class AG_ExternalAHRS_VectorNav;
    ...
    static AG_ExternalAHRS *get_singleton(void) {
        return _singleton;
    }
...
private:
    AG_ExternalAHRS_backend *backend;
    ...
    static AG_ExternalAHRS *_singleton;
