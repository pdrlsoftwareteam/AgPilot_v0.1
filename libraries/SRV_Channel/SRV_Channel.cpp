...
const AP_Param::GroupInfo SRV_Channel::var_info[] = {
    ...
    // @Description: Function assigned to this servo. Setting this to Disabled(0) will setup this output for control by auto missions or AGPILOTLink servo set commands. any other value will enable the corresponding function
