...
class AG_VisualOdom_Backend
{
public:
    // constructor. This incorporates initialisation as well.
    AG_VisualOdom_Backend(AG_VisualOdom &frontend);
...
protected:
    ...
    AG_VisualOdom::VisualOdom_Type get_type(void) const {
    ...
    AG_VisualOdom &_frontend;   // reference to frontend
