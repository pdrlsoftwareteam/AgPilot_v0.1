...
const AG_Param::GroupInfo AG_TempCalibration::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO_FLAGS("_ENABLED", 1, AG_TempCalibration, enabled, TC_DISABLED, AP_PARAM_FLAG_ENABLE),
    ...
    // @Volatile: True
    // @User: Advanced
    AP_GROUPINFO("_TEMP_MIN", 2, AG_TempCalibration, temp_min, 0),
    ...
    // @Volatile: True
    // @User: Advanced
    AP_GROUPINFO("_TEMP_MAX", 4, AG_TempCalibration, temp_max, 0),
    ...
    // @Volatile: True
    // @User: Advanced
    AP_GROUPINFO("_BARO_EXP", 5, AG_TempCalibration, baro_exponent, 0),
 ...
 */
float AG_TempCalibration::calculate_correction(float temp, float exponent) const
{
...
/*
  setup for learning
 */
void AG_TempCalibration::setup_learning(void)
{
...
/*
  ...
  calibration
 */
float AG_TempCalibration::calculate_p_range(float baro_factor) const
{
    float sum = 0;
 ...
 */
void AG_TempCalibration::calculate_calibration(void)
{
 ...
 */
void AG_TempCalibration::learn_calibration(void)
{
 ...
 */
void AG_TempCalibration::apply_calibration(void)
{
    AG_Baro &baro = AP::baro();
    // just for first baro now
    if (!baro.healthy(0)) {
        return;
    }
 ...
 */
void AG_TempCalibration::update(void)
{
    switch (enabled.get()) {
    case TC_DISABLED:
        break;
