...
AG_IRLock_SITL_Gazebo::AG_IRLock_SITL_Gazebo() :
    _last_timestamp(0),
    sock(true)
{}

void AG_IRLock_SITL_Gazebo::init(int8_t bus)
{
    ...
    hal.console->printf("AG_IRLock_SITL::init()\n");

    _flags.healthy = true;
}

// retrieve latest sensor data - returns true if new data is available
bool AG_IRLock_SITL_Gazebo::update()
{
