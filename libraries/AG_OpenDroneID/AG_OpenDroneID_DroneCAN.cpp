...
static void handle_arm_status(AG_UAVCAN* ap_uavcan, uint8_t node_id, const ArmStatusCb &cb);

void AG_OpenDroneID::dronecan_init(AG_UAVCAN *uavcan)
{
 ...
 */
void AG_OpenDroneID::dronecan_send(AG_UAVCAN *uavcan)
{
    const uint8_t driver_index = uavcan->get_driver_index();
    const uint8_t driver_mask = 1U<<driver_index;
...
void AG_OpenDroneID::dronecan_send_location(AG_UAVCAN *uavcan)
{
...
void AG_OpenDroneID::dronecan_send_basic_id(AG_UAVCAN *uavcan)
{
...
void AG_OpenDroneID::dronecan_send_system(AG_UAVCAN *uavcan)
{
...
void AG_OpenDroneID::dronecan_send_self_id(AG_UAVCAN *uavcan)
{
...
void AG_OpenDroneID::dronecan_send_operator_id(AG_UAVCAN *uavcan)
{
...
void AG_OpenDroneID::set_arm_status(mavlink_open_drone_id_arm_status_t &status)
{
    WITH_SEMAPHORE(_sem);
    arm_status = status;
