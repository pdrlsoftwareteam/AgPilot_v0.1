...
#include "AG_OpenDroneID_config.h"
...
class AG_OpenDroneID
{
public:
    AG_OpenDroneID();

    /* Do not allow copies */
    CLASS_NO_COPY(AG_OpenDroneID);
    ...
    static AG_OpenDroneID *get_singleton()
    {
        return _singleton;
    }
private:
    static AG_OpenDroneID *_singleton;
    bool _initialised;
    // parameters
    AP_Int8  _enable;
    ...
    void dronecan_init(AG_UAVCAN *uavcan);
    void dronecan_send_location(AG_UAVCAN *uavcan);
    void dronecan_send_basic_id(AG_UAVCAN *uavcan);
    void dronecan_send_system(AG_UAVCAN *uavcan);
    void dronecan_send_self_id(AG_UAVCAN *uavcan);
    void dronecan_send_operator_id(AG_UAVCAN *uavcan);
};
