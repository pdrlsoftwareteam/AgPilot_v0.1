...
#include <AG_RPM/AG_RPM_Params.h>

// table of user settable parameters
const AG_Param::GroupInfo AG_RPM_Params::var_info[] = {
    // @Param: TYPE
    // @DisplayName: RPM type
    // @Description: What type of RPM sensor is connected
    // @Values: 0:None,1:Not Used,2:GPIO,3:EFI,4:Harmonic Notch,5:ESC Telemetry Motors Bitmask,6:Generator
    // @User: Standard
    AP_GROUPINFO_FLAGS("TYPE", 1, AG_RPM_Params, type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @Increment: 0.001
    // @User: Standard
    AP_GROUPINFO("SCALING", 2, AG_RPM_Params, scaling, 1.0f),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MAX", 3, AG_RPM_Params, maximum, 100000),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MIN", 4, AG_RPM_Params, minimum, 10),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("MIN_QUAL", 5, AG_RPM_Params, quality_min, 0.5),
    ...
    // @User: Standard
    AP_GROUPINFO("PIN", 6, AG_RPM_Params, pin, -1),
    ...
    // @User: Advanced
    AP_GROUPINFO("ESC_MASK", 7, AG_RPM_Params, esc_mask, 0),

    AP_GROUPEND
};

AG_RPM_Params::AG_RPM_Params(void)
{
