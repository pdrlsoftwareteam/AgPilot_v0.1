...
AP_PDRL_Logger::AP_PDRL_Logger():
																										m_AG_NPNT_data_helper(AG_NPNT_data_helper::getInstance()),
																										_geofence_file_fd(-1)
{
...

{
	...
	AP::FS().write(outPutFile_fd,m_AG_NPNT_data_helper->permissionArticaftID,strlen(m_AG_NPNT_data_helper->permissionArticaftID));
...
void AP_PDRL_Logger::qciLogGenerationTest(int outPutFile_fd)
{
	if(currentDebugLogType == 0)
	{
		...
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+1));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
		AP::FS().write(outPutFile_fd,"},",strlen("},"));
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+2));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
	}
	else if(currentDebugLogType == 1)
	{
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+3));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
		AP::FS().write(outPutFile_fd,"},",strlen("},"));
		AP::FS().write(outPutFile_fd,"{\"entryType\":\"LAND/DISARM\",",strlen("{\"entryType\":\"LAND/DISARM\","));
		AP::FS().write(outPutFile_fd,"\"latitude\":",strlen("\"latitude\":"));
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+4));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
	}
	else if(currentDebugLogType == 2)
	{
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+5));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
		AP::FS().write(outPutFile_fd,"},",strlen("},"));
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+6));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
		AP::FS().write(outPutFile_fd,"},",strlen("},"));
		AP::FS().write(outPutFile_fd,"{\"entryType\":\"GEOFENCE_BREACH\",",strlen("{\"entryType\":\"GEOFENCE_BREACH\","));
		AP::FS().write(outPutFile_fd,"\"latitude\":",strlen("\"latitude\":"));
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+7));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
		AP::FS().write(outPutFile_fd,"},",strlen("},"));
		AP::FS().write(outPutFile_fd,"{\"entryType\":\"LAND/DISARM\",",strlen("{\"entryType\":\"LAND/DISARM\","));
		AP::FS().write(outPutFile_fd,"\"latitude\":",strlen("\"latitude\":"));
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+8));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
	}
	else if(currentDebugLogType == 3)
	{
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightStartTime)+9));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
		AP::FS().write(outPutFile_fd,"},",strlen("},"));
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightEndTime)+1));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
		AP::FS().write(outPutFile_fd,"},",strlen("},"));
		AP::FS().write(outPutFile_fd,"{\"entryType\":\"TIME_BREACH\",",strlen("{\"entryType\":\"TIME_BREACH\","));
		AP::FS().write(outPutFile_fd,"\"latitude\":",strlen("\"latitude\":"));
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightEndTime)+2));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
		AP::FS().write(outPutFile_fd,"},",strlen("},"));
		AP::FS().write(outPutFile_fd,"{\"entryType\":\"LAND/DISARM\",",strlen("{\"entryType\":\"LAND/DISARM\","));
		AP::FS().write(outPutFile_fd,"\"latitude\":",strlen("\"latitude\":"));
		...
		AP::FS().write(outPutFile_fd,",\"timeStamp\":",strlen(",\"timeStamp\":"));
		memset(lineBuf,0,sizeof(lineBuf));
		snprintf(lineBuf,sizeof(lineBuf),"%u",(unsigned int)((m_AG_NPNT_data_helper->flightEndTime)+3));
		AP::FS().write(outPutFile_fd,lineBuf,strlen(lineBuf));
...
int AP_PDRL_Logger::checkTimeBreach(uint64_t *currentTime)
{
	*currentTime = (*currentTime) + 19800000000;
	if(*currentTime < m_AG_NPNT_data_helper->flightStartTime)
	{
		//time breach
		return 1;
	}
	else if(*currentTime > m_AG_NPNT_data_helper->flightEndTime)
	{
		//time breach
		return 1;
	}
...
size_t AP_PDRL_Logger::encryptHash(char* buffer,size_t dataLenght)
{
    ...
    keyStore = AG_KEYSTORE::getInstance();
...
void AP_PDRL_Logger::signLogFile(char* inFilePath,size_t len)
{
	...
	if( ( ret = mbedtls_rsa_pkcs1_sign( AG_KEYSTORE::getInstance()->rsaPtr, NULL, NULL, MBEDTLS_RSA_PRIVATE, MBEDTLS_MD_SHA256,
			20, hash, buf ) ) != 0 )
	{
		return;
	}
