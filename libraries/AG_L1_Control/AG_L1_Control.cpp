...
#include "AG_L1_Control.h"

extern const AG_HAL::HAL& hal;

// table of user settable parameters
const AG_Param::GroupInfo AG_L1_Control::var_info[] = {
    // @Param: PERIOD
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("PERIOD",    0, AG_L1_Control, _L1_period, 17),
    ...
    // @Increment: 0.05
    // @User: Advanced
    AP_GROUPINFO("DAMPING",   1, AG_L1_Control, _L1_damping, 0.75f),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("XTRACK_I",   2, AG_L1_Control, _L1_xtrack_i_gain, 0.02),
    ...
    // @Range: 0 89
    // @User: Advanced
    AP_GROUPINFO("LIM_BANK",   3, AG_L1_Control, _loiter_bank_limit, 0.0f),
 ...
 */
float AG_L1_Control::get_yaw() const
{
    if (_reverse) {
 ...
 */
int32_t AG_L1_Control::get_yaw_sensor() const
{
    if (_reverse) {
...
/*
  ...
  update_*() operation
 */
int32_t AG_L1_Control::nav_roll_cd(void) const
{
    float ret;
...
/*
  ...
  update_*() operation
 */
float AG_L1_Control::lateral_acceleration(void) const
{
    return _latAccDem;
}

int32_t AG_L1_Control::nav_bearing_cd(void) const
{
    return wrap_180_cd(RadiansToCentiDegrees(_nav_bearing));
}

int32_t AG_L1_Control::bearing_error_cd(void) const
{
    return RadiansToCentiDegrees(_bearing_error);
}

int32_t AG_L1_Control::target_bearing_cd(void) const
{
 ...
 */
float AG_L1_Control::turn_distance(float wp_radius) const
{
 ...
 */
float AG_L1_Control::turn_distance(float wp_radius, float turn_angle) const
{
...
float AG_L1_Control::loiter_radius(const float radius) const
{
...
bool AG_L1_Control::reached_loiter_target(void)
{
    return _WPcircle;
}
 ...
 */
void AG_L1_Control::_prevent_indecision(float &Nu)
{
...
void AG_L1_Control::update_waypoint(const Location &prev_WP, const Location &next_WP, float dist_min)
{
...
void AG_L1_Control::update_loiter(const Location &center_WP, float radius, int8_t loiter_direction)
{
    Location _current_loc;
...
void AG_L1_Control::update_heading_hold(int32_t navigation_heading_cd)
{
...
void AG_L1_Control::update_level_flight(void)
{
    // copy to _target_bearing_cd and _nav_bearing
