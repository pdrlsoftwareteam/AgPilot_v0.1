...
class AG_L1_Control : public AG_Navigation {
public:
    AG_L1_Control(AG_AHRS &ahrs, const AG_TECS *tecs)
        : _ahrs(ahrs)
        , _tecs(tecs)
    {
    ...
    /* Do not allow copies */
    CLASS_NO_COPY(AG_L1_Control);

    /* see AG_Navigation.h for the definitions and units of these
     * functions */
