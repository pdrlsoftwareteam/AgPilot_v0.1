...
class AG_CustomRotations {
public:
    AG_CustomRotations();

    CLASS_NO_COPY(AG_CustomRotations);

    static AG_CustomRotations *get_singleton(void) { return singleton; }
...
private:
    ...
    static AG_CustomRotations *singleton;
};
