...
#pragma once
#include "AG_ADSB_Backend.h"

#if HAL_ADSB_UCP_ENABLED

#define AG_ADSB_UAVIONIX_UCP_CAPTURE_ALL_RX_PACKETS         1
...
class AG_ADSB_uAvionix_UCP : public AG_ADSB_Backend {
public:
    using AG_ADSB_Backend::AG_ADSB_Backend;
