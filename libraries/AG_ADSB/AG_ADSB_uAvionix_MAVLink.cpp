...
bool AG_ADSB_uAvionix_MAVLink::detect()
{
...
void AG_ADSB_uAvionix_MAVLink::update()
{
...
void AG_ADSB_uAvionix_MAVLink::send_dynamic_out(const mavlink_channel_t chan) const
{
 ...
 */
uint32_t AG_ADSB_uAvionix_MAVLink::encode_icao(const uint32_t icao_id) const
{
 ...
 */
uint8_t AG_ADSB_uAvionix_MAVLink::get_encoded_callsign_null_char()
{
 ...
 */
void AG_ADSB_uAvionix_MAVLink::send_configure(const mavlink_channel_t chan)
{
