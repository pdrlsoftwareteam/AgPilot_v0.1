...
const AG_Param::GroupInfo AG_NavEKF_Source::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("1_POSXY", 1, AG_NavEKF_Source, _source_set[0].posxy, (int8_t)AG_NavEKF_Source::SourceXY::GPS),
    ...
    // @User: Advanced
    AP_GROUPINFO("1_VELXY", 2, AG_NavEKF_Source, _source_set[0].velxy, (int8_t)AG_NavEKF_Source::SourceXY::GPS),
    ...
    // @User: Advanced
    AP_GROUPINFO("1_POSZ", 3, AG_NavEKF_Source, _source_set[0].posz, (int8_t)AG_NavEKF_Source::SourceZ::BARO),
    ...
    // @Values: 0:None, 3:GPS, 4:Beacon, 6:ExternalNav
    // @User: Advanced
    AP_GROUPINFO("1_VELZ", 4, AG_NavEKF_Source, _source_set[0].velz, (int8_t)AG_NavEKF_Source::SourceZ::GPS),
    ...
    // @User: Advanced
    AP_GROUPINFO("1_YAW", 5, AG_NavEKF_Source, _source_set[0].yaw, (int8_t)AG_NavEKF_Source::SourceYaw::COMPASS),
    ...
    // @Values: 0:None, 3:GPS, 4:Beacon, 6:ExternalNav
    // @User: Advanced
    AP_GROUPINFO("2_POSXY", 6, AG_NavEKF_Source, _source_set[1].posxy, (int8_t)AG_NavEKF_Source::SourceXY::NONE),
    ...
    // @Values: 0:None, 3:GPS, 4:Beacon, 5:OpticalFlow, 6:ExternalNav, 7:WheelEncoder
    // @User: Advanced
    AP_GROUPINFO("2_VELXY", 7, AG_NavEKF_Source, _source_set[1].velxy, (int8_t)AG_NavEKF_Source::SourceXY::NONE),
    ...
    // @Values: 0:None, 1:Baro, 2:RangeFinder, 3:GPS, 4:Beacon, 6:ExternalNav
    // @User: Advanced
    AP_GROUPINFO("2_POSZ", 8, AG_NavEKF_Source, _source_set[1].posz, (int8_t)AG_NavEKF_Source::SourceZ::BARO),
    ...
    // @Values: 0:None, 3:GPS, 4:Beacon, 6:ExternalNav
    // @User: Advanced
    AP_GROUPINFO("2_VELZ", 9, AG_NavEKF_Source, _source_set[1].velz, (int8_t)AG_NavEKF_Source::SourceZ::NONE),
    ...
    // @Values: 0:None, 1:Compass, 2:GPS, 3:GPS with Compass Fallback, 6:ExternalNav, 8:GSF
    // @User: Advanced
    AP_GROUPINFO("2_YAW", 10, AG_NavEKF_Source, _source_set[1].yaw, (int8_t)AG_NavEKF_Source::SourceYaw::NONE),
#endif
    ...
    // @Values: 0:None, 3:GPS, 4:Beacon, 6:ExternalNav
    // @User: Advanced
    AP_GROUPINFO("3_POSXY", 11, AG_NavEKF_Source, _source_set[2].posxy, (int8_t)AG_NavEKF_Source::SourceXY::NONE),
    ...
    // @Values: 0:None, 3:GPS, 4:Beacon, 5:OpticalFlow, 6:ExternalNav, 7:WheelEncoder
    // @User: Advanced
    AP_GROUPINFO("3_VELXY", 12, AG_NavEKF_Source, _source_set[2].velxy, (int8_t)AG_NavEKF_Source::SourceXY::NONE),
    ...
    // @Values: 0:None, 1:Baro, 2:RangeFinder, 3:GPS, 4:Beacon, 6:ExternalNav
    // @User: Advanced
    AP_GROUPINFO("3_POSZ", 13, AG_NavEKF_Source, _source_set[2].posz, (int8_t)AG_NavEKF_Source::SourceZ::BARO),
    ...
    // @Values: 0:None, 3:GPS, 4:Beacon, 6:ExternalNav
    // @User: Advanced
    AP_GROUPINFO("3_VELZ", 14, AG_NavEKF_Source, _source_set[2].velz, (int8_t)AG_NavEKF_Source::SourceZ::NONE),
    ...
    // @Values: 0:None, 1:Compass, 2:GPS, 3:GPS with Compass Fallback, 6:ExternalNav, 8:GSF
    // @User: Advanced
    AP_GROUPINFO("3_YAW", 15, AG_NavEKF_Source, _source_set[2].yaw, (int8_t)AG_NavEKF_Source::SourceYaw::NONE),
#endif
    ...
    // @User: Advanced
    AP_GROUPINFO("_OPTIONS", 16, AG_NavEKF_Source, _options, (int16_t)SourceOptions::FUSE_ALL_VELOCITIES),

    AP_GROUPEND
};

AG_NavEKF_Source::AG_NavEKF_Source()
{
    AG_Param::setup_object_defaults(this, var_info);
}

// set position, velocity and yaw sources to either 0=primary, 1=secondary, 2=tertiary
void AG_NavEKF_Source::setPosVelYawSourceSet(uint8_t source_set_idx)
{
...
bool AG_NavEKF_Source::useVelXYSource(SourceXY velxy_source) const
{
...
bool AG_NavEKF_Source::useVelZSource(SourceZ velz_source) const
{
...
bool AG_NavEKF_Source::haveVelZSource() const
{
...
// get yaw source
AG_NavEKF_Source::SourceYaw AG_NavEKF_Source::getYawSource() const
{
...
// get pos Z source
AG_NavEKF_Source::SourceZ AG_NavEKF_Source::getPosZSource() const
{
...
void AG_NavEKF_Source::align_inactive_sources()
{
...
bool AG_NavEKF_Source::usingGPS() const
{
...
bool AG_NavEKF_Source::configured()
{
    if (_configured) {
        return true;
    }
...
void AG_NavEKF_Source::mark_configured()
{
...
bool AG_NavEKF_Source::pre_arm_check(bool requires_position, char *failure_msg, uint8_t failure_msg_len) const
{
    auto &dal = AP::dal();
...
bool AG_NavEKF_Source::ext_nav_enabled(void) const
{
    for (uint8_t i=0; i<AP_NAKEKF_SOURCE_SET_MAX; i++) {
...
bool AG_NavEKF_Source::wheel_encoder_enabled(void) const
{
    for (uint8_t i=0; i<AP_NAKEKF_SOURCE_SET_MAX; i++) {
        const auto &src = _source_set[i];
...
uint8_t AG_NavEKF_Source::get_active_source_set() const
{
    return active_source_set;
}

// return true if GPS yaw is enabled on any source
bool AG_NavEKF_Source::gps_yaw_enabled(void) const
{
    for (uint8_t i=0; i<AP_NAKEKF_SOURCE_SET_MAX; i++) {
        const auto &src = _source_set[i];
