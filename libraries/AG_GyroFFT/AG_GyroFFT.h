...
public:
    typedef AG_HAL::DSP::FrequencyPeak FrequencyPeak;
    ...
    static AG_GyroFFT *get_singleton() { return _singleton; }
...
private:
    ...
    class FrequencyData {
    public:
        FrequencyData(const AG_GyroFFT& gyrofft, const EngineConfig& config);
    ...
    AG_HAL::DSP::FFTWindowState* _state;
