 ...
 */
int16_t AG_IOMCU_FW::mix_input_angle(uint8_t channel, uint16_t radio_in) const
{
 ...
 */
int16_t AG_IOMCU_FW::mix_input_range(uint8_t channel, uint16_t radio_in) const
{
    const uint16_t &rc_min = mixing.rc_min[channel];
    const uint16_t &rc_max = mixing.rc_max[channel];
    const uint16_t &reversed = mixing.rc_reversed[channel];
 ...
 */
uint16_t AG_IOMCU_FW::mix_output_angle(uint8_t channel, int16_t angle) const
{
 ...
 */
uint16_t AG_IOMCU_FW::mix_output_range(uint8_t channel, int16_t value) const
{
    const uint16_t &srv_min = mixing.servo_min[channel];
    const uint16_t &srv_max = mixing.servo_max[channel];
    const uint16_t &reversed = mixing.servo_reversed[channel];
 ...
 */
int16_t AG_IOMCU_FW::mix_elevon_vtail(int16_t angle1, int16_t angle2, bool first_output) const
{
    if (first_output) {
 ...
 */
void AG_IOMCU_FW::run_mixer(void)
{
