...
#include <AG_Common/AG_ExpandingArray.h>
...
public:
    ...
    CLASS_NO_COPY(AG_AIS);

    // get singleton instance
    static AG_AIS *get_singleton();
...
private:
    ...
    AG_ExpandingArray<ais_vehicle_t> _list {8};
