/*
   ...
   This class inherits from AG_AttitudeControl_Multi and provides functionality
 ...
 */
#include "AG_AttitudeControl_TS.h"

void AG_AttitudeControl_TS::relax_attitude_controllers(bool exclude_pitch)
{
    ...
    if (exclude_pitch) {
        ...
        AG_AttitudeControl::relax_attitude_controllers();
    }
}
...
void AG_AttitudeControl_TS::input_euler_rate_yaw_euler_angle_pitch_bf_roll(bool plane_controls, float body_roll_cd, float euler_pitch_cd, float euler_yaw_rate_cds)
{
