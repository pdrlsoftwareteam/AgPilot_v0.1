...
const AG_Param::GroupInfo AG_AttitudeControl_Multi::var_info[] = {
    // parameters from parent vehicle
    AP_NESTEDGROUPINFO(AG_AttitudeControl, 0),
    ...
    AP_SUBGROUPINFO(_pid_rate_roll, "RAT_RLL_", 1, AG_AttitudeControl_Multi, AG_PID),
    ...
    AP_SUBGROUPINFO(_pid_rate_pitch, "RAT_PIT_", 2, AG_AttitudeControl_Multi, AG_PID),
    ...
    AP_SUBGROUPINFO(_pid_rate_yaw, "RAT_YAW_", 3, AG_AttitudeControl_Multi, AG_PID),
    ...
    // @Range: 0.1 0.25
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MIN", 4, AG_AttitudeControl_Multi, _thr_mix_min, AC_ATTITUDE_CONTROL_MIN_DEFAULT),
    ...
    // @Range: 0.5 0.9
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MAX", 5, AG_AttitudeControl_Multi, _thr_mix_max, AC_ATTITUDE_CONTROL_MAX_DEFAULT),
    ...
    // @Range: 0.1 0.9
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MAN", 6, AG_AttitudeControl_Multi, _thr_mix_man, AC_ATTITUDE_CONTROL_MAN_DEFAULT),
    ...
    // @Range: 0 1
    // @User: Advanced
    AP_GROUPINFO("THR_G_BOOST", 7, AG_AttitudeControl_Multi, _throttle_gain_boost, 0.0f),

    AP_GROUPEND
};

AG_AttitudeControl_Multi::AG_AttitudeControl_Multi(AG_AHRS_View &ahrs, const AG_MultiCopter &aparm, AG_MotorsMulticopter& motors) :
    AG_AttitudeControl(ahrs, aparm, motors),
...
void AG_AttitudeControl_Multi::update_althold_lean_angle_max(float throttle_in)
{
...
void AG_AttitudeControl_Multi::set_throttle_out(float throttle_in, bool apply_angle_boost, float filter_cutoff)
{
...
void AG_AttitudeControl_Multi::set_throttle_mix_max(float ratio)
{
...
float AG_AttitudeControl_Multi::get_throttle_boosted(float throttle_in)
{
...
// returns a throttle including compensation for roll/pitch angle
// throttle value should be 0 ~ 1
float AG_AttitudeControl_Multi::get_throttle_avg_max(float throttle_in)
{
...
void AG_AttitudeControl_Multi::update_throttle_gain_boost()
{
...
void AG_AttitudeControl_Multi::update_throttle_rpy_mix()
{
...
void AG_AttitudeControl_Multi::rate_controller_run()
{
...
void AG_AttitudeControl_Multi::parameter_sanity_check()
{
