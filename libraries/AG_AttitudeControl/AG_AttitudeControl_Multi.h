...
/// @file    AG_AttitudeControl_Multi.h
...
class AG_AttitudeControl_Multi : public AG_AttitudeControl {
public:
	AG_AttitudeControl_Multi(AG_AHRS_View &ahrs, const AG_MultiCopter &aparm, AG_MotorsMulticopter& motors);

	// empty destructor to suppress compiler warning
	virtual ~AG_AttitudeControl_Multi() {}

    // pid accessors
    AG_PID& get_rate_roll_pid() override { return _pid_rate_roll; }
    AG_PID& get_rate_pitch_pid() override { return _pid_rate_pitch; }
    AG_PID& get_rate_yaw_pid() override { return _pid_rate_yaw; }
...
protected:
    ...
    AG_MotorsMulticopter& _motors_multi;
    AG_PID                _pid_rate_roll;
    AG_PID                _pid_rate_pitch;
    AG_PID                _pid_rate_yaw;
