...
class AG_AttitudeControl_Multi_6DoF : public AG_AttitudeControl_Multi {
public:
    AG_AttitudeControl_Multi_6DoF(AG_AHRS_View &ahrs, const AG_MultiCopter &aparm, AG_MotorsMulticopter& motors):
        AG_AttitudeControl_Multi(ahrs,aparm,motors) {

        if (_singleton != nullptr) {
            AG_HAL::panic("Can only be one AG_AttitudeControl_Multi_6DoF");
        }
        _singleton = this;
    }

    static AG_AttitudeControl_Multi_6DoF *get_singleton() {
        return _singleton;
    }
...
private:
    ...
    static AG_AttitudeControl_Multi_6DoF *_singleton;
