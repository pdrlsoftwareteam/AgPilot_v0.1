...
class AG_AttitudeControl_Sub : public AG_AttitudeControl {
public:
    AG_AttitudeControl_Sub(AG_AHRS_View &ahrs, const AG_MultiCopter &aparm, AG_MotorsMulticopter& motors);

    // empty destructor to suppress compiler warning
    virtual ~AG_AttitudeControl_Sub() {}
