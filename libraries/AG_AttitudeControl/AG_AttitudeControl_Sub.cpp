#include "AG_AttitudeControl_Sub.h"
#include <AG_HAL/AG_HAL.h>
#include <AG_Math/AG_Math.h>

// table of user settable parameters
const AG_Param::GroupInfo AG_AttitudeControl_Sub::var_info[] = {
    ...
    AP_SUBGROUPINFO(_pid_rate_roll, "RAT_RLL_", 1, AG_AttitudeControl_Sub, AG_PID),
    ...
    AP_SUBGROUPINFO(_pid_rate_pitch, "RAT_PIT_", 2, AG_AttitudeControl_Sub, AG_PID),
    ...
    AP_SUBGROUPINFO(_pid_rate_yaw, "RAT_YAW_", 3, AG_AttitudeControl_Sub, AG_PID),
    ...
    // @Range: 0.1 0.25
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MIN", 4, AG_AttitudeControl_Sub, _thr_mix_min, AC_ATTITUDE_CONTROL_MIN_DEFAULT),
    ...
    // @Range: 0.5 0.9
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MAX", 5, AG_AttitudeControl_Sub, _thr_mix_max, AC_ATTITUDE_CONTROL_MAX_DEFAULT),
    ...
    // @Range: 0.5 0.9
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MAN", 6, AG_AttitudeControl_Sub, _thr_mix_man, AC_ATTITUDE_CONTROL_MAN_DEFAULT),
...
AG_AttitudeControl_Sub::AG_AttitudeControl_Sub(AG_AHRS_View &ahrs, const AG_MultiCopter &aparm, AG_MotorsMulticopter& motors) :
...
void AG_AttitudeControl_Sub::update_althold_lean_angle_max(float throttle_in)
{
...
void AG_AttitudeControl_Sub::set_throttle_out(float throttle_in, bool apply_angle_boost, float filter_cutoff)
{
...
float AG_AttitudeControl_Sub::get_throttle_boosted(float throttle_in)
{
...
// returns a throttle including compensation for roll/pitch angle
// throttle value should be 0 ~ 1
float AG_AttitudeControl_Sub::get_throttle_avg_max(float throttle_in)
{
...
void AG_AttitudeControl_Sub::update_throttle_rpy_mix()
{
...
void AG_AttitudeControl_Sub::rate_controller_run()
{
...
void AG_AttitudeControl_Sub::parameter_sanity_check()
{
