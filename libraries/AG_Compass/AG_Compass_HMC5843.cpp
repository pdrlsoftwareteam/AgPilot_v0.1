...
/*
 *       AG_Compass_HMC5843.cpp - Arduino Library for HMC5843 I2C magnetometer
...
#include <AG_InertialSensor/AuxiliaryBus.h>
...
AG_Compass_HMC5843::AG_Compass_HMC5843(AP_HMC5843_BusDriver *bus,
...
AG_Compass_HMC5843::~AG_Compass_HMC5843()
{
    delete _bus;
}

AG_Compass_Backend *AG_Compass_HMC5843::probe(AG_HAL::OwnPtr<AG_HAL::Device> dev,
                                              bool force_external,
                                              enum Rotation rotation)
{
    ...
    AG_Compass_HMC5843 *sensor = new AG_Compass_HMC5843(bus, force_external, rotation);
...
AG_Compass_Backend *AG_Compass_HMC5843::probe_mpu6000(enum Rotation rotation)
{
    ...
    AG_Compass_HMC5843 *sensor = new AG_Compass_HMC5843(bus, false, rotation);
    if (!sensor || !sensor->init()) {
        delete sensor;
        return nullptr;
    }
...
bool AG_Compass_HMC5843::init()
{
    ...
    _bus->register_periodic_callback(13333,
                                     FUNCTOR_BIND_MEMBER(&AG_Compass_HMC5843::_timer, void));
 ...
 */
void AG_Compass_HMC5843::_timer()
{
...
bool AG_Compass_HMC5843::_setup_sampling_mode()
{
 ...
 */
bool AG_Compass_HMC5843::_read_sample()
{
    struct PACKED {
        be16_t rx;
        be16_t ry;
 ...
 */
void AG_Compass_HMC5843::_take_sample()
{
    _bus->register_write(HMC5843_REG_MODE,
                         HMC5843_MODE_SINGLE);
}

bool AG_Compass_HMC5843::_check_whoami()
{
    uint8_t id[3];
...
bool AG_Compass_HMC5843::_calibrate()
{
...
/* AG_HAL::Device implementation of the HMC5843 */
AP_HMC5843_BusDriver_HALDevice::AP_HMC5843_BusDriver_HALDevice(AG_HAL::OwnPtr<AG_HAL::Device> dev)
    : _dev(std::move(dev))
{
...
AG_HAL::Semaphore *AP_HMC5843_BusDriver_HALDevice::get_semaphore()
{
    return _dev->get_semaphore();
}

AG_HAL::Device::PeriodicHandle AP_HMC5843_BusDriver_HALDevice::register_periodic_callback(uint32_t period_usec, AG_HAL::Device::PeriodicCb cb)
{
...
AP_HMC5843_BusDriver_Auxiliary::AP_HMC5843_BusDriver_Auxiliary(AG_InertialSensor &ins, uint8_t backend_id,
                                                               uint8_t addr)
{
    /*
...
AG_HAL::Semaphore *AP_HMC5843_BusDriver_Auxiliary::get_semaphore()
{
...
AG_HAL::Device::PeriodicHandle AP_HMC5843_BusDriver_Auxiliary::register_periodic_callback(uint32_t period_usec, AG_HAL::Device::PeriodicCb cb)
{
