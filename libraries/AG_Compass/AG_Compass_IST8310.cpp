...
AG_Compass_Backend *AG_Compass_IST8310::probe(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev,
                                              bool force_external,
                                              enum Rotation rotation)
{
    ...
    AG_Compass_IST8310 *sensor = new AG_Compass_IST8310(std::move(dev), force_external, rotation);
...
AG_Compass_IST8310::AG_Compass_IST8310(AG_HAL::OwnPtr<AG_HAL::Device> dev,
                                       bool force_external,
                                       enum Rotation rotation)
    : _dev(std::move(dev))
    , _rotation(rotation)
...
bool AG_Compass_IST8310::init()
{
    ...
    _periodic_handle = _dev->register_periodic_callback(SAMPLING_PERIOD_USEC,
        FUNCTOR_BIND_MEMBER(&AG_Compass_IST8310::timer, void));
...
void AG_Compass_IST8310::start_conversion()
{
