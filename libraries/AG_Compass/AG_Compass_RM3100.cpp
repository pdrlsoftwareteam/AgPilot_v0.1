...
AG_Compass_Backend *AG_Compass_RM3100::probe(AG_HAL::OwnPtr<AG_HAL::Device> dev,
                                              bool force_external,
                                              enum Rotation rotation)
{
    ...
    AG_Compass_RM3100 *sensor = new AG_Compass_RM3100(std::move(dev), force_external, rotation);
...
AG_Compass_RM3100::AG_Compass_RM3100(AG_HAL::OwnPtr<AG_HAL::Device> _dev,
...
bool AG_Compass_RM3100::init()
{
    ...
    dev->register_periodic_callback(1000000U/80U,
                                    FUNCTOR_BIND_MEMBER(&AG_Compass_RM3100::timer, void));

    return true;
}

void AG_Compass_RM3100::timer()
{
    struct PACKED {
        uint8_t magx_2;
        uint8_t magx_1;
