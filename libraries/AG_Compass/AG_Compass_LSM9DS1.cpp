...
AG_Compass_LSM9DS1::AG_Compass_LSM9DS1(AG_HAL::OwnPtr<AG_HAL::Device> dev,
...
AG_Compass_Backend *AG_Compass_LSM9DS1::probe(AG_HAL::OwnPtr<AG_HAL::Device> dev,
                                              enum Rotation rotation)
{
    if (!dev) {
        return nullptr;
    }
    AG_Compass_LSM9DS1 *sensor = new AG_Compass_LSM9DS1(std::move(dev), rotation);
...
bool AG_Compass_LSM9DS1::init()
{
    AG_HAL::Semaphore *bus_sem = _dev->get_semaphore();
    ...
    _dev->register_periodic_callback(10000, FUNCTOR_BIND_MEMBER(&AG_Compass_LSM9DS1::_update, void));
...
void AG_Compass_LSM9DS1::_dump_registers()
{
...
void AG_Compass_LSM9DS1::_update(void)
{
...
void AG_Compass_LSM9DS1::read()
{
    drain_accumulated_samples(_compass_instance);
}

bool AG_Compass_LSM9DS1::_check_id(void)
{
...
bool AG_Compass_LSM9DS1::_configure(void)
{
...
bool AG_Compass_LSM9DS1::_set_scale(void)
{
...
uint8_t AG_Compass_LSM9DS1::_register_read(uint8_t reg)
{
    uint8_t val = 0;
...
bool AG_Compass_LSM9DS1::_block_read(uint8_t reg, uint8_t *buf, uint32_t size)
{
    /* set !MS bit */
    reg |= 0xc0;
...
void AG_Compass_LSM9DS1::_register_write(uint8_t reg, uint8_t val)
{
    _dev->write_register(reg, val);
}

void AG_Compass_LSM9DS1::_register_modify(uint8_t reg, uint8_t clearbits, uint8_t setbits)
{
    uint8_t val;
