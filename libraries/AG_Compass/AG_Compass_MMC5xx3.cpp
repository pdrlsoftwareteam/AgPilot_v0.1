...
AG_Compass_Backend *AG_Compass_MMC5XX3::probe(AG_HAL::OwnPtr<AG_HAL::Device> dev,
                                              bool force_external,
                                              enum Rotation rotation)
{
    ...
    AG_Compass_MMC5XX3 *sensor = new AG_Compass_MMC5XX3(std::move(dev), force_external, rotation);
...
AG_Compass_MMC5XX3::AG_Compass_MMC5XX3(AG_HAL::OwnPtr<AG_HAL::Device> _dev,
...
bool AG_Compass_MMC5XX3::init()
{
    ...
    dev->register_periodic_callback(10000U,
                                    FUNCTOR_BIND_MEMBER(&AG_Compass_MMC5XX3::timer, void));

    return true;
}

void AG_Compass_MMC5XX3::timer()
{
