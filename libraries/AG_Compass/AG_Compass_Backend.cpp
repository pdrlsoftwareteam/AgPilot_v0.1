...
AG_Compass_Backend::AG_Compass_Backend()
    : _compass(AP::compass())
{
}

void AG_Compass_Backend::rotate_field(Vector3f &mag, uint8_t instance)
{
...
void AG_Compass_Backend::publish_raw_field(const Vector3f &mag, uint8_t instance)
{
    ...
    if (cal != nullptr) {
        Compass::mag_state &state = _compass._state[Compass::StateIndex(instance)];
        state.last_update_ms = AG_HAL::millis();
        cal->new_sample(mag);
    }
#endif
}

void AG_Compass_Backend::correct_field(Vector3f &mag, uint8_t i)
{
...
void AG_Compass_Backend::accumulate_sample(Vector3f &field, uint8_t instance,
...
void AG_Compass_Backend::drain_accumulated_samples(uint8_t instance,
 ...
 */
void AG_Compass_Backend::publish_filtered_field(const Vector3f &mag, uint8_t instance)
{
    Compass::mag_state &state = _compass._state[Compass::StateIndex(instance)];
    ...
    state.last_update_ms = AG_HAL::millis();
    state.last_update_usec = AG_HAL::micros();
}

void AG_Compass_Backend::set_last_update_usec(uint32_t last_update, uint8_t instance)
{
    Compass::mag_state &state = _compass._state[Compass::StateIndex(instance)];
 ...
 */
bool AG_Compass_Backend::register_compass(int32_t dev_id, uint8_t& instance) const
{ 
...
*/
void AG_Compass_Backend::set_dev_id(uint8_t instance, uint32_t dev_id)
{
...
*/
void AG_Compass_Backend::save_dev_id(uint8_t instance)
{
...
*/
void AG_Compass_Backend::set_external(uint8_t instance, bool external)
{
...
bool AG_Compass_Backend::is_external(uint8_t instance)
{
    return _compass._state[Compass::StateIndex(instance)].external;
}

// set rotation of an instance
void AG_Compass_Backend::set_rotation(uint8_t instance, enum Rotation rotation)
{
 ...
 * rejected. 
*/
bool AG_Compass_Backend::field_ok(const Vector3f &field)
{
...
enum Rotation AG_Compass_Backend::get_board_orientation(void) const
{
