...
AG_Compass_Backend *AG_Compass_QMC5883L::probe(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev,
                                               bool force_external,
                                               enum Rotation rotation)
{
    ...
    AG_Compass_QMC5883L *sensor = new AG_Compass_QMC5883L(std::move(dev),force_external,rotation);
...
AG_Compass_QMC5883L::AG_Compass_QMC5883L(AG_HAL::OwnPtr<AG_HAL::Device> dev,
                                         bool force_external,
                                         enum Rotation rotation)
    : _dev(std::move(dev))
    , _rotation(rotation)
...
bool AG_Compass_QMC5883L::init()
{
    ...
    _dev->register_periodic_callback(10000,
        FUNCTOR_BIND_MEMBER(&AG_Compass_QMC5883L::timer, void));
...
bool AG_Compass_QMC5883L::_check_whoami()
{
    uint8_t whoami;
...
void AG_Compass_QMC5883L::timer()
{
    struct PACKED {
    	le16_t rx;
    	le16_t ry;
...
void AG_Compass_QMC5883L::read()
{
    drain_accumulated_samples(_instance);
}

void AG_Compass_QMC5883L::_dump_registers()
{
