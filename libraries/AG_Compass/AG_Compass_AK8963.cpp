...
#include <AG_InertialSensor/AG_InertialSensor_Invensense.h>
...
AG_Compass_AK8963::AG_Compass_AK8963(AP_AK8963_BusDriver *bus,
...
AG_Compass_AK8963::~AG_Compass_AK8963()
{
    delete _bus;
}

AG_Compass_Backend *AG_Compass_AK8963::probe(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev,
                                             enum Rotation rotation)
{
    if (!dev) {
        return nullptr;
    ...
    AG_Compass_AK8963 *sensor = new AG_Compass_AK8963(bus, rotation);
...
AG_Compass_Backend *AG_Compass_AK8963::probe_mpu9250(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev,
                                                     enum Rotation rotation)
{
    if (!dev) {
        return nullptr;
    ...
    AG_InertialSensor &ins = *AG_InertialSensor::get_singleton();
...
AG_Compass_Backend *AG_Compass_AK8963::probe_mpu9250(uint8_t mpu9250_instance,
                                                     enum Rotation rotation)
{
#if AP_INERTIALSENSOR_ENABLED
    AG_InertialSensor &ins = *AG_InertialSensor::get_singleton();
...
bool AG_Compass_AK8963::init()
{
    ...
    _bus->register_periodic_callback(10000, FUNCTOR_BIND_MEMBER(&AG_Compass_AK8963::_update, void));
...
void AG_Compass_AK8963::_make_adc_sensitivity_adjustment(Vector3f& field) const
{
...
void AG_Compass_AK8963::_make_factory_sensitivity_adjustment(Vector3f& field) const
{
...
void AG_Compass_AK8963::_update()
{
...
bool AG_Compass_AK8963::_check_id()
{
    for (int i = 0; i < 5; i++) {
        uint8_t deviceid = 0;
...
/* AG_HAL::I2CDevice implementation of the AK8963 */
AP_AK8963_BusDriver_HALDevice::AP_AK8963_BusDriver_HALDevice(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev)
    : _dev(std::move(dev))
{
}
...
AG_HAL::Semaphore *AP_AK8963_BusDriver_HALDevice::get_semaphore()
{
    return _dev->get_semaphore();
}

AG_HAL::Device::PeriodicHandle AP_AK8963_BusDriver_HALDevice::register_periodic_callback(uint32_t period_usec, AG_HAL::Device::PeriodicCb cb)
{
    return _dev->register_periodic_callback(period_usec, cb);
}

/* AK8963 on an auxiliary bus of IMU driver */
AP_AK8963_BusDriver_Auxiliary::AP_AK8963_BusDriver_Auxiliary(AG_InertialSensor &ins, uint8_t backend_id,
...
AG_HAL::Semaphore *AP_AK8963_BusDriver_Auxiliary::get_semaphore()
{
...
AG_HAL::Device::PeriodicHandle AP_AK8963_BusDriver_Auxiliary::register_periodic_callback(uint32_t period_usec, AG_HAL::Device::PeriodicCb cb)
{
