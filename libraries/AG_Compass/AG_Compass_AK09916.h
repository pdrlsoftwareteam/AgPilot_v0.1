...
class AG_Compass_AK09916 : public AG_Compass_Backend
{
public:
    ...
    static AG_Compass_Backend *probe_ICM20948(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev,
                                             AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev_icm,
                                             bool force_external,
                                             enum Rotation rotation);

    /* Probe for AK09916 on auxiliary bus of ICM20948, connected through SPI by default */
    static AG_Compass_Backend *probe_ICM20948(uint8_t mpu9250_instance, enum Rotation rotation);
    static AG_Compass_Backend *probe_ICM20948_SPI(uint8_t mpu9250_instance,
                                             enum Rotation rotation);

	/* Probe for AK09916 on auxiliary bus of ICM20948, connected through I2C */
    static AG_Compass_Backend *probe_ICM20948_I2C(uint8_t mpu9250_instance,
                                             enum Rotation rotation);
#endif

    static constexpr const char *name = "AK09916";

    virtual ~AG_Compass_AK09916();

    void read() override;

private:
    AG_Compass_AK09916(AP_AK09916_BusDriver *bus, bool force_external,
                       enum Rotation rotation);
    ...
    enum AG_Compass_Backend::DevTypes _devtype;
    uint8_t no_data;
};
...
{
public:
    AP_AK09916_BusDriver_HALDevice(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev);
    ...
    virtual AG_HAL::Semaphore  *get_semaphore() override;
...
{
public:
    AP_AK09916_BusDriver_Auxiliary(AG_InertialSensor &ins, uint8_t backend_id,
