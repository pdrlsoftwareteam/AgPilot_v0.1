...
AG_Compass_MSP::AG_Compass_MSP(uint8_t _msp_instance)
{
    msp_instance = _msp_instance;

    auto devid = AG_HAL::Device::make_bus_id(AG_HAL::Device::BUS_TYPE_MSP, 0, _msp_instance, 0);
...
void AG_Compass_MSP::handle_msp(const MSP::msp_compass_data_message_t &pkt)
{
