...
AG_Compass_Backend *AG_Compass_LIS3MDL::probe(AG_HAL::OwnPtr<AG_HAL::Device> dev,
                                              bool force_external,
                                              enum Rotation rotation)
{
    ...
    AG_Compass_LIS3MDL *sensor = new AG_Compass_LIS3MDL(std::move(dev), force_external, rotation);
...
AG_Compass_LIS3MDL::AG_Compass_LIS3MDL(AG_HAL::OwnPtr<AG_HAL::Device> _dev,
...
bool AG_Compass_LIS3MDL::init()
{
    ...
    dev->register_periodic_callback(1000000U/80U,
                                    FUNCTOR_BIND_MEMBER(&AG_Compass_LIS3MDL::timer, void));
