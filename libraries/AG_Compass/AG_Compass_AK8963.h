...
class AG_Compass_AK8963 : public AG_Compass_Backend
{
public:
    ...
    static AG_Compass_Backend *probe_mpu9250(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev,
                                             enum Rotation rotation);

    /* Probe for AK8963 on auxiliary bus of MPU9250, connected through SPI */
    static AG_Compass_Backend *probe_mpu9250(uint8_t mpu9250_instance,
                                             enum Rotation rotation);

    static constexpr const char *name = "AK8963";

    virtual ~AG_Compass_AK8963();

    void read() override;

private:
    AG_Compass_AK8963(AP_AK8963_BusDriver *bus,
                      enum Rotation rotation);
...
{
public:
    AP_AK8963_BusDriver_HALDevice(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev);
...
{
public:
    AP_AK8963_BusDriver_Auxiliary(AG_InertialSensor &ins, uint8_t backend_id,
