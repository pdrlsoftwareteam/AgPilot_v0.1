...
class Compass
{
friend class AG_Compass_Backend;
public:
    Compass();
    ...
    */
    ...
    void handle_external(const AG_ExternalAHRS::mag_data_message_t &pkt);
#endif
...
private:
    ...
    bool _add_backend(AG_Compass_Backend *backend);
    ...
    */
    ...
    // backend objects
    AG_Compass_Backend *_backends[COMPASS_MAX_BACKEND];
    ...
    struct mag_state {
        ...
        // accumulated samples, protected by _sem, used by AG_Compass_Backend
        Vector3f accum;
