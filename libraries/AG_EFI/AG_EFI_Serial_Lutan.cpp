...
AG_EFI_Serial_Lutan::AG_EFI_Serial_Lutan(AG_EFI &_frontend):
...
void AG_EFI_Serial_Lutan::update()
{
    if (port == nullptr) {
        return;
    }
...
void AG_EFI_Serial_Lutan::send_request(void)
{
...
#endif  // AG_EFI_SERIAL_LUTAN_ENABLED
