...
#include <AG_AttitudeControl/AG_AttitudeControl.h> // Attitude controller library for sqrt controller
...
public:
    ...
    /* Do not allow copies */
    CLASS_NO_COPY(AG_Avoid);

    // get singleton instance
    static AG_Avoid *get_singleton() {
        return _singleton;
    }
    ...
    bool limits_active() const {return (AG_HAL::millis() - _last_limit_time) < AC_AVOID_ACTIVE_LIMIT_TIMEOUT_MS;};
