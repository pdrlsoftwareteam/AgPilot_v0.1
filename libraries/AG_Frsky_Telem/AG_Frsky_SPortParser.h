...
class AG_Frsky_SPortParser
{
public:

    // packet parser helpers
    bool process_byte(AG_Frsky_SPort::sport_packet_t &sport_packet, const uint8_t data);
...
private:
    ...
    bool get_packet(AG_Frsky_SPort::sport_packet_t &sport_packet, bool discard_duplicates);
};
