...
AG_Frsky_SPort *AG_Frsky_SPort::singleton;

/*
 * send telemetry data
 * for FrSky SPort protocol (X-receivers)
 */
void AG_Frsky_SPort::send(void)
{
 ...
 */
uint32_t AG_Frsky_SPort::calc_gps_latlng(bool &send_latitude)
{
 ...
 */
void  AG_Frsky_SPort::send_sport_frame(uint8_t frame, uint16_t appid, uint32_t data)
{
    uint8_t buf[8];
...
bool AG_Frsky_SPortParser::should_process_packet(const uint8_t *packet, bool discard_duplicates)
{
...
bool AG_Frsky_SPortParser::process_byte(AG_Frsky_SPort::sport_packet_t &sport_packet, const uint8_t data)
{
...
bool AG_Frsky_SPortParser::get_packet(AG_Frsky_SPort::sport_packet_t &sport_packet, bool discard_duplicates)
{
...
uint8_t AG_Frsky_SPort::calc_sensor_id(const uint8_t physical_id)
{
 ...
 * for FrSky SPort Passthrough (OpenTX) protocol (X-receivers)
 */
uint16_t AG_Frsky_SPort::prep_number(int32_t number, uint8_t digits, uint8_t power)
{
    uint16_t res = 0;
 ...
 */
bool AG_Frsky_SPort::sport_telemetry_push(uint8_t sensor, uint8_t frame, uint16_t appid, int32_t data)
{
    WITH_SEMAPHORE(_sport_push_buffer.sem);
...
namespace AP {
    AG_Frsky_SPort *frsky_sport() {
        return AG_Frsky_SPort::get_singleton();
    }
};
