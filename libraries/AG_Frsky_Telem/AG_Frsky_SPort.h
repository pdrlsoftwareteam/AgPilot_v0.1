...
class AG_Frsky_SPort : public AG_Frsky_Backend
{

public:

    AG_Frsky_SPort(AG_HAL::UARTDriver *port) : AG_Frsky_Backend(port) {
        singleton = this;
    }

    /* Do not allow copies */
    CLASS_NO_COPY(AG_Frsky_SPort);
    ...
    static AG_Frsky_SPort *get_singleton(void) {
        return singleton;
    }
...
private:
    ...
    static AG_Frsky_SPort *singleton;
