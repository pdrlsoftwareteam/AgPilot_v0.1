/*
 * AGDirectFlashAccess.cpp
 *
 *  Created on: 02-Nov-2019
 *      Author: owner
 */

#include "AGDirectFlashAccess.h"
#include "stm32_util.h"
#include "flash.h"

AG_Direct_Flash_Access *AG_Direct_Flash_Access::m_AG_Direct_Flash_Access = 0;

AG_Direct_Flash_Access::AG_Direct_Flash_Access() {
	// TODO Auto-generated constructor stub

}

AG_Direct_Flash_Access* AG_Direct_Flash_Access::getInstance()
{
	if(m_AG_Direct_Flash_Access == 0)
		m_AG_Direct_Flash_Access = new AG_Direct_Flash_Access();
	return m_AG_Direct_Flash_Access;
}

void AG_Direct_Flash_Access::storeInflash(uint8_t* dataBuf, uint16_t dataSize, uint32_t add, bool continueWr)
{
...
void AG_Direct_Flash_Access::readFromInflash(uint8_t* dataBuf, uint16_t dataSize, uint32_t add)
{
	access_semaphore.take(1);
#if 1
