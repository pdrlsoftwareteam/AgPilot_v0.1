...
*/
bool AG_Declination::get_mag_field_ef(float latitude_deg, float longitude_deg, float &intensity_gauss, float &declination_deg, float &inclination_deg)
{
...
/*
 calculate magnetic field intensity and orientation
*/
float AG_Declination::get_declination(float latitude_deg, float longitude_deg)
{
...
*/
Vector3f AG_Declination::get_earth_field_ga(const Location &loc)
{
    float declination_deg=0, inclination_deg=0, intensity_gauss=0;
