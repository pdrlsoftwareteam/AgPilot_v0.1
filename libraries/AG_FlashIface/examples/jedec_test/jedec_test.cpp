...
#include <AG_FlashIface/AG_FlashIface.h>
#include <stdio.h>

AG_FlashIface_JEDEC jedec_dev;
const AG_HAL::HAL& hal = AG_HAL::get_HAL();
...
static UNUSED_FUNCTION void test_sector_erase()
{
    ...
    uint32_t erase_start = AG_HAL::millis();
