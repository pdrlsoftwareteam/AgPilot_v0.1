...
#include <AG_InertialNav/AG_InertialNav.h>
...
public:
    ...
    /// Constructor
    AG_Loiter(const AG_InertialNav& inav, const AG_AHRS_View& ahrs, AG_PosControl& pos_control, const AG_AttitudeControl& attitude_control);
