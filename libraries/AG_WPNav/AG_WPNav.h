...
#include <AG_Math/SCurve.h>
#include <AG_Math/SplineCurve.h>
...
#include <AG_AttitudeControl/AG_AttitudeControl.h> // Attitude control library
#include <AG_Terrain/AG_Terrain.h>
#include <AG_Avoidance/AG_Avoid.h>                 // Stop at fence library
...
public:
    ...
    /// Constructor
    AG_WPNav(const AG_InertialNav& inav, const AG_AHRS_View& ahrs, AG_PosControl& pos_control, const AG_AttitudeControl& attitude_control);
    ...
    AG_WPNav::TerrainSource get_terrain_source() const;
    ...
    // having this function unifies the AG_WPNav_OA and AG_WPNav interfaces making vehicle code simpler
...
protected:
    ...
    const AG_AttitudeControl& _attitude_control;
