...
public:
    ...
    virtual AG_Filesystem_Backend::FormatStatus get_format_status() const { return FormatStatus::NOT_STARTED; }
...
#define FS_CHECK_ALLOWED(retfail) do { if (!file_op_allowed()) { INTERNAL_ERROR(AG_InternalError::error_t::flow_of_control); return retfail; } } while(0)
#else
