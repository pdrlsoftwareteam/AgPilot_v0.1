/*
  FATFS backend for AG_Filesystem
 */
...
#include <errno.h>
#include <stddef.h>
#include "AG_Filesystem_backend.h"
...
class AG_Filesystem_FATFS : public AG_Filesystem_Backend
{
public:
    ...
    AG_Filesystem_Backend::FormatStatus get_format_status() const override;
