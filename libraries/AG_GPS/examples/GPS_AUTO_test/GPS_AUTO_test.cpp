 ...
 */
/*
     Test for AG_GPS_AUTO
*/

#include <AG_HAL/AG_HAL.h>                                      //This is a common Hardware Abstraction Layer.
#include <AG_GPS/AG_GPS.h>
#include <GCS_MAVLink/GCS_Dummy.h>
#include <AG_Notify/AG_Notify.h>
#include <AG_Notify/AG_BoardLED.h>
...
const AG_HAL::HAL& hal = AG_HAL::get_HAL();                     //Declare "hal" reference variable. This variable is pointing to Ap_HAL::HAL class's object. Here, AG_HAL is library and HAL is a class in that library. This reference variable can be used to get access to hardware specific functions.                     
 ...
 */
void print_latlon(AG_HAL::BetterStream *s, int32_t lat_or_lon);
void print_latlon(AG_HAL::BetterStream *s, int32_t lat_or_lon)
{
