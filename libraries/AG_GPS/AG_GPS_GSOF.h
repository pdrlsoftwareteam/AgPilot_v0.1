...
class AG_GPS_GSOF : public AG_GPS_Backend
{
public:
    AG_GPS_GSOF(AG_GPS &_gps, AG_GPS::GPS_State &_state, AG_HAL::UARTDriver *_port);

    AG_GPS::GPS_Status highest_supported_status(void) override {
        return AG_GPS::GPS_OK_FIX_3D_RTK_FIXED;
    }
