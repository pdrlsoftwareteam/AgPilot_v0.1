...
void AP_Frsky_AGPILOTlite_SPortToAGPILOTlite::reset(void)
{
    checksum = 0;
...
void AP_Frsky_AGPILOTlite_SPortToAGPILOTlite::update_checksum(const uint8_t c)
{
    checksum += c; //0-1FF
    checksum += checksum >> 8;
    checksum &= 0xFF;
 ...
 */
bool AP_Frsky_AGPILOTlite_SPortToAGPILOTlite::process(AP_Frsky_AGPILOTlite_Message &rxmsg, const AP_Frsky_SPort::sport_packet_t &packet)
{
...
void AP_Frsky_AGPILOTlite_SPortToAGPILOTlite::parse(uint8_t byte)
{
    switch (parse_state) {
