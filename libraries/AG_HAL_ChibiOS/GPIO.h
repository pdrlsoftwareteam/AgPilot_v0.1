...
class ChibiOS::GPIO : public AG_HAL::GPIO {
public:
    GPIO();
    void    init() override;
    ...
    /* Interrupt interface - for AG_HAL::GPIO */
    ...
    bool _attach_interrupt(ioline_t line, AG_HAL::Proc p, uint8_t mode);
...
class ChibiOS::DigitalSource : public AG_HAL::DigitalSource {
public:
...
#if HAL_WITH_IO_MCU
class ChibiOS::IOMCU_DigitalSource : public AG_HAL::DigitalSource {
public:
