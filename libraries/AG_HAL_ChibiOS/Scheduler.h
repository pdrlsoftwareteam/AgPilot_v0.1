...
class ChibiOS::Scheduler : public AG_HAL::Scheduler {
public:
    Scheduler();
...
private:
    ...
    AG_HAL::MemberProc _timer_proc[CHIBIOS_SCHEDULER_MAX_TIMER_PROCS];
    uint8_t _num_timer_procs;
    volatile bool _in_timer_proc;

    AG_HAL::MemberProc _io_proc[CHIBIOS_SCHEDULER_MAX_TIMER_PROCS];
