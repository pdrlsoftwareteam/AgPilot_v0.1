...
struct SPIDesc {
    ...
    uint32_t lowspeed;
    uint32_t highspeed;
    AG_HAL::Device::BankSelectCb bank_select_cb;
    AG_HAL::Device::RegisterRWCb register_rw_cb;
};
...
public:
    ...
    */
    void setup_bankselect_callback(BankSelectCb bank_select) override {
        ...
        AG_HAL::SPIDevice::setup_bankselect_callback(bank_select);
    }
    ...
    */
    void deregister_bankselect_callback() override {
        ...
        AG_HAL::SPIDevice::deregister_bankselect_callback();
    }
    ...
    */
    ...
    bool adjust_periodic_callback(AG_HAL::Device::PeriodicHandle h, uint32_t period_usec) override;
...
public:
    ...
    void set_register_rw_callback(const char* name, AG_HAL::Device::RegisterRWCb cb) override;
