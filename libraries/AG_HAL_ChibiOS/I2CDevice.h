 ...
 *
 * Modified for use in AG_HAL_ChibiOS by Andrew Tridgell and Siddharth Bharat Purohit
 */
...
class I2CDevice : public AG_HAL::I2CDevice {
public:
...
class I2CDeviceManager : public AG_HAL::I2CDeviceManager {
public:
