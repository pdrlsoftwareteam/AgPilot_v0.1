...
class ChibiOS::RCOutput : public AG_HAL::RCOutput
#ifdef HAL_WITH_BIDIR_DSHOT
  , AG_ESC_Telem_Backend
#endif
{
public:
    ...
    */
    AG_HAL::Util::safety_state _safety_switch_state(void);
...
private:
    ...
    struct pwm_group {
        ...
        bool can_send_dshot_pulse() const {
          return is_dshot_protocol(current_mode) && AG_HAL::micros64() - last_dmar_send_us > (dshot_pulse_time_us + 50);
        }
    ...
    // safety switch state
    AG_HAL::Util::safety_state safety_state;
