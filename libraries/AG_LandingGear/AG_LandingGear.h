/// @file   AG_LandingGear.h
/// @brief  Landing gear control library
#pragma once

#include "AG_LandingGear_config.h"
...
public:
    AG_LandingGear() {
        ...
        if (_singleton != nullptr) {
            AG_HAL::panic("AG_LandingGear must be singleton");
        }
        _singleton = this;
    }

    /* Do not allow copies */
    CLASS_NO_COPY(AG_LandingGear);
    
    // get singleton instance
    static AG_LandingGear *get_singleton(void) {
        return _singleton;
    }
...
private:
    ...
    static AG_LandingGear *_singleton;
};
