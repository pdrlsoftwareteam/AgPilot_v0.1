...
exclude_files = {"Tools/CHDK-Scripts/*", "modules/*", "libraries/AG_Scripting/tests/luacheck.lua"}
...
assert(pcall(setfenv(assert(loadfile("libraries/AG_Scripting/docs/docs.lua")), env)))
