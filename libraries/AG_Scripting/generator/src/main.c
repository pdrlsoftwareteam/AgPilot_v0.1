...
int main(int argc, char **argv) {
  ...
  fprintf(source, "#include <AG_Scripting/lua_boxed_numerics.h>\n");
  fprintf(source, "#include <AG_Scripting/lua_bindings.h>\n");

  // for set_and_print_new_error_message deprecate warning
  fprintf(source, "#include <AG_Scripting/lua_scripts.h>\n");
  ...
  fprintf(header, "#include <AG_Vehicle/AG_Vehicle_Type.h> // needed for APM_BUILD_TYPE #if\n");
  emit_headers(header);
  fprintf(header, "#include <AG_Scripting/lua/src/lua.hpp>\n");
