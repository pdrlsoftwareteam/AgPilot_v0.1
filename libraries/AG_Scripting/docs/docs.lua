...
---@param format string -- type format string, see https://github.com/ArduPilot/ardupilot/blob/master/libraries/AG_Logger/README.md
...
-- desc
---@class AG_HAL__PWMSource_ud
local AG_HAL__PWMSource_ud = {}

---@return AG_HAL__PWMSource_ud
function PWMSource() end

-- desc
---@return integer
function AG_HAL__PWMSource_ud:get_pwm_avg_us() end

-- desc
---@return integer
function AG_HAL__PWMSource_ud:get_pwm_us() end

-- desc
---@param pin_number integer
---@return boolean
function AG_HAL__PWMSource_ud:set_pin(pin_number) end
...
-- desc
---@class AG_EFI_Backend_ud
local AG_EFI_Backend_ud = {}

-- desc
---@param state EFI_State_ud
---@return boolean
function AG_EFI_Backend_ud:handle_scripting(state) end
...
-- desc
---@class AG_HAL__AnalogSource_ud
local AG_HAL__AnalogSource_ud = {}

-- desc
---@return number
function AG_HAL__AnalogSource_ud:voltage_average_ratiometric() end

-- desc
---@return number
function AG_HAL__AnalogSource_ud:voltage_latest() end

-- desc
---@return number
function AG_HAL__AnalogSource_ud:voltage_average() end

-- desc
---@param pin_number integer
---@return boolean
function AG_HAL__AnalogSource_ud:set_pin(pin_number) end


-- desc
---@class AG_HAL__I2CDevice_ud
local AG_HAL__I2CDevice_ud = {}

-- desc
---@param address integer
function AG_HAL__I2CDevice_ud:set_address(address) end
...
function AG_HAL__I2CDevice_ud:read_registers(register_num, read_length) end

-- desc
---@param register_num integer
---@param value integer
---@return boolean
function AG_HAL__I2CDevice_ud:write_register(register_num, value) end

-- desc
---@param retries integer
function AG_HAL__I2CDevice_ud:set_retries(retries) end


-- desc
---@class AG_HAL__UARTDriver_ud
local AG_HAL__UARTDriver_ud = {}
...
---| '1' # enabled
---| '2' # auto
function AG_HAL__UARTDriver_ud:set_flow_control(flow_control_setting) end

-- desc
---@return uint32_t_ud
function AG_HAL__UARTDriver_ud:available() end

-- desc
---@param value integer
---@return uint32_t_ud
function AG_HAL__UARTDriver_ud:write(value) end

-- desc
---@return integer
function AG_HAL__UARTDriver_ud:read() end

-- desc
---@param baud_rate uint32_t_ud
function AG_HAL__UARTDriver_ud:begin(baud_rate) end
...
-- Get motors interlock state, the state of motors controlled by AG_Motors, Copter and Quadplane VTOL motors. Not plane forward flight motors.
---@return boolean
---| true  # motors active
...
--get APM_BUILD_? value from AG_Vehicle/AG_Vehicle_Type.h that is checked against APM_BUILD_TYPE()
---@return integer
---| '1' # Rover
---| '2' # ArduCopter
---| '3' # ArduPlane
...
-- desc
---@return AG_HAL__AnalogSource_ud
...
---@return AG_HAL__UARTDriver_ud -- the requested UART instance available for scripting, or nil if none.
...
-- RangeFinder backend
---@class AG_RangeFinder_Backend_ud
local AG_RangeFinder_Backend_ud = {}

-- Send distance to lua rangefinder backend. Returns false if failed
---@param distance number
---@return boolean
function AG_RangeFinder_Backend_ud:handle_script_msg(distance) end

-- Status of this rangefinder instance
---@return integer
function AG_RangeFinder_Backend_ud:status() end

-- Type of rangefinder of this instance
---@return integer
function AG_RangeFinder_Backend_ud:type() end

-- Orintation of the rangefinder of this instance
---@return integer
function AG_RangeFinder_Backend_ud:orientation() end

-- Current distance of the sensor instance
---@return number
function AG_RangeFinder_Backend_ud:distance() end
...
---@return AG_RangeFinder_Backend_ud
...
function AG_AttitudeControl:get_rpy_srate() end
