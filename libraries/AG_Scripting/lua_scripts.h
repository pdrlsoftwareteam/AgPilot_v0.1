...
{
public:
    lua_scripts(const AP_Int32 &vm_steps, const AP_Int32 &heap_size, const AP_Int8 &debug_options, struct AG_Scripting::terminal_s &_terminal);
...
private:
    ...
    // REPL stuff
    struct AG_Scripting::terminal_s &terminal;
...
public:
    ...
    static AG_HAL::Semaphore* get_last_error_semaphore() { return &error_msg_buf_sem; }
