...
public:
    ...
    static AG_Scripting * get_singleton(void) { return _singleton; }

    static const struct AG_Param::GroupInfo var_info[];

    MAV_RESULT handle_command_int_packet(const mavlink_command_int_t &packet);

    void handle_mission_command(const class AG_Mission::Mission_Command& cmd);
   ...
   AP_Float _user[6];
    ...
    AG_HAL::OwnPtr<AG_HAL::I2CDevice> *_i2c_dev[SCRIPTING_MAX_NUM_I2C_DEVICE];
    ...
    AG_HAL::PWMSource *_pwm_source[SCRIPTING_MAX_NUM_PWM_SOURCE];
...
private:
    ...
    static AG_Scripting *_singleton;

};

namespace AP {
    AG_Scripting * scripting(void);
};
