...
local function write_to_dataflash()
  ...
  -- format characters specify the type of variable to be logged, see AG_Logger/README.md
  -- https://github.com/ArduPilot/ardupilot/tree/master/libraries/AG_Logger
