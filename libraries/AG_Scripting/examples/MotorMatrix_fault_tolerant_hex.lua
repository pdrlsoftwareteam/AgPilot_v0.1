...
-- duplicate the #defines from AG_Motors
...
-- helper function duplication of the one found in AG_MotorsMatrix
...
-- this duplicates the add motor format used in AG_Motors for ease of modification of existing mixes
