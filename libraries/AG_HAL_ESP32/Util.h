...
class ESP32::Util : public AG_HAL::Util
{
public:
    static Util *from(AG_HAL::Util *util)
    {
        return static_cast<Util*>(util);
    }

    bool run_debug_shell(AG_HAL::BetterStream *stream) override
    {
        return false;
    }
    ...
    void *malloc_type(size_t size, AG_HAL::Util::Memory_Type mem_type) override;
    void free_type(void *ptr, size_t size, AG_HAL::Util::Memory_Type mem_type) override;
