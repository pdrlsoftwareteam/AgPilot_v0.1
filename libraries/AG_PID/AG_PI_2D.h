...
#define AG_PI_2D_FILT_HZ_MIN      0.01f   // minimum input filter frequency
...
public:
    ...
    // constructor
    AG_PI_2D(float initial_p, float initial_i, float initial_imax, float initial_filt_hz, float dt);

    CLASS_NO_COPY(AG_PI_2D);
