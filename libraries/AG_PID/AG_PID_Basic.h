...
public:
    ...
    // Constructor for PID
    AG_PID_Basic(float initial_p, float initial_i, float initial_d, float initial_ff, float initial_imax, float initial_filt_E_hz, float initial_filt_D_hz);
    ...
    const AG_PIDInfo& get_pid_info(void) const WARN_IF_UNUSED { return _pid_info; }
