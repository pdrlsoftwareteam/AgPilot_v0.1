...
/*
 * The AG_Rally library:
 * 
 * Initial implementation: Michael Day, September 2013
 * Moved to AG_Rally lib:  Andrew Chapman April 2014
 * 
...
public:
    ...
    static AG_Rally *get_singleton() { return _singleton; }


private:
    static AG_Rally *_singleton;
