...
class AG_Radio_backend
{
public:
    AG_Radio_backend(AG_Radio &radio);
    virtual ~AG_Radio_backend();
    ...
    virtual const AG_Radio::stats &get_stats(void) = 0;
...
protected:
    ...
    AG_Radio::ap_radio_protocol get_protocol(void) const
    {
        return (AG_Radio::ap_radio_protocol)radio.protocol.get();
    }
