...
/*
  AG_Radio implementation for Cypress 2.4GHz radio.
...
class AG_Radio_cypress : public AG_Radio_backend
{
public:
    AG_Radio_cypress(AG_Radio &radio);
    ...
    const AG_Radio::stats &get_stats(void) override;
...
private:
    ...
    static AG_Radio_cypress *radio_singleton;
    ...
    AG_Radio::stats stats;
    AG_Radio::stats last_stats;
