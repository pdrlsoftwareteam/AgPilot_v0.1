...
#include "AG_Radio_cypress.h"
#include <utility>
#include <stdio.h>
#include <StorageManager/StorageManager.h>
#include <AG_HAL/utility/dsm.h>
...
AG_Radio_cypress *AG_Radio_cypress::radio_singleton;
#if CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS
thread_t *AG_Radio_cypress::_irq_handler_ctx;
#endif
/*
  constructor
 */
AG_Radio_cypress::AG_Radio_cypress(AG_Radio &_radio) :
    AG_Radio_backend(_radio)
{
...
/*
  initialise radio
 */
bool AG_Radio_cypress::init(void)
{
    dev = hal.spi->get_device(CYRF_SPI_DEVICE);
#if CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS
    if (_irq_handler_ctx != nullptr) {
        AG_HAL::panic("AG_Radio_cypress: double instantiation of irq_handler\n");
    }
...
/*
  reset radio
 */
bool AG_Radio_cypress::reset(void)
{
 ...
 */
const AG_Radio::stats &AG_Radio_cypress::get_stats(void)
{
    return stats;
}
 ...
 */
uint16_t AG_Radio_cypress::read(uint8_t chan)
{
 ...
 */
void AG_Radio_cypress::update(void)
{
    check_fw_ack();
}
 ...
 */
void AG_Radio_cypress::print_debug_info(void)
{
 ...
 */
uint8_t AG_Radio_cypress::num_channels(void)
{
 ...
 */
void AG_Radio_cypress::check_fw_ack(void)
{
 ...
 */
uint32_t AG_Radio_cypress::last_recv_us(void)
{
 ...
 */
bool AG_Radio_cypress::send(const uint8_t *pkt, uint16_t len)
{
    // disabled for now
    return false;
}
...
/* The PN codes */
const uint8_t AG_Radio_cypress::pn_codes[5][9][8] = {
    { /* Row 0 */
...
const uint8_t AG_Radio_cypress::pn_bind[] = { 0x98, 0x88, 0x1B, 0xE4, 0x30, 0x79, 0x03, 0x84 };

/*The CYRF initial config, binding config and transfer config */
const AG_Radio_cypress::config AG_Radio_cypress::cyrf_config[] = {
...
const AG_Radio_cypress::config AG_Radio_cypress::cyrf_bind_config[] = {
    {CYRF_TX_CFG, CYRF_DATA_CODE_LENGTH | CYRF_DATA_MODE_SDR | CYRF_PA_4},   // Enable 64 chip codes, SDR mode and amplifier +4dBm
...
const AG_Radio_cypress::config AG_Radio_cypress::cyrf_transfer_config[] = {
 ...
 */
uint8_t AG_Radio_cypress::read_status_debounced(uint8_t adr)
{
    uint8_t ret;
 ...
 */
void AG_Radio_cypress::force_initial_state(void)
{
    while (true) {
        ...
        } while (AG_HAL::millis() - start_ms < 5);
...
/*
  set desired channel
 */
void AG_Radio_cypress::set_channel(uint8_t channel)
{
...
void AG_Radio_cypress::radio_set_config(const struct config *conf, uint8_t size)
{
 ...
 */
void AG_Radio_cypress::radio_init(void)
{
    ...
    hal.gpio->attach_interrupt(HAL_GPIO_RADIO_IRQ, trigger_irq_radio_event, AG_HAL::GPIO::INTERRUPT_RISING);
}

void AG_Radio_cypress::dump_registers(uint8_t n)
{
 ...
 */
uint8_t AG_Radio_cypress::read_register(uint8_t reg)
{
    uint8_t v = 0;
 ...
 */
void AG_Radio_cypress::write_multiple(uint8_t reg, uint8_t n, const uint8_t *data)
{
    uint8_t pkt[n+1];
 ...
 */
void AG_Radio_cypress::write_register(uint8_t reg, uint8_t value)
{
 ...
 */
void AG_Radio_cypress::map_stick_mode(uint16_t *channels)
{
 ...
 */
void AG_Radio_cypress::check_double_bind(void)
{
 ...
 */
bool AG_Radio_cypress::parse_dsm_channels(const uint8_t *data)
{
    ...
    dsm.last_parse_us = AG_HAL::micros();
 ...
 */
void AG_Radio_cypress::process_bind(const uint8_t *pkt, uint8_t len)
{
    if (len != 16) {
        return;
    }
    ...
    if (ok) {
        ...
        dsm.last_recv_us = AG_HAL::micros();
...
/*
  start DSM2 sync
 */
void AG_Radio_cypress::dsm2_start_sync(void)
{
 ...
 */
void AG_Radio_cypress::setup_timeout(uint32_t timeout_ms)
{
 ...
 */
void AG_Radio_cypress::process_packet(const uint8_t *pkt, uint8_t len)
{
    if (len == 16) {
        bool ok;
 ...
 */
void AG_Radio_cypress::start_receive(void)
{
    dsm_choose_channel();
    ...
    dsm.receive_start_us = AG_HAL::micros();
    if (state == STATE_AUTOBIND) {
 ...
 */
void AG_Radio_cypress::irq_handler_recv(uint8_t rx_status)
{
...
/*
  handle a send IRQ
 */
void AG_Radio_cypress::irq_handler_send(uint8_t tx_status)
{
...
/*
  IRQ handler
 */
void AG_Radio_cypress::irq_handler(void)
{
 ...
 */
void AG_Radio_cypress::irq_timeout(void)
{
    stats.timeouts++;
    if (!dev->get_semaphore()->take_nonblocking()) {
 ...
 */
void AG_Radio_cypress::irq_handler_thd(void *arg)
{
...
void AG_Radio_cypress::trigger_timeout_event(void *arg)
{
    (void)arg;
...
void AG_Radio_cypress::trigger_irq_radio_event()
{
    //we are called from ISR context
    chSysLockFromISR();
    if (_irq_handler_ctx) {
 ...
 */
void AG_Radio_cypress::dsm_set_channel(uint8_t channel, bool is_dsm2, uint8_t sop_col, uint8_t data_col, uint16_t crc_seed)
{
 ...
 */
void AG_Radio_cypress::dsm_generate_channels_dsmx(uint8_t mfg_id[4], uint8_t channels[23])
{
 ...
 */
void AG_Radio_cypress::dsm_setup_transfer_dsmx(void)
{
 ...
 */
void AG_Radio_cypress::dsm_choose_channel(void)
{
    uint32_t now = AG_HAL::micros();
    ...
    if (is_DSM2() && dsm.sync == DSM2_SYNC_A) {
        ...
        //hal.console->printf("%u chan=%u\n", AG_HAL::micros(), dsm.current_rf_channel);
 ...
 */
void AG_Radio_cypress::start_recv_bind(void)
{
    dev->get_semaphore()->take_blocking();
...
/*
  save bind info
 */
void AG_Radio_cypress::save_bind_info(void)
{
...
/*
  load bind info
 */
void AG_Radio_cypress::load_bind_info(void)
{
    // access to storage for bind information
    StorageAccess bind_storage(StorageManager::StorageBindInfo);
    struct bind_info info;
...
bool AG_Radio_cypress::is_DSM2(void)
{
    if (get_protocol() != AG_Radio::PROTOCOL_AUTO) {
        return get_protocol() == AG_Radio::PROTOCOL_DSM2;
    }
...
*/
void AG_Radio_cypress::transmit16(const uint8_t data[16])
{
 ...
 */
void AG_Radio_cypress::send_telem_packet(void)
{
    struct telem_packet_cypress pkt;

    t_status.flags = 0;
    t_status.flags |= AG_Notify::flags.gps_status >= 3?TELEM_FLAG_GPS_OK:0;
    t_status.flags |= AG_Notify::flags.pre_arm_check?TELEM_FLAG_ARM_OK:0;
    t_status.flags |= AG_Notify::flags.failsafe_battery?0:TELEM_FLAG_BATT_OK;
    t_status.flags |= hal.util->get_soft_armed()?TELEM_FLAG_ARMED:0;
    t_status.flags |= AG_Notify::flags.have_pos_abs?TELEM_FLAG_POS_OK:0;
    t_status.flags |= AG_Notify::flags.video_recording?TELEM_FLAG_VIDEO:0;
    t_status.flight_mode = AG_Notify::flags.flight_mode;
 ...
 */
void AG_Radio_cypress::send_FCC_test_packet(void)
{
...
void AG_Radio_cypress::handle_data_packet(mavlink_channel_t chan, const mavlink_data96_t &m)
{
    uint32_t ofs=0;
