...
public:
    // Generic functions
    Radio_Beken(AG_HAL::OwnPtr<AG_HAL::SPIDevice> _dev);
    bool lock_bus(void)
    {
    ...
    volatile uint8_t bkReady; // initialised in AG_Radio_bk2425.h radio_init() at the very end. Similar to a semaphore.
