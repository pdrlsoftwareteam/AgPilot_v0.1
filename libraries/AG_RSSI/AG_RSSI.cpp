...
const AG_Param::GroupInfo AG_RSSI::var_info[] = {
    ...
    // @User: Standard
    AP_GROUPINFO_FLAGS("TYPE", 0, AG_RSSI, rssi_type,  BOARD_RSSI_DEFAULT, AP_PARAM_FLAG_ENABLE),
    ...
    // @User: Standard
    AP_GROUPINFO("ANA_PIN", 1, AG_RSSI, rssi_analog_pin,  BOARD_RSSI_ANA_PIN),
    ...
    // @Range: 0 5.0
    // @User: Standard
    AP_GROUPINFO("PIN_LOW", 2, AG_RSSI, rssi_analog_pin_range_low, 0.0f),
    ...
    // @Range: 0 5.0
    // @User: Standard
    AP_GROUPINFO("PIN_HIGH", 3, AG_RSSI, rssi_analog_pin_range_high, BOARD_RSSI_ANA_PIN_HIGH),
    ...
    // @Range: 0 16
    // @User: Standard
    AP_GROUPINFO("CHANNEL", 4, AG_RSSI, rssi_channel,  0),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("CHAN_LOW", 5, AG_RSSI, rssi_channel_low_pwm_value,  1000),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("CHAN_HIGH", 6, AG_RSSI, rssi_channel_high_pwm_value,  2000),
...
{       
    ...
    if (_singleton) {
        AG_HAL::panic("Too many RSSI sensors");
    }
    _singleton = this;
}

// destructor
AG_RSSI::~AG_RSSI(void)
{       
}

/*
 * Get the AG_RSSI singleton
 */
AG_RSSI *AG_RSSI::get_singleton()
{
    return _singleton;
}
...
float AG_RSSI::read_receiver_rssi()
{
...
float AG_RSSI::read_receiver_link_quality()
{
...
uint8_t AG_RSSI::read_receiver_rssi_uint8()
{
...
float AG_RSSI::read_channel_rssi()
{
...
float AG_RSSI::read_pwm_pin_rssi()
{
...
float AG_RSSI::read_telemetry_radio_rssi()
{
    return GCS_MAVLINK::telemetry_radio_rssi();
}

// Scale and constrain a float rssi value to 0.0 to 1.0 range 
float AG_RSSI::scale_and_constrain_float_rssi(float current_rssi_value, float low_rssi_range, float high_rssi_range)
{    
...
AG_RSSI *AG_RSSI::_singleton = nullptr;

namespace AP {

AG_RSSI *rssi()
{
    return AG_RSSI::get_singleton();
}
