...
public:
    // Constructor
    AG_AHRS_View(AG_AHRS &ahrs, enum Rotation rotation, float pitch_trim_deg=0);

    // update state
    void update();

    // empty virtual destructor
    virtual ~AG_AHRS_View() {}
    ...
    /*
      ...
      AG_AHRS.h for description of each function
     */
    ...
    void Write_Rate( const AG_Motors &motors, const AG_AttitudeControl &attitude_control,
