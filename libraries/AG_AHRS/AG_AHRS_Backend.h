...
#define AG_AHRS_TRIM_LIMIT 10.0f        // maximum trim angle in degrees
#define AG_AHRS_RP_P_MIN   0.05f        // minimum value for AHRS_RP_P parameter
#define AG_AHRS_YAW_P_MIN  0.05f        // minimum value for AHRS_YAW_P parameter
...
public:
    ...
    virtual ~AG_AHRS_Backend() {}

    CLASS_NO_COPY(AG_AHRS_Backend);
    ...
    bool airspeed_sensor_enabled(void) const {
        ...
        const AG_Airspeed *_airspeed = AP::airspeed();
