...
#include <AG_Landing/AG_Landing.h>
...
const AG_Param::GroupInfo AG_TECS::var_info[] = {
    ...
    // @Range: 0.1 20.0
    // @User: Standard
    AP_GROUPINFO("CLMB_MAX",    0, AG_TECS, _maxClimbRate, 5.0f),
    ...
    // @Range: 0.1 10.0
    // @User: Standard
    AP_GROUPINFO("SINK_MIN",    1, AG_TECS, _minSinkRate, 2.0f),
    ...
    // @Increment: 0.2
    // @User: Advanced
    AP_GROUPINFO("TIME_CONST",  2, AG_TECS, _timeConst, 5.0f),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("THR_DAMP",    3, AG_TECS, _thrDamp, 0.5f),
    ...
    // @Increment: 0.02
    // @User: Advanced
    AP_GROUPINFO("INTEG_GAIN", 4, AG_TECS, _integGain, 0.3f),
    ...
    // @Increment: 0.5
    // @User: Advanced
    AP_GROUPINFO("VERT_ACC",  5, AG_TECS, _vertAccLim, 7.0f),
    ...
    // @Increment: 0.05
    // @User: Advanced
    AP_GROUPINFO("HGT_OMEGA", 6, AG_TECS, _hgtCompFiltOmega, 3.0f),
    ...
    // @Increment: 0.05
    // @User: Advanced
    AP_GROUPINFO("SPD_OMEGA", 7, AG_TECS, _spdCompFiltOmega, 2.0f),
    ...
    // @Increment: 1.0
    // @User: Advanced
    AP_GROUPINFO("RLL2THR",  8, AG_TECS, _rollComp, 10.0f),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("SPDWEIGHT", 9, AG_TECS, _spdWeight, 1.0f),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("PTCH_DAMP", 10, AG_TECS, _ptchDamp, 0.3f),
    ...
    // @Range: 0.0 20.0
    // @User: Standard
    AP_GROUPINFO("SINK_MAX",  11, AG_TECS, _maxSinkRate, 5.0f),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("LAND_ARSPD", 12, AG_TECS, _landAirspeed, -1),
    ...
    // @Increment: 0.1
    // @User: Standard
    AP_GROUPINFO("LAND_THR", 13, AG_TECS, _landThrottle, -1),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("LAND_SPDWGT", 14, AG_TECS, _spdWeightLand, -1.0f),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("PITCH_MAX", 15, AG_TECS, _pitch_max, 15),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("PITCH_MIN", 16, AG_TECS, _pitch_min, 0),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("LAND_SINK", 17, AG_TECS, _land_sink, 0.25f),
    ...
    // @Increment: 0.2
    // @User: Advanced
    AP_GROUPINFO("LAND_TCONST", 18, AG_TECS, _landTimeConst, 2.0f),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("LAND_DAMP", 19, AG_TECS, _landDamp, 0.5f),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("LAND_PMAX", 20, AG_TECS, _land_pitch_max, 10),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("APPR_SMAX", 21, AG_TECS, _maxSinkRate_approach, 0),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("LAND_SRC", 22, AG_TECS, _land_sink_rate_change, 0),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("LAND_TDAMP", 23, AG_TECS, _land_throttle_damp, 0),
    ...
    // @Increment: 0.02
    // @User: Advanced
    AP_GROUPINFO("LAND_IGAIN", 24, AG_TECS, _integGain_land, 0),
    ...
    // @Increment: 0.02
    // @User: Advanced
    AP_GROUPINFO("TKOFF_IGAIN", 25, AG_TECS, _integGain_takeoff, 0),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("LAND_PDAMP", 26, AG_TECS, _land_pitch_damp, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("SYNAIRSPEED", 27, AG_TECS, _use_synthetic_airspeed, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("OPTIONS", 28, AG_TECS, _options, 0),
    ...
    // @Range: 5.0 50.0
    // @User: Advanced
    AP_GROUPINFO("PTCH_FF_V0", 29, AG_TECS, _pitch_ff_v0, 12.0),
    ...
    // @Range: -5.0 0.0
    // @User: Advanced
    AP_GROUPINFO("PTCH_FF_K", 30, AG_TECS, _pitch_ff_k, 0.0),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("FLARE_HGT", 32, AG_TECS, _flare_holdoff_hgt, 1.0f),
    ...
    // @Increment: 0.2
    // @User: Advanced
    AP_GROUPINFO("HDEM_TCONST", 33, AG_TECS, _hgt_dem_tconst, 3.0f),
...
void AG_TECS::_update_speed(float DT)
{
...
void AG_TECS::_update_speed_demand(void)
{
...
void AG_TECS::_update_height_demand(void)
{
        ...
        if (_flags.is_doing_auto_land) {
            ...
            if (_using_airspeed_for_throttle) {
                ...
                max_climb_condition   |= (_thr_clip_status == clipStatus::MAX) &&
                                            !((_flight_stage == AG_FixedWing::FlightStage::TAKEOFF) || (_flight_stage == AG_FixedWing::FlightStage::ABORT_LANDING));
...
void AG_TECS::_detect_underspeed(void)
{
    ...
    if (_flags.underspeed &&
        ...
        AG_HAL::millis() - _underspeed_start_ms > 3000U) {
        _flags.underspeed = false;
    }

    if (_flight_stage == AG_FixedWing::FlightStage::VTOL) {
        _flags.underspeed = false;
                ...
                ((_height < _hgt_dem) && _flags.underspeed))
    {
        ...
        if (_TAS_state < _TASmin * 0.9f) {
            ...
            _underspeed_start_ms = AG_HAL::millis();
        }
    } else {
...
void AG_TECS::_update_energies(void)
{
 ...
 */
float AG_TECS::timeConstant(void) const
{
    if (_flags.is_doing_auto_land) {
 ...
 */
void AG_TECS::_update_throttle_with_airspeed(void)
{
    ...
    if (_flags.underspeed) {
        ...
        if (_flight_stage == AG_FixedWing::FlightStage::TAKEOFF || _flight_stage == AG_FixedWing::FlightStage::ABORT_LANDING) {
...
float AG_TECS::_get_i_gain(void)
{
 ...
 */
void AG_TECS::_update_throttle_without_airspeed(int16_t throttle_nudge)
{
    ...
    if (_flight_stage == AG_FixedWing::FlightStage::TAKEOFF) {
...
void AG_TECS::_detect_bad_descent(void)
{
...
void AG_TECS::_update_pitch(void)
{
    ...
    if (!(_ahrs.airspeed_sensor_enabled() || _use_synthetic_airspeed)) {
        _SKE_weighting = 0.0f;
    } else if (_flight_stage == AG_FixedWing::FlightStage::VTOL) {
        ...
        _SKE_weighting = 0.0f;
    } else if ( _flags.underspeed || _flight_stage == AG_FixedWing::FlightStage::TAKEOFF || _flight_stage == AG_FixedWing::FlightStage::ABORT_LANDING || _flags.is_gliding) {
        _SKE_weighting = 2.0f;
    } else if (_flags.is_doing_auto_land) {
        if (_spdWeightLand < 0) {
...
void AG_TECS::_initialise_states(int32_t ptchMinCO_cd, float hgt_afe)
{
    _flags.reset = false;
    ...
    } else if (_flight_stage == AG_FixedWing::FlightStage::TAKEOFF || _flight_stage == AG_FixedWing::FlightStage::ABORT_LANDING) {
...
void AG_TECS::_update_STE_rate_lim(void)
{
...
void AG_TECS::update_pitch_throttle(int32_t hgt_dem_cm,
                                    int32_t EAS_dem_cm,
                                    enum AG_FixedWing::FlightStage flight_stage,
                                    ...
                                    float load_factor)
{
    ...
    _flags.is_doing_auto_land = (flight_stage == AG_FixedWing::FlightStage::LAND);
    ...
    if (flight_stage == AG_FixedWing::FlightStage::TAKEOFF || flight_stage == AG_FixedWing::FlightStage::ABORT_LANDING) {
