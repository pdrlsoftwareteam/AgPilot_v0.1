...
bool AG_Mission::start_command_do_aux_function(const AG_Mission::Mission_Command& cmd)
{
...
bool AG_Mission::start_command_do_gripper(const AG_Mission::Mission_Command& cmd)
{
    ...
    default:
        ...
        AG_HAL::panic("Unhandled gripper case");
#endif
        return false;
    }
}
...
bool AG_Mission::start_command_do_servorelayevents(const AG_Mission::Mission_Command& cmd)
{
    AG_ServoRelayEvents *sre = AP::servorelayevents();
    if (sre == nullptr) {
        return false;
    }
    ...
    default:
#if CONFIG_HAL_BOARD == HAL_BOARD_SITL
        AG_HAL::panic("Unhandled servo/relay case");
#endif
        return false;
    }
}
...
bool AG_Mission::start_command_camera(const AG_Mission::Mission_Command& cmd)
{
    ...
    default:
#if CONFIG_HAL_BOARD == HAL_BOARD_SITL
        AG_HAL::panic("Unhandled camera case");
#endif
        return false;
    }
}
...
bool AG_Mission::start_command_parachute(const AG_Mission::Mission_Command& cmd)
{
#if HAL_PARACHUTE_ENABLED
    AG_Parachute *parachute = AP::parachute();
...
bool AG_Mission::command_do_set_repeat_dist(const AG_Mission::Mission_Command& cmd)
{
    _repeat_dist = cmd.p1;
...
bool AG_Mission::start_command_do_sprayer(const AG_Mission::Mission_Command& cmd)
{
...
bool AG_Mission::start_command_do_scripting(const AG_Mission::Mission_Command& cmd)
{
...
bool AG_Mission::start_command_do_gimbal_manager_pitchyaw(const AG_Mission::Mission_Command& cmd)
{
