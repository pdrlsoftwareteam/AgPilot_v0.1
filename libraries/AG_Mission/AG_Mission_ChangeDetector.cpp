/// @file    AG_Mission_ChangeDetector.cpp
/// @brief   Detects changes in the next few nav commands in the mission

#include "AG_Mission_ChangeDetector.h"

#if AP_MISSION_ENABLED

// detect external changes to mission
bool AG_Mission_ChangeDetector::check_for_mission_change()
{
    ...
    AG_Mission::Mission_Command cmd[mis_change_detect_cmd_max];
