...
#include "AG_AdvancedFailsafe_config.h"
...
public:
    ...
    /* Do not allow copies */
    CLASS_NO_COPY(AG_AdvancedFailsafe);
    ...
    static AG_AdvancedFailsafe *get_singleton(void) {
        return _singleton;
    }
...
private:
    static AG_AdvancedFailsafe *_singleton;
