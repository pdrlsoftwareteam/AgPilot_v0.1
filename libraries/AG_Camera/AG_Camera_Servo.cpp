...
void AG_Camera_Servo::update()
{
    ...
    // call parent update
    AG_Camera_Backend::update();
}

// entry point to actually take a picture.  returns true on success
bool AG_Camera_Servo::trigger_pic()
{
...
// configure camera
void AG_Camera_Servo::configure(float shooting_mode, float shutter_speed, float aperture, float ISO, float exposure_type, float cmd_id, float engine_cutoff_time)
{
