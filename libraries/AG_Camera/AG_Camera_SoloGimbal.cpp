...
bool AG_Camera_SoloGimbal::trigger_pic()
{
...
void AG_Camera_SoloGimbal::cam_mode_toggle()
{
...
void AG_Camera_SoloGimbal::handle_message(mavlink_channel_t chan, const mavlink_message_t &msg)
{
