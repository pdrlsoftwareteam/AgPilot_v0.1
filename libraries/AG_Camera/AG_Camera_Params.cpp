...
const AG_Param::GroupInfo AG_Camera_Params::var_info[] = {
    ...
    // @User: Standard
    AP_GROUPINFO_FLAGS("_TYPE",  1, AG_Camera_Params, type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @Range: 0 5
    // @User: Standard
    AP_GROUPINFO("_DURATION", 2, AG_Camera_Params, trigger_duration, 0.1),
    ...
    // @Range: 1000 2000
    // @User: Standard
    AP_GROUPINFO("_SERVO_ON", 3, AG_Camera_Params, servo_on_pwm, 1300),
    ...
    // @Range: 1000 2000
    // @User: Standard
    AP_GROUPINFO("_SERVO_OFF", 4, AG_Camera_Params, servo_off_pwm, 1100),
    ...
    // @Units: m
    // @Range: 0 1000
    AP_GROUPINFO("_TRIGG_DIST", 5, AG_Camera_Params, trigg_dist, 0),
    ...
    // @Values: 0:Low,1:High
    // @User: Standard
    AP_GROUPINFO("_RELAY_ON", 6, AG_Camera_Params, relay_on, 1),
    ...
    // @Range: 0 10
    // @User: Standard
    AP_GROUPINFO("_INTRVAL_MIN", 7, AG_Camera_Params, interval_min, 0),
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO("_FEEDBAK_PIN", 8, AG_Camera_Params, feedback_pin, -1),
    ...
    // @User: Standard
    AP_GROUPINFO("_FEEDBAK_POL", 9, AG_Camera_Params, feedback_polarity, 1),

    AP_GROUPEND

};

AG_Camera_Params::AG_Camera_Params(void) {
