...
public:
    ...
    // do not allow copies
    CLASS_NO_COPY(AG_RunCam);

    // get singleton instance
    static AG_RunCam *get_singleton() {
        return _singleton;
    }
...
private:
    ...
    class Request
    {
        friend class AG_RunCam;

    public:
        Request(AG_RunCam *device, Command commandID, uint8_t param,
        ...
        AG_RunCam *_device; // parent device
    ...
    AG_RunCam::Event map_rc_input_to_event() const;
