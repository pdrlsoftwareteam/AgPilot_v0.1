...
public:
    ...
    // Constructor
    AG_Camera_Backend(AG_Camera &frontend, AG_Camera_Params &params, uint8_t instance);

    /* Do not allow copies */
    CLASS_NO_COPY(AG_Camera_Backend);
...
protected:
    ...
    // references
    AG_Camera &_frontend;       // reference to the front end which holds parameters
    AG_Camera_Params &_params;  // parameters for this backend
