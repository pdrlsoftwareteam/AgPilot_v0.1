...
public:
    AG_RCProtocol() {}
    ~AG_RCProtocol();
    friend class AG_RCProtocol_Backend;
    ...
    // add a UART for RCIN
    void add_uart(AG_HAL::UARTDriver* uart);
    ...
    class SerialConfig {
    public:
        void apply_to_uart(AG_HAL::UARTDriver *uart) const;
...
private:
    ...
    AG_RCProtocol_Backend *backend[NONE];
    bool _new_input;
...
#include "AG_RCProtocol_Backend.h"
