...
class AG_FETtecOneWire : public AG_ESC_Telem_Backend
{
...
public:
    ...
    /// Do not allow copies
    CLASS_NO_COPY(AG_FETtecOneWire);

    static const struct AG_Param::GroupInfo var_info[];

    static AG_FETtecOneWire *get_singleton() {
        return _singleton;
    }
    ...
    /// called from AG_Arming; should return false if arming should be
    /// disallowed
...
private:
    static AG_FETtecOneWire *_singleton;
