...
- control motor speed
- Use the AG_ESC_Telem base class to:
...
See *ESC to ArduPilot Protocol* section below and comments in `AG_FETtecOneWire.cpp` for details.
...
The data is forwarded to the `AG_ESC_Telem` class that distributes it to other parts of the ArduPilot code.
