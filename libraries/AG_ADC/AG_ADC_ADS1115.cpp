...
const uint8_t AG_ADC_ADS1115::_channels_number  = ADS1115_CHANNELS_COUNT;
...
bool AG_ADC_ADS1115::init()
{
    ...
    _dev->register_periodic_callback(100000, FUNCTOR_BIND_MEMBER(&AG_ADC_ADS1115::_update, void));

    return true;
}

bool AG_ADC_ADS1115::_start_conversion(uint8_t channel)
{
    struct PACKED {
        uint8_t reg;
        be16_t val;
...
size_t AG_ADC_ADS1115::read(adc_report_s *report, size_t length) const
{
...
float AG_ADC_ADS1115::_convert_register_data_to_mv(int16_t word) const
{
    ...
    default:
        ...
        AG_HAL::panic("ADS1115: wrong gain selected");
        break;
    }
