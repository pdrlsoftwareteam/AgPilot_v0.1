...
class AG_Mount_Siyi : public AG_Mount_Backend
{

public:
    // Constructor
    using AG_Mount_Backend::AG_Mount_Backend;

    /* Do not allow copies */
    CLASS_NO_COPY(AG_Mount_Siyi);
...
private:
    ...
    // internal variables
    AG_HAL::UARTDriver *_uart;                      // uart connected to gimbal
