...
bool AG_Mount_Servo::has_pan_control() const
{
    return SRV_Channels::function_assigned(_pan_idx) && yaw_range_valid();
}

// get attitude as a quaternion.  returns true on success
bool AG_Mount_Servo::get_attitude_quaternion(Quaternion& att_quat)
{
...
void AG_Mount_Servo::update_angle_outputs(const MountTarget& angle_rad)
{
...
void AG_Mount_Servo::move_servo(uint8_t function_idx, int16_t angle, int16_t angle_min, int16_t angle_max)
{
