...
public:
    // Constructor
    AG_Mount_Backend(AG_Mount &frontend, AG_Mount_Params &params, uint8_t instance) :
        _frontend(frontend),
        _params(params),
        _instance(instance)
    {}
...
protected:
    ...
    AG_Mount    &_frontend; // reference to the front end which holds parameters
    AG_Mount_Params &_params; // parameters for this backend
