...
const AG_Param::GroupInfo AG_Mount_Params::var_info[] = {
    ...
    // @RebootRequired: True
    // @User: Standard
    AP_GROUPINFO_FLAGS("_TYPE", 1, AG_Mount_Params, type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @User: Standard
    AP_GROUPINFO("_DEFLT_MODE", 2, AG_Mount_Params, default_mode, MAV_MOUNT_MODE_RC_TARGETING),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_RC_RATE", 3, AG_Mount_Params, rc_rate_max, 0),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_ROLL_MIN", 4, AG_Mount_Params, roll_angle_min, -30),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_ROLL_MAX", 5, AG_Mount_Params, roll_angle_max, 30),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_PITCH_MIN", 6, AG_Mount_Params, pitch_angle_min, -90),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_PITCH_MAX", 7, AG_Mount_Params, pitch_angle_max, 20),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_YAW_MIN", 8, AG_Mount_Params, yaw_angle_min,  -180),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_YAW_MAX", 9, AG_Mount_Params, yaw_angle_max,  180),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_RETRACT", 10, AG_Mount_Params, retract_angles, 0),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("_NEUTRAL", 11, AG_Mount_Params, neutral_angles, 0),
    ...
    // @Increment: .005
    // @User: Standard
    AP_GROUPINFO("_LEAD_RLL", 12, AG_Mount_Params, roll_stb_lead, 0.0f),
    ...
    // @Increment: .005
    // @User: Standard
    AP_GROUPINFO("_LEAD_PTCH", 13, AG_Mount_Params, pitch_stb_lead, 0.0f),

    AP_GROUPEND
};

AG_Mount_Params::AG_Mount_Params(void) {
