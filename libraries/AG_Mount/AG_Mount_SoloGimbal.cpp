...
AG_Mount_SoloGimbal::AG_Mount_SoloGimbal(AG_Mount &frontend, AG_Mount_Params &params, uint8_t instance) :
    AG_Mount_Backend(frontend, params, instance),
    _gimbal()
{}

// init - performs any required initialisation for this instance
void AG_Mount_SoloGimbal::init()
{
    _initialised = true;
    set_mode((enum MAV_MOUNT_MODE)_params.default_mode.get());
}

void AG_Mount_SoloGimbal::update_fast()
{
    _gimbal.update_fast();
}

// update mount position - should be called periodically
void AG_Mount_SoloGimbal::update()
{
...
bool AG_Mount_SoloGimbal::get_attitude_quaternion(Quaternion& att_quat)
{
    if (!_gimbal.aligned()) {
        return false;
    }
 ...
 */
void AG_Mount_SoloGimbal::handle_gimbal_report(mavlink_channel_t chan, const mavlink_message_t &msg)
{
...
void AG_Mount_SoloGimbal::handle_param_value(const mavlink_message_t &msg)
{
...
/*
  handle a GIMBAL_REPORT message
 */
void AG_Mount_SoloGimbal::handle_gimbal_torque_report(mavlink_channel_t chan, const mavlink_message_t &msg)
{
