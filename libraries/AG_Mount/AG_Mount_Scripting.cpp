...
void AG_Mount_Scripting::update()
{
...
bool AG_Mount_Scripting::healthy() const
{
    // healthy if scripting backend has updated actual angles recently
    return (AG_HAL::millis() - last_update_ms <= AP_MOUNT_SCRIPTING_TIMEOUT_MS);
}

// take a picture.  returns true on success
bool AG_Mount_Scripting::take_picture()
{
    picture_count++;
...
bool AG_Mount_Scripting::record_video(bool start_recording)
{
...
bool AG_Mount_Scripting::set_zoom_step(int8_t zoom_step)
{
...
bool AG_Mount_Scripting::set_manual_focus_step(int8_t focus_step)
{
...
bool AG_Mount_Scripting::set_auto_focus()
{
    manual_focus_step = 0;
...
bool AG_Mount_Scripting::get_rate_target(float& roll_degs, float& pitch_degs, float& yaw_degs, bool& yaw_is_earth_frame)
{
...
bool AG_Mount_Scripting::get_angle_target(float& roll_deg, float& pitch_deg, float& yaw_deg, bool& yaw_is_earth_frame)
{
...
bool AG_Mount_Scripting::get_location_target(Location &_target_loc)
{
    if (target_loc_valid) {
...
void AG_Mount_Scripting::set_attitude_euler(float roll_deg, float pitch_deg, float yaw_bf_deg)
{
...
bool AG_Mount_Scripting::get_camera_state(uint16_t& pic_count, bool& record_video, int8_t& zoom_step, int8_t& focus_step, bool& auto_focus)
{
...
bool AG_Mount_Scripting::get_attitude_quaternion(Quaternion& att_quat)
{
