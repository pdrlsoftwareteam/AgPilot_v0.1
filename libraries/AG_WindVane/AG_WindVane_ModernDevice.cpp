...
// constructor
AG_WindVane_ModernDevice::AG_WindVane_ModernDevice(AG_WindVane &frontend) :
...
void AG_WindVane_ModernDevice::update_speed()
{
...
void AG_WindVane_ModernDevice::calibrate()
{
