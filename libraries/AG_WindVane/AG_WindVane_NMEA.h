...
class AG_WindVane_NMEA : public AG_WindVane_Backend
{
public:
    // constructor
    using AG_WindVane_Backend::AG_WindVane_Backend;

    // initialization
    void init(const AG_SerialManager& serial_manager) override;
