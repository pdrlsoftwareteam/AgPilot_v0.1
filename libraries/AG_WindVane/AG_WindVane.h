...
class AG_WindVane_Backend;

class AG_WindVane
{
    friend class AG_WindVane_Backend;
    friend class AG_WindVane_Home;
    friend class AG_WindVane_Analog;
    friend class AG_WindVane_SITL;
    friend class AG_WindVane_ModernDevice;
    friend class AG_WindVane_Airspeed;
    friend class AG_WindVane_RPM;
    friend class AG_WindVane_NMEA;

public:
    AG_WindVane();

    /* Do not allow copies */
    CLASS_NO_COPY(AG_WindVane);

    static AG_WindVane *get_singleton();
...
private:
    ...
    AG_WindVane_Backend *_direction_driver;
    AG_WindVane_Backend *_speed_driver;
