...
#include <AG_CANManager/AG_CANDriver.h>
...
class AG_PiccoloCAN : public AG_CANDriver, public AG_ESC_Telem_Backend
{
public:
    AG_PiccoloCAN();
    ~AG_PiccoloCAN();
    ...
    static AG_PiccoloCAN *get_pcan(uint8_t driver_index);
