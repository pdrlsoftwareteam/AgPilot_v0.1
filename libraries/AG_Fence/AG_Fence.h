...
public:
    ...
    static AG_Fence *get_singleton() { return _singleton; }
    ...
    AG_PolyFence_loader &polyfence();
    const AG_PolyFence_loader &polyfence() const;
...
private:
    ...
    AG_PolyFence_loader _poly_loader{_total}; // polygon fence
};
