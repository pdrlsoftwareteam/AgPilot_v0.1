...
const AG_Param::GroupInfo AG_Sprayer::var_info[] = {
    // @Param: ENABLE
    // @DisplayName: Sprayer enable/disable
    // @Description: Allows you to enable (1) or disable (0) the sprayer
    // @Values: 0:Disabled,1:Enabled
    // @User: Standard
    AP_GROUPINFO_FLAGS("ENABLE", 0, AG_Sprayer, _enabled, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @Range: 0 100
    // @User: Standard
    AP_GROUPINFO("PUMP_RATE",   1, AG_Sprayer, _pump_pct_1ms, AC_SPRAYER_DEFAULT_PUMP_RATE),
    ...
    // @Range: 1000 2000
    // @User: Standard
    AP_GROUPINFO("SPINNER",     2, AG_Sprayer, _spinner_pwm, AC_SPRAYER_DEFAULT_SPINNER_PWM),
    ...
    // @Range: 0 1000
    // @User: Standard
    AP_GROUPINFO("SPEED_MIN",   3, AG_Sprayer, _speed_min, AC_SPRAYER_DEFAULT_SPEED_MIN),
    ...
    // @Range: 0 100
    // @User: Standard
    AP_GROUPINFO("PUMP_MIN",   4, AG_Sprayer, _pump_min_pct, AC_SPRAYER_DEFAULT_PUMP_MIN),

    AP_GROUPEND
};

AG_Sprayer::AG_Sprayer()
{
    if (_singleton) {
#if CONFIG_HAL_BOARD == HAL_BOARD_SITL
        AG_HAL::panic("Too many sprayers");
#endif
        return;
    }
    _singleton = this;
 ...
 */
AG_Sprayer *AG_Sprayer::_singleton;
AG_Sprayer *AG_Sprayer::get_singleton()
{
    return _singleton;
}

void AG_Sprayer::run(const bool activate)
{
...
AG_Sprayer *sprayer()
{
    return AG_Sprayer::get_singleton();
}
