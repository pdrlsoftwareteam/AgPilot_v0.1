...
void AG_Generator_IE_2400::init()
{
    // Call init from base class to do common setup
    AG_Generator_IE_FuelCell::init();
...
void AG_Generator_IE_2400::assign_measurements(const uint32_t now)
{
...
void AG_Generator_IE_2400::decode_latest_term()
{
...
// Check for failsafes
AG_BattMonitor::Failsafe AG_Generator_IE_2400::update_failsafes() const
{
...
bool AG_Generator_IE_2400::is_critical_error(const uint32_t err_in) const
{
...
bool AG_Generator_IE_2400::is_low_error(const uint32_t err_in) const
{
    switch ((ErrorCode)err_in) {
        // Error codes that lead to critical action battery monitor failsafe
...
bool AG_Generator_IE_2400::check_for_err_code(char* msg_txt, uint8_t msg_len) const
{
...
void AG_Generator_IE_2400::log_write()
{
