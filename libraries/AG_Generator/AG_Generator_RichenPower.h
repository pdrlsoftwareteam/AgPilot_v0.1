...
#include "AG_Generator_Backend.h"
...
class AG_Generator_RichenPower : public AG_Generator_Backend
{

public:
    // constructor
    using AG_Generator_Backend::AG_Generator_Backend;
...
private:
    ...
    uint32_t time_in_idle_state_ms() const {
        ...
        return AG_HAL::millis() - idle_state_start_ms;
    }
