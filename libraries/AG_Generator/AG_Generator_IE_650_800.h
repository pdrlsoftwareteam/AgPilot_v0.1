...
class AG_Generator_IE_650_800 : public AG_Generator_IE_FuelCell
{
    // Inherit constructor
    using AG_Generator_IE_FuelCell::AG_Generator_IE_FuelCell;

public:

    void init(void) override;

    AG_BattMonitor::Failsafe update_failsafes() const override;
