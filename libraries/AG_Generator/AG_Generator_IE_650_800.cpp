...
void AG_Generator_IE_650_800::init()
{
...
void AG_Generator_IE_650_800::assign_measurements(const uint32_t now)
{
    ...
    // Invert bat remaining percent to match AG_BattMonitor convention
...
void AG_Generator_IE_650_800::decode_latest_term()
{
...
bool AG_Generator_IE_650_800::check_for_err_code(char* msg_txt, uint8_t msg_len) const
{
...
// Check for failsafes
AG_BattMonitor::Failsafe AG_Generator_IE_650_800::update_failsafes() const
{
