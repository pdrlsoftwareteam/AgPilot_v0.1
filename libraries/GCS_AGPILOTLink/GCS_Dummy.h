 ...
 */
class GCS_AGPILOTLINK_Dummy : public GCS_AGPILOTLINK
{
public:
...
protected:
    ...
    // dummy information:
    AGPILOT_MODE base_mode() const override { return (AGPILOT_MODE)AGPILOT_MODE_FLAG_CUSTOM_MODE_ENABLED; }
    AGPILOT_STATE vehicle_system_status() const override { return AGPILOT_STATE_CALIBRATING; }
...
protected:
    ...
    GCS_AGPILOTLINK_Dummy *new_gcs_mavlink_backend(GCS_AGPILOTLINK_Parameters &params,
                                               AP_HAL::UARTDriver &uart) override {
        return new GCS_AGPILOTLINK_Dummy(params, uart);
    }
...
private:
    ...
    GCS_AGPILOTLINK_CHAN_METHOD_DEFINITIONS(GCS_AGPILOTLINK_Dummy);

    void send_textv(AGPILOT_SEVERITY severity, const char *fmt, va_list arg_list, uint8_t dest_bitmask) override;

    AGPILOT_TYPE frame_type() const override { return AGPILOT_TYPE_FIXED_WING; }
