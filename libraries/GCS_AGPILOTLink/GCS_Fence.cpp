...
AGPILOT_RESULT GCS_AGPILOTLINK::handle_command_do_fence_enable(const mavlink_command_long_t &packet)
{
#if AP_FENCE_ENABLED
...
void GCS_AGPILOTLINK::handle_fence_message(const mavlink_message_t &msg)
{
#if AP_FENCE_ENABLED
    AC_Fence *fence = AP::fence();
    if (fence == nullptr) {
...
void GCS_AGPILOTLINK::send_fence_status() const
{
#if AP_FENCE_ENABLED
