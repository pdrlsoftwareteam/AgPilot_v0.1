//  GCS Message ID's
/// NOTE: to ensure we never block on sending AGPILOTLink messages
/// please keep each MSG_ to a single AGPILOTLink message. If need be
...
enum ap_message : uint8_t {
    ...
    MSG_ATTITUDE_TARGET,
    MSG_DATA_TRANSFER,
    MSG_LIBNPNT_TRANSFER,
    MSG_ACK_FOR_COMMAND,
    MSG_COMMAND_TRANSFER,
    MSG_HYGROMETER,
