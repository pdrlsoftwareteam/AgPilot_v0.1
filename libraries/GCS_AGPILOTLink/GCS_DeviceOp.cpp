 ...
 */
/*
  handle device operations over AGPILOTLink
 */
 ...
 */
void GCS_AGPILOTLINK::handle_device_op_read(const mavlink_message_t &msg)
{
 ...
 */
void GCS_AGPILOTLINK::handle_device_op_write(const mavlink_message_t &msg)
{
