...
public:
    ...
    AGPILOT_MISSION_TYPE mission_type() const override {
        return AGPILOT_MISSION_TYPE_FENCE;
    }
...
private:
    ...
    AGPILOT_MISSION_RESULT allocate_receive_resources(const uint16_t count) override WARN_IF_UNUSED;
    AGPILOT_MISSION_RESULT allocate_update_resources() override WARN_IF_UNUSED;
