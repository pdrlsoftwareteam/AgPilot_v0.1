...
#error AG_FWVersionDefine.h should never be included directly. You probably want to include AG_Common/AG_FWVersion.h
#endif
 ...
 */
const AG_FWVersion AG_FWVersion::fwver{
