...
#include "AG_ExpandingArray.h"
#include <AG_HAL/AG_HAL.h>

extern const AG_HAL::HAL& hal;

AG_ExpandingArrayGeneric::~AG_ExpandingArrayGeneric(void)
{
    // free chunks
...
bool AG_ExpandingArrayGeneric::expand(uint16_t num_chunks)
{
...
bool AG_ExpandingArrayGeneric::expand_to_hold(uint16_t num_items)
{
