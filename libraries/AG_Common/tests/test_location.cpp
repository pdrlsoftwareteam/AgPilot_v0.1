...
class DummyVehicle {
public:
    bool start_cmd(const AG_Mission::Mission_Command& cmd) { return true; };
    bool verify_cmd(const AG_Mission::Mission_Command& cmd) { return true; };
    void mission_complete() { };
    AG_AHRS ahrs{AG_AHRS::FLAG_ALWAYS_USE_EKF};

    AG_Mission mission{
        FUNCTOR_BIND_MEMBER(&DummyVehicle::start_cmd, bool, const AG_Mission::Mission_Command &),
        FUNCTOR_BIND_MEMBER(&DummyVehicle::verify_cmd, bool, const AG_Mission::Mission_Command &),
