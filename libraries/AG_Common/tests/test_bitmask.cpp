...
TEST(Bitmask, Tests)
{
    ...
    EXPECT_EXIT(x.set(50), testing::KilledBySignal(SIGABRT), "AG_InternalError::error_t::bitmask_range");
#endif
...
#elif CONFIG_HAL_BOARD == HAL_BOARD_SITL
    EXPECT_EXIT(x2.get(50), testing::KilledBySignal(SIGABRT), "AG_InternalError::error_t::bitmask_range");
#endif
}
