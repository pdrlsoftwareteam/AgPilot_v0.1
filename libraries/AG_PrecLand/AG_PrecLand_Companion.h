...
/*
 * AG_PrecLand_Companion - implements precision landing using target vectors provided
...
class AG_PrecLand_Companion : public AG_PrecLand_Backend
{
public:
    // Constructor
    using AG_PrecLand_Backend::AG_PrecLand_Backend;
