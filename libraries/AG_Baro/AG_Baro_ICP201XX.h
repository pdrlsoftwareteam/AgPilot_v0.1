...
class AG_Baro_ICP201XX : public AG_Baro_Backend
{
public:
    void update() override;

    static AG_Baro_Backend *probe(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev);

private:
    AG_Baro_ICP201XX(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev);
