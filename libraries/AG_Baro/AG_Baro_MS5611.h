...
class AG_Baro_MS56XX : public AG_Baro_Backend
{
public:
    ...
    static AG_Baro_Backend *probe_5611(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::Device> dev) {
        return probe(baro, std::move(dev), BARO_MS5611);
    }
    static AG_Baro_Backend *probe_5607(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::Device> dev) {
        return probe(baro, std::move(dev), BARO_MS5607);
    }
    static AG_Baro_Backend *probe_5637(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::Device> dev) {
        return probe(baro, std::move(dev), BARO_MS5637);
    }
    static AG_Baro_Backend *probe_5837(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::Device> dev) {
        return probe(baro, std::move(dev), BARO_MS5837);
    }

    static AG_Baro_Backend *probe(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::Device> dev, enum MS56XX_TYPE ms56xx_type=BARO_MS5611);
...
private:
    ...
    AG_Baro_MS56XX(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::Device> dev, enum MS56XX_TYPE ms56xx_type);
