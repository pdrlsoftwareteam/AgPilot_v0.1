...
AG_Baro_BMP388::AG_Baro_BMP388(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::Device> _dev)
    : AG_Baro_Backend(baro)
    , dev(std::move(_dev))
{
}

AG_Baro_Backend *AG_Baro_BMP388::probe(AG_Baro &baro,
                                       AG_HAL::OwnPtr<AG_HAL::Device> _dev)
{
    ...
    AG_Baro_BMP388 *sensor = new AG_Baro_BMP388(baro, std::move(_dev));
...
bool AG_Baro_BMP388::init()
{
    ...
    // request 50Hz update
    dev->register_periodic_callback(20 * AP_USEC_PER_MSEC, FUNCTOR_BIND_MEMBER(&AG_Baro_BMP388::timer, void));
...
void AG_Baro_BMP388::timer(void)
{
    uint8_t buf[7];
...
void AG_Baro_BMP388::update(void)
{
    WITH_SEMAPHORE(_sem);
 ...
 */
void AG_Baro_BMP388::scale_calibration_data(void)
{
 ...
 */
void AG_Baro_BMP388::update_temperature(uint32_t data)
{
 ...
 */
void AG_Baro_BMP388::update_pressure(uint32_t data)
{
...
*/
bool AG_Baro_BMP388::read_registers(uint8_t reg, uint8_t *data, uint8_t len)
{
