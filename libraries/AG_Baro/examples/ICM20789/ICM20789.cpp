...
static AG_HAL::OwnPtr<AG_HAL::Device> i2c_dev;
static AG_HAL::OwnPtr<AG_HAL::Device> spi_dev;
static AG_HAL::OwnPtr<AG_HAL::Device> dev;
...
static void spi_init()
{
    ...
    spi_dev->set_speed(AG_HAL::Device::SPEED_LOW);
