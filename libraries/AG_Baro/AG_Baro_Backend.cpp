...
// constructor
AG_Baro_Backend::AG_Baro_Backend(AG_Baro &baro) : 
    _frontend(baro) 
{
}

void AG_Baro_Backend::update_healthy_flag(uint8_t instance)
{
...
void AG_Baro_Backend::backend_update(uint8_t instance)
{
    update();
 ...
 */
void AG_Baro_Backend::_copy_to_frontend(uint8_t instance, float pressure, float temperature)
{
    if (instance >= _frontend._num_sensors) {
        return;
    }
 ...
 * rejected. 
*/
bool AG_Baro_Backend::pressure_ok(float press)
{
