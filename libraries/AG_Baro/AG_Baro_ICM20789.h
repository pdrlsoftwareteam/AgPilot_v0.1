...
class AG_Baro_ICM20789 : public AG_Baro_Backend
{
public:
    void update() override;

    static AG_Baro_Backend *probe(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev, AG_HAL::OwnPtr<AG_HAL::Device> dev_imu);
    
private:
    AG_Baro_ICM20789(AG_Baro &baro, AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev, AG_HAL::OwnPtr<AG_HAL::Device> dev_imu);
