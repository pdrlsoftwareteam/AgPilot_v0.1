...
public:
    ...
    virtual void set_logger_backend(class AG_Logger_Backend *backend) {
...
protected:
    ...
    AG_Logger_Backend *_logger_backend = nullptr;
};
...
public:
    ...
    virtual void set_logger_backend(class AG_Logger_Backend *backend) override {
