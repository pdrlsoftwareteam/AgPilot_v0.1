/*
   AG_Logger logging - block oriented variant
 */
#pragma once
...
class AG_Logger_Block : public AG_Logger_Backend {
public:
    AG_Logger_Block(AG_Logger &front, LoggerMessageWriter_DFLogStart *writer);
...
private:
    ...
    void _print_log_formats(AG_HAL::BetterStream *port);
