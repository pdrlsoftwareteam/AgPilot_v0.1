/* 
   AG_Logger logging - MAVLink variant
...
class AG_Logger_MAVLink : public AG_Logger_Backend
{
public:
    // constructor
    AG_Logger_MAVLink(AG_Logger &front, LoggerMessageWriter_DFLogStart *writer) :
    ...
    static AG_Logger_Backend  *probe(AG_Logger &front,
        ...
        return new AG_Logger_MAVLink(front, ls);
    }
...
private:
    ...
    void Write_logger_MAV(AG_Logger_MAVLink &logger);
