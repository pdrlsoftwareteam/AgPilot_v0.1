...
class AG_LoggerTest_AllTypes : public AG_HAL::HAL::Callbacks {
public:
    void setup() override;
    void loop() override;
...
private:
    ...
    void flush_logger(AG_Logger &logger);
};

void AG_LoggerTest_AllTypes::flush_logger(AG_Logger &_logger)
{
    ...
    // writing, 2 seconds, see AG_Logger_File::_io_timer) the data
    // will go out.
...
void AG_LoggerTest_AllTypes::Log_Write_TypeMessages()
{
...
void AG_LoggerTest_AllTypes::Log_Write_TypeMessages_Log_Write()
{
    log_num = logger.find_last_log();
...
void AG_LoggerTest_AllTypes::setup(void)
{
...
void AG_LoggerTest_AllTypes::loop(void)
{
...
static AG_LoggerTest_AllTypes loggertest;

AG_HAL_MAIN_CALLBACKS(&loggertest);
