...
public:
    ...
    static AG_VideoTX *get_singleton(void) {
        return singleton;
    }
    ...
    bool get_configured_pitmode() const { return _options.get() & uint8_t(AG_VideoTX::VideoOptions::VTX_PITMODE); }
    bool get_pitmode() const { return _current_options & uint8_t(AG_VideoTX::VideoOptions::VTX_PITMODE); }
