...
bool NavEKF3_core::InitialiseFilterBootstrap(void)
{
    ...
    if (assume_zero_sideslip() && dal.gps().status(preferred_gps) < AG_DAL_GPS::GPS_OK_FIX_3D) {
 ...
 * See AG_NavEKF3/derivation/main.py for derivation
 * Output for change reference: AG_NavEKF3/derivation/generated/covariance_generated.cpp
...
void NavEKF3_core::calcTiltErrorVariance()
{
    ...
    // equations generated by quaternion_error_propagation(): in AG_NavEKF3/derivation/main.py
