...
void NavEKF3_core::realignYawGPS(bool emergency_reset)
{
    ...
    if (gpsDataDelayed.vel.xy().length_squared() > sq(GPS_VEL_YAW_ALIGN_MIN_SPD)) {
        ...
        if (badMagYaw) {
            ...
            const bool useGSF = !assume_zero_sideslip() || (frontend->sources.getYawSource() == AG_NavEKF_Source::SourceYaw::GSF);
...
void NavEKF3_core::SelectMagFusion()
{
    ...
    if ((yaw_source == AG_NavEKF_Source::SourceYaw::GSF) ||
        (!use_compass() &&
         yaw_source != AG_NavEKF_Source::SourceYaw::GPS &&
         yaw_source != AG_NavEKF_Source::SourceYaw::GPS_COMPASS_FALLBACK &&
         yaw_source != AG_NavEKF_Source::SourceYaw::EXTNAV)) {

        if ((!yawAlignComplete || yaw_source_reset) && ((yaw_source != AG_NavEKF_Source::SourceYaw::GSF) || (EKFGSF_yaw_valid_count >= GSF_YAW_VALID_HISTORY_THRESHOLD))) {
            realignYawGPS(false);
        ...
        if (imuSampleTime_ms - lastSynthYawTime_ms > 140) {
            ...
            const bool didUseEKFGSF = yawAlignComplete && (yaw_source == AG_NavEKF_Source::SourceYaw::GSF) && EKFGSF_getYaw(gsfYaw, gsfYawVariance) && !assume_zero_sideslip() && fuseEulerYaw(yawFusionMethod::GSF);
    ...
    if (yaw_source == AG_NavEKF_Source::SourceYaw::GPS || yaw_source == AG_NavEKF_Source::SourceYaw::GPS_COMPASS_FALLBACK) {
        ...
        if (yaw_source == AG_NavEKF_Source::SourceYaw::GPS) {
            // no fallback
            return;
        }
    ...
    if (yaw_source != AG_NavEKF_Source::SourceYaw::GPS_COMPASS_FALLBACK) {
    ...
    if (magDataToFuse) {
        if (yaw_source_reset && (yaw_source == AG_NavEKF_Source::SourceYaw::COMPASS ||
                                 yaw_source == AG_NavEKF_Source::SourceYaw::GPS_COMPASS_FALLBACK)) {
 ...
 * /AG_NavEKF3/derivation/main.py with output recorded in /AG_NavEKF3/derivation/generated/yaw_generated.cpp
...
bool NavEKF3_core::EKFGSF_resetMainFilterYaw(bool emergency_reset)
{
    ...
    if (EKFGSF_getYaw(yawEKFGSF, yawVarianceEKFGSF)) {
        ...
        if ((frontend->sources.getYawSource() == AG_NavEKF_Source::SourceYaw::GSF) ||
