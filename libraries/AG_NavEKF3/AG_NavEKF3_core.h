...
#include "AG_NavEKF3_feature.h"
#include <AG_Common/Location.h>
#include <AG_Math/AG_Math.h>
#include <AG_Math/vectorN.h>
#include <AG_NavEKF/AG_NavEKF_core_common.h>
#include <AG_NavEKF/AG_NavEKF_Source.h>
#include <AG_NavEKF/EKF_Buffer.h>
#include <AG_InertialSensor/AG_InertialSensor.h>
#include <AG_DAL/AG_DAL.h>

#include "AG_NavEKF/EKFGSF_yaw.h"
...
public:
   ...
   // return the innovation consistency test ratios for the velocity, position, magnetometer and true airspeed measurements
    ...
    bool getVelInnovationsAndVariancesForSource(AG_NavEKF_Source::SourceXY source, Vector3f &innovations, Vector3f &variances) const WARN_IF_UNUSED;
...
private:
    ...
    AG_NavEKF_Source::SourceZ activeHgtSource;  // active height source
    AG_NavEKF_Source::SourceZ prevHgtSource;    // previous height source used to detect changes in source
    ...
    */
    ...
    AG_NavEKF_Source::SourceXY posxy_source_last;   // horizontal position source on previous iteration (used to detect a changes)
    bool posxy_source_reset;                        // true when the horizontal position source has changed but the position has not yet been reset
    AG_NavEKF_Source::SourceYaw yaw_source_last;    // yaw source on previous iteration (used to detect a change)
