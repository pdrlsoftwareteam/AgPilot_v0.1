...
/*
 *   AG_Landing_Deepstall.cpp - Landing logic handler for ArduPlane for deepstall landings
 */
...
const AG_Param::GroupInfo AG_Landing_Deepstall::var_info[] = {
    ...
    // @Units: m/s
    // @User: Advanced
    AP_GROUPINFO("V_FWD", 1, AG_Landing_Deepstall, forward_speed, 1),

    // @Param: SLOPE_A
    // @DisplayName: Deepstall slope a
    // @Description: The a component of distance = a*wind + b
    // @User: Advanced
    AP_GROUPINFO("SLOPE_A", 2, AG_Landing_Deepstall, slope_a, 1),

    // @Param: SLOPE_B
    // @DisplayName: Deepstall slope b
    // @Description: The a component of distance = a*wind + b
    // @User: Advanced
    AP_GROUPINFO("SLOPE_B", 3, AG_Landing_Deepstall, slope_b, 1),
    ...
    // @Units: m
    // @User: Advanced
    AP_GROUPINFO("APP_EXT", 4, AG_Landing_Deepstall, approach_extension, 50),
    ...
    // @Units: m/s
    // @User: Advanced
    AP_GROUPINFO("V_DWN", 5, AG_Landing_Deepstall, down_speed, 2),
    ...
    // @Units: s
    // @User: Advanced
    AP_GROUPINFO("SLEW_SPD", 6, AG_Landing_Deepstall, slew_speed, 0.5),
    ...
    // @Units: PWM
    // @User: Advanced
    AP_GROUPINFO("ELEV_PWM", 7, AG_Landing_Deepstall, elevator_pwm, 1500),
    ...
    // @Units: m/s
    // @User: Advanced
    AP_GROUPINFO("ARSP_MAX", 8, AG_Landing_Deepstall, handoff_airspeed, 15.0),
    ...
    // @Units: m/s
    // @User: Advanced
    AP_GROUPINFO("ARSP_MIN", 9, AG_Landing_Deepstall, handoff_lower_limit_airspeed, 10.0),
    ...
    // @Units: s
    // @User: Advanced
    AP_GROUPINFO("L1", 10, AG_Landing_Deepstall, L1_period, 30.0),
    ...
    // @Range: 0 1
    // @User: Advanced
    AP_GROUPINFO("L1_I", 11, AG_Landing_Deepstall, L1_i, 0),
    ...
    // @Units: deg/s
    // @User: Advanced
    AP_GROUPINFO("YAW_LIM", 12, AG_Landing_Deepstall, yaw_rate_limit, 10),
    ...
    // @Units: s
    // @User: Advanced
    AP_GROUPINFO("L1_TCON", 13, AG_Landing_Deepstall, time_constant, 0.4),
    ...
    // @User: Standard
    AP_SUBGROUPINFO(ds_PID, "", 14, AG_Landing_Deepstall, PID),
    ...
    // @Units: m
    // @User: Advanced
    AP_GROUPINFO("ABORTALT", 15, AG_Landing_Deepstall, min_abort_alt, 0.0f),
    ...
    // @Range: 0 2.0
    // @User: Advanced
    AP_GROUPINFO("AIL_SCL", 16, AG_Landing_Deepstall, aileron_scalar, 1.0f),
...
void AG_Landing_Deepstall::do_land(const AG_Mission::Mission_Command& cmd, const float relative_altitude)
{
...
void AG_Landing_Deepstall::verify_abort_landing(const Location &prev_WP_loc, Location &next_WP_loc, bool &throttle_suppressed)
{
 ...
 */
bool AG_Landing_Deepstall::verify_land(const Location &prev_WP_loc, Location &next_WP_loc, const Location &current_loc,
        ...
        const bool is_armed, const bool is_flying, const bool rangefinder_state_in_range)
{
    ...
    case DEEPSTALL_STAGE_APPROACH:
        ...
        stall_entry_time = AG_HAL::millis();
...
bool AG_Landing_Deepstall::override_servos(void)
{
    ...
    if (slew_speed > 0) {
        slew_progress  = (AG_HAL::millis() - stall_entry_time) / (100.0f * slew_speed);
    }
...
bool AG_Landing_Deepstall::request_go_around(void)
{
...
bool AG_Landing_Deepstall::is_throttle_suppressed(void) const
{
    return stage == DEEPSTALL_STAGE_LAND;
}

bool AG_Landing_Deepstall::is_flying_forward(void) const
{
    return stage != DEEPSTALL_STAGE_LAND;
}

bool AG_Landing_Deepstall::is_on_approach(void) const
{
    return stage == DEEPSTALL_STAGE_LAND;
}

bool AG_Landing_Deepstall::get_target_altitude_location(Location &location)
{
    memcpy(&location, &landing_point, sizeof(Location));
    return true;
}

int32_t AG_Landing_Deepstall::get_target_airspeed_cm(void) const
{
...
bool AG_Landing_Deepstall::send_deepstall_message(mavlink_channel_t chan) const
{
...
const AG_PIDInfo& AG_Landing_Deepstall::get_pid_info(void) const
{
    return ds_PID.get_pid_info();
}

void AG_Landing_Deepstall::Log(void) const {
    const AG_PIDInfo& pid_info = ds_PID.get_pid_info();
    struct log_DSTL pkt = {
...
bool AG_Landing_Deepstall::terminate(void) {
...
void AG_Landing_Deepstall::build_approach_path(bool use_current_heading)
{
...
float AG_Landing_Deepstall::predict_travel_distance(const Vector3f wind, const float height, const bool print)
{
    bool reverse = false;
...
bool AG_Landing_Deepstall::verify_breakout(const Location &current_loc, const Location &target_loc,
...
float AG_Landing_Deepstall::update_steering()
{
