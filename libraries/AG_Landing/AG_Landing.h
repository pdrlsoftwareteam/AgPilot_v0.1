...
#include <AG_TECS/AG_TECS.h>
#include <AG_Navigation/AG_Navigation.h>
#include "AG_Landing_Deepstall.h"
#include <AG_Common/Location.h>

/// @class  AG_Landing
/// @brief  Class managing ArduPlane landing methods
class AG_Landing {
    friend class AG_Landing_Deepstall;
...
public:
    ...
    AG_Landing(AG_Mission &_mission, AG_AHRS &_ahrs, AG_TECS *_tecs_Controller, AG_Navigation *_nav_controller, AG_FixedWing &_aparm,
...
//      TODO: TYPE_HELICAL,
    ...
    void do_land(const AG_Mission::Mission_Command& cmd, const float relative_altitude);
    ...
    void adjust_landing_slope_for_rangefinder_bump(AG_FixedWing::Rangefinder_State &rangefinder_state, Location &prev_WP_loc, Location &next_WP_loc, const Location &current_loc, const float wp_distance, int32_t &target_altitude_offset_cm);
    ...
    void check_if_need_to_abort(const AG_FixedWing::Rangefinder_State &rangefinder_state);
    ...
    void Log(void) const;
    const AG_PIDInfo * get_pid_info(void) const;
...
private:
    ...
    AG_Mission &mission;
    AG_AHRS &ahrs;
    AG_TECS *tecs_Controller;
    AG_Navigation *nav_controller;
    ...
    AG_Landing_Deepstall deepstall;
#endif
    ...
    void type_slope_do_land(const AG_Mission::Mission_Command& cmd, const float relative_altitude);
    ...
    void type_slope_adjust_landing_slope_for_rangefinder_bump(AG_FixedWing::Rangefinder_State &rangefinder_state, Location &prev_WP_loc, Location &next_WP_loc, const Location &current_loc, const float wp_distance, int32_t &target_altitude_offset_cm);
    ...
    void type_slope_check_if_need_to_abort(const AG_FixedWing::Rangefinder_State &rangefinder_state);
