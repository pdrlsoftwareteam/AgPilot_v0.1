...
class AG_BoardConfig {
public:
    AG_BoardConfig();

    /* Do not allow copies */
    CLASS_NO_COPY(AG_BoardConfig);

    // singleton support
    static AG_BoardConfig *get_singleton(void) {
        return _singleton;
    }
...
private:
    static AG_BoardConfig *_singleton;
