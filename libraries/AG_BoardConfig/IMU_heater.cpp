...
void AG_BoardConfig::set_imu_temp(float current)
{
...
bool AG_BoardConfig::get_board_heater_temperature(float &temperature) const
{
...
bool AG_BoardConfig::get_board_heater_arming_temperature(int8_t &temperature) const
{
