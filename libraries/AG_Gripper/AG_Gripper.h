...
#include "AG_Gripper_config.h"

#if AP_GRIPPER_ENABLED

#include <AG_Param/AG_Param.h>

class AG_Gripper_Backend;
...
public:
    ...
    /* Do not allow copies */
    CLASS_NO_COPY(AG_Gripper);

    static AG_Gripper *get_singleton();
    static AG_Gripper *_singleton;
