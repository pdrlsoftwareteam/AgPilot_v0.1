...
#include <stdarg.h>
#include <AG_Common/AG_Common.h> // for FMT_PRINTF
...
public:
    ...
    // get path to custom defaults file for AG_Param
    ...
    // commands
    virtual bool run_debug_shell(AG_HAL::BetterStream *stream) = 0;
     ...
     */
    virtual AG_HAL::BetterStream *get_shell_stream() { return nullptr; }
