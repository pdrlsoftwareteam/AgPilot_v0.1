...
public:
    ...
    virtual void     register_delay_callback(AG_HAL::Proc,
    ...
    virtual void     register_timer_process(AG_HAL::MemberProc) = 0;

    // register a low priority IO task
    virtual void     register_io_process(AG_HAL::MemberProc) = 0;

    virtual void     register_timer_failsafe(AG_HAL::Proc,
    ...
    /*
      create a new thread
     */
    virtual bool thread_create(AG_HAL::MemberProc proc, const char *name,
