...
public:
    ...
    virtual bool wait(uint64_t duration, AG_HAL::EventHandle* evt_handle) = 0;
};

class AG_HAL::EventHandle {
public:
    //Set event source
    virtual bool set_source(AG_HAL::EventSource* src);

    AG_HAL::EventSource* get_source() { return evt_src_; }
