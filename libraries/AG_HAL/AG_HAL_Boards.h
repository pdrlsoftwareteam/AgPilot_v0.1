/**
 * C preprocesor enumeration of the boards supported by the AG_HAL.
...
/* DEFINITIONS FOR BOARDS */
    ...
    #include <AG_HAL/board/sitl.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_LINUX
    #include <AG_HAL/board/linux.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_EMPTY
    #include <AG_HAL/board/empty.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_VRBRAIN
    #include <AG_HAL/board/vrbrain.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS
	#include <AG_HAL/board/chibios.h>
#elif CONFIG_HAL_BOARD == HAL_BOARD_ESP32
    #include <AG_HAL/board/esp32.h>
#else
...
// enable AG_GyroFFT library only if required:
#ifndef HAL_WITH_DSP
...
#define AG_UAVCAN_SLCAN_ENABLED 1
#else
#define AG_UAVCAN_SLCAN_ENABLED 0
#endif
...
#define AG_HAL_SHARED_DMA_ENABLED 1
#endif
