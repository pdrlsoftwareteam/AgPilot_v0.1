 ...
 */
/*
  Simulator for the AGPILOTLink Serial rangefinder
*/

#include "SIM_RF_AGPILOTLink.h"
...
uint32_t RF_AGPILOTLink::packet_for_alt(uint16_t alt_cm, uint8_t *buffer, uint8_t buflen)
{
    ...
    const mavlink_distance_sensor_t distance_sensor{
        ...
        .type = 0,
        .id = 72, // ID
        .orientation = AGPILOT_SENSOR_ROTATION_PITCH_270,
