...
// note that this is re-definition of the one in AG_Airspeed.cpp, can't be shared as vehicle dependences cant go in header files
...
const AG_Param::GroupInfo AG_Airspeed_Params::var_info[] = {
    ...
    // @User: Standard
    AP_GROUPINFO_FLAGS("TYPE", 1, AG_Airspeed_Params, type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @User: Standard
    AP_GROUPINFO("USE", 2, AG_Airspeed_Params, use, 0),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("OFFSET", 3, AG_Airspeed_Params, offset, 0),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("RATIO", 4, AG_Airspeed_Params, ratio, 2),
    ...
    // @User: Advanced
    AP_GROUPINFO("PIN", 5, AG_Airspeed_Params, pin, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("AUTOCAL", 6, AG_Airspeed_Params, autocal, 0),
#endif
    ...
    AP_GROUPINFO("TUBE_ORDR", 7, AG_Airspeed_Params, tube_order, 2),
    ...
    // @User: Advanced
    AP_GROUPINFO("SKIP_CAL", 8, AG_Airspeed_Params, skip_cal, 0),
#endif // HAL_BUILD_AP_PERIPH
    ...
    // @User: Advanced
    AP_GROUPINFO("PSI_RANGE", 9, AG_Airspeed_Params, psi_range, PSI_RANGE_DEFAULT),
    ...
    // @RebootRequired: True
    // @User: Advanced
    AP_GROUPINFO("BUS", 10, AG_Airspeed_Params, bus, 1),
#endif // HAL_BUILD_AP_PERIPH
    ...
    // @ReadOnly: True
    // @User: Advanced
    AP_GROUPINFO_FLAGS("DEVID", 11, AG_Airspeed_Params, bus_id, 0, AP_PARAM_FLAG_INTERNAL_USE_ONLY),

    AP_GROUPEND
};

AG_Airspeed_Params::AG_Airspeed_Params(void)
{
...
AG_Airspeed_Params::AG_Airspeed_Params(void) {};
const AG_Param::GroupInfo AG_Airspeed_Params::var_info[] = { AP_GROUPEND };
