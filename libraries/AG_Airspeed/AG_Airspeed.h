...
#include "AG_Airspeed_config.h"

#include <AG_Param/AG_Param.h>
#include <AG_Math/AG_Math.h>

class AG_Airspeed_Backend;

class AG_Airspeed_Params {
public:
    // Constructor
    AG_Airspeed_Params(void);
...
{
public:
    friend class AG_Airspeed_Backend;
    
    // constructor
    AG_Airspeed();

    void set_fixedwing_parameters(const class AG_FixedWing *_fixed_wing_parameters);
    ...
    static AG_Airspeed *get_singleton() { return _singleton; }
...
private:
    ...
    AG_Airspeed_Params param[AIRSPEED_MAX_SENSORS];
    ...
    AG_Airspeed_Backend *sensor[AIRSPEED_MAX_SENSORS];

    void Log_Airspeed();

    bool add_backend(AG_Airspeed_Backend *backend);
    
    const AG_FixedWing *fixed_wing_parameters;
