...
class AG_Airspeed_MS5525 : public AG_Airspeed_Backend
{
public:
    enum MS5525_ADDR {
        MS5525_ADDR_1    = 0,
    ...
    AG_Airspeed_MS5525(AG_Airspeed &frontend, uint8_t _instance, MS5525_ADDR address);
    ~AG_Airspeed_MS5525(void) {}
