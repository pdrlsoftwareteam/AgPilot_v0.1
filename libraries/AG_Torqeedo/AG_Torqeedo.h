...
class AG_Torqeedo : public AG_ESC_Telem_Backend {
public:
    AG_Torqeedo();

    CLASS_NO_COPY(AG_Torqeedo);

    static AG_Torqeedo* get_singleton();
...
private:
    ...
    // members
    AG_HAL::UARTDriver *_uart;      // serial port to communicate with motor
