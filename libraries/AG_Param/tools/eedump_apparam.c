/*
 * Simple tool to dump the AG_Param contents from an EEPROM dump
 * Andrew Tridgell February 2012
 *
 * Build Command (Assuming starting directory is ardupilot)
 *    gcc -o eedump_ap_param libraries/AG_Param/tools/eedump_apparam.c
 *    gcc -g -o eedump_ap_param libraries/AG_Param/tools/eedump_apparam.c   // With Debugging symbols
 *
 * How to Use?
