...
#include <AG_CSVReader/AG_CSVReader.h>

TEST(AG_CSVReader, basic)
{
    ...
    uint8_t term[16];
    AG_CSVReader csvreader{term, ARRAY_SIZE(term), ' '};
...
TEST(AG_CSVReader, missinglastcr)
{
    static const char *basic_csv =
        "A,1"
        ;
