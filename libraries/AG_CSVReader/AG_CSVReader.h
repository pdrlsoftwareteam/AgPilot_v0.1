...
public:
    ...
    AG_CSVReader(uint8_t *_term, uint8_t _term_len, uint8_t _separator=',') :
...
private:
    ...
    AG_CSVReader::RetCode handle_unquoted_term(uint8_t c);
    AG_CSVReader::RetCode handle_quoted_term(uint8_t c);
};
