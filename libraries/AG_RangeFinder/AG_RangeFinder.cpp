...
#include "AG_RangeFinder_MaxsonarI2CXL.h"
#include "AG_RangeFinder_MaxsonarSerialLV.h"
#include "AG_RangeFinder_LightWareSerial.h"
#if (CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_LINUX_BEBOP || \
     CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_LINUX_DISCO) &&      \
    defined(HAVE_LIBIIO)
#endif
#include "AG_RangeFinder_MAVLink.h"
#include "AG_RangeFinder_USD1_Serial.h"
#include "AG_RangeFinder_TeraRanger_Serial.h"
#include "AG_RangeFinder_VL53L1X.h"
#include "AG_RangeFinder_Benewake_TF02.h"
#include "AG_RangeFinder_Benewake_TF03.h"
#include "AG_RangeFinder_Benewake_TFMini.h"
#include "AG_RangeFinder_Benewake_TFMiniPlus.h"
#include "AG_RangeFinder_PWM.h"
#include "AG_RangeFinder_HC_SR04.h"
#include "AG_RangeFinder_UAVCAN.h"
#include "AG_RangeFinder_LeddarVu8.h"
#include "AG_RangeFinder_SITL.h"
#include "AG_RangeFinder_MSP.h"
#include "AG_RangeFinder_USD1_CAN.h"
#include "AG_RangeFinder_Benewake_CAN.h"
...
const AG_Param::GroupInfo RangeFinder::var_info[] = {

	// @Group: 1_
	// @Path: AG_RangeFinder_Params.cpp
	AP_SUBGROUPINFO(params[0], "1_", 25, RangeFinder, AG_RangeFinder_Params),

    // @Group: 1_
    // @Path: AG_RangeFinder_Wasp.cpp,AG_RangeFinder_Benewake_CAN.cpp,AG_RangeFinder_USD1_CAN.cpp
    AP_SUBGROUPVARPTR(drivers[0], "1_",  57, RangeFinder, backend_var_info[0]),

#if RANGEFINDER_MAX_INSTANCES > 1
    // @Group: 2_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[1], "2_", 27, RangeFinder, AG_RangeFinder_Params),
    ...
    // @Group: 3_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[2], "3_", 29, RangeFinder, AG_RangeFinder_Params),
    ...
    // @Group: 4_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[3], "4_", 31, RangeFinder, AG_RangeFinder_Params),
    ...
    // @Group: 5_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[4], "5_", 33, RangeFinder, AG_RangeFinder_Params),
    ...
    // @Group: 6_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[5], "6_", 35, RangeFinder, AG_RangeFinder_Params),
    ...
    // @Group: 7_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[6], "7_", 37, RangeFinder, AG_RangeFinder_Params),
    ...
    // @Group: 8_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[7], "8_", 39, RangeFinder, AG_RangeFinder_Params),
    ...
    // @Group: 9_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[8], "9_", 41, RangeFinder, AG_RangeFinder_Params),
    ...
    // @Group: A_
    // @Path: AG_RangeFinder_Params.cpp
    AP_SUBGROUPINFO(params[9], "A_", 43, RangeFinder, AG_RangeFinder_Params),
...
const AG_Param::GroupInfo *RangeFinder::backend_var_info[RANGEFINDER_MAX_INSTANCES];
...
RangeFinder::RangeFinder()
{
    ...
    if (_singleton != nullptr) {
        AG_HAL::panic("Rangefinder must be singleton");
    }
...
bool RangeFinder::_add_backend(AG_RangeFinder_Backend *backend, uint8_t instance, uint8_t serial_instance)
{
    if (!backend) {
        return false;
    }
    if (instance >= RANGEFINDER_MAX_INSTANCES) {
        AG_HAL::panic("Too many RANGERS backends");
    }
...
void RangeFinder::detect_instance(uint8_t instance, uint8_t& serial_instance)
{
    ...
    AG_RangeFinder_Backend_Serial *(*serial_create_fn)(RangeFinder::RangeFinder_State&, AG_RangeFinder_Params&) = nullptr;
    ...
    case Type::BenewakeTFminiPlus: {
        ...
        FOREACH_I2C(i) {
            if (_add_backend(AG_RangeFinder_Benewake_TFMiniPlus::detect(state[instance], params[instance],
    ...
    case Type::PX4_PWM:
        ...
        // the backend driver...
        if (AG_RangeFinder_PWM::detect()) {
            _add_backend(new AG_RangeFinder_PWM(state[instance], params[instance], estimated_terrain_height), instance);
        }
#endif
        break;
    case Type::USD1_Serial:
#if AP_RANGEFINDER_USD1_SERIAL_ENABLED
        serial_create_fn = AG_RangeFinder_USD1_Serial::create;
#endif
        break;
    case Type::MAVLink:
#if AP_RANGEFINDER_MAVLINK_ENABLED
        if (AG_RangeFinder_MAVLink::detect()) {
            _add_backend(new AG_RangeFinder_MAVLink(state[instance], params[instance]), instance);
        }
#endif
        break;
    case Type::ANALOG:
        ...
        if (AG_RangeFinder_analog::detect(params[instance])) {
            _add_backend(new AG_RangeFinder_analog(state[instance], params[instance]), instance);
        }
#endif
        break;
    case Type::HC_SR04:
        ...
        if (AG_RangeFinder_HC_SR04::detect(params[instance])) {
            _add_backend(new AG_RangeFinder_HC_SR04(state[instance], params[instance]), instance);
        }
#endif
        break;
    case Type::BenewakeTF02:
#if AP_RANGEFINDER_BENEWAKE_TF02_ENABLED
        serial_create_fn = AG_RangeFinder_Benewake_TF02::create;
#endif
        break;
    case Type::BenewakeTFmini:
#if AP_RANGEFINDER_BENEWAKE_TFMINI_ENABLED
        serial_create_fn = AG_RangeFinder_Benewake_TFMini::create;
#endif
        break;
    case Type::BenewakeTF03:
#if AP_RANGEFINDER_BENEWAKE_TF03_ENABLED
        serial_create_fn = AG_RangeFinder_Benewake_TF03::create;
#endif
        break;
    case Type::TeraRanger_Serial:
#if AP_RANGEFINDER_TERARANGER_SERIAL_ENABLED
        serial_create_fn = AG_RangeFinder_TeraRanger_Serial::create;
#endif
        break;
    case Type::PWM:
#if AP_RANGEFINDER_PWM_ENABLED
    ...
    case Type::SIM:
        ...
        _add_backend(new AG_RangeFinder_SITL(state[instance], params[instance], instance), instance);
#endif
        break;

    case Type::MSP:
#if HAL_MSP_RANGEFINDER_ENABLED
        if (AG_RangeFinder_MSP::detect()) {
            _add_backend(new AG_RangeFinder_MSP(state[instance], params[instance]), instance);
        }
    ...
    case Type::USD1_CAN:
        ...
        _add_backend(new AG_RangeFinder_USD1_CAN(state[instance], params[instance]), instance);
#endif
        break;

    case Type::Radar_H30:
    	_add_backend(new AG_RangeFinder_USD1_CAN(state[instance], params[instance],4,5,0xc8), instance);
    	break;

    case Type::NEW_ALTIMETER:
        _add_backend(new AG_RangeFinder_USD1_CAN(state[instance], params[instance],4,5,0xd6), instance);
        break;

    case Type::UAV_R21_FRONT:
    	_add_backend(new AG_RangeFinder_USD1_CAN(state[instance], params[instance],4,5,0xdc), instance);
		break;

    case Type::UAV_R21_BACK:
        _add_backend(new AG_RangeFinder_USD1_CAN(state[instance], params[instance],4,5,0xdd), instance);
    	break;

    case Type::Benewake_CAN:
#if AP_RANGEFINDER_BENEWAKE_CAN_ENABLED
        _add_backend(new AG_RangeFinder_Benewake_CAN(state[instance], params[instance]), instance);
#endif
        break;

    case Type::Lua_Scripting:
#if AP_SCRIPTING_ENABLED
        _add_backend(new AG_RangeFinder_Lua(state[instance], params[instance]), instance);
#endif
        break;
    ...
    if (serial_create_fn != nullptr) {
        if (AP::serialmanager().have_serial(AG_SerialManager::SerialProtocol_Rangefinder, serial_instance)) {
...
AG_RangeFinder_Backend *RangeFinder::get_backend(uint8_t id) const {
    if (id >= num_instances) {
        return nullptr;
    }
...
{
    AG_RangeFinder_Backend *backend = find_instance(orientation);
    if (backend == nullptr) {
...
AG_RangeFinder_Backend *RangeFinder::find_instance(enum Rotation orientation) const
{
    // first try for a rangefinder that is in range
    for (uint8_t i=0; i<num_instances; i++) {
        AG_RangeFinder_Backend *backend = get_backend(i);
        if (backend != nullptr &&
...
void RangeFinder::Log_RFND() const
{
    ...
    for (uint8_t i=0; i<RANGEFINDER_MAX_INSTANCES; i++) {
        const AG_RangeFinder_Backend *s = get_backend(i);
        if (s == nullptr) {
            continue;
        }
