...
class AG_RangeFinder_MaxsonarSerialLV : public AG_RangeFinder_Backend_Serial
{
...
public:
    ...
    static AG_RangeFinder_Backend_Serial *create(
        ...
        return new AG_RangeFinder_MaxsonarSerialLV(_state, _params);
    }
...
private:
    ...
    AG_RangeFinder_MaxsonarSerialLV(RangeFinder::RangeFinder_State &_state, AG_RangeFinder_Params &_params);
