...
class AG_RangeFinder_VL53L1X : public AG_RangeFinder_Backend
{
...
public:
    ...
    static AG_RangeFinder_Backend *detect(RangeFinder::RangeFinder_State &_state, AG_RangeFinder_Params &_params, AG_HAL::OwnPtr<AG_HAL::I2CDevice> _dev, DistanceMode mode);
...
private:
    ...
    // constructor
    AG_RangeFinder_VL53L1X(RangeFinder::RangeFinder_State &_state, AG_RangeFinder_Params &_params, AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev);
