...
public:
	...
	AG_RangeFinder_Backend(RangeFinder::RangeFinder_State &_state, AG_RangeFinder_Params &_params);

    // we declare a virtual destructor so that RangeFinder drivers can
    // override with a custom destructor if need be
    virtual ~AG_RangeFinder_Backend(void) {}
