...
bool AG_RangeFinder_LeddarVu8::get_reading(float &reading_m)
{
    if (uart == nullptr) {
        return false;
    }
...
uint8_t AG_RangeFinder_LeddarVu8::get_sensor_address() const
{
    if (params.address == 0) {
...
void AG_RangeFinder_LeddarVu8::request_distances()
{
    uint8_t req_buf[] = {
    ...
    last_distance_request_ms = AG_HAL::millis();
}
...
bool AG_RangeFinder_LeddarVu8::parse_byte(uint8_t b, bool &valid_reading, uint16_t &reading_cm)
{
