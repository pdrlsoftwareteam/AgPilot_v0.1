...
/*
 *   AG_RangeFinder_HC_SR04.cpp - rangefinder for HC_SR04 source
 *
...
AG_RangeFinder_HC_SR04::AG_RangeFinder_HC_SR04(RangeFinder::RangeFinder_State &_state, AG_RangeFinder_Params &_params) :
    AG_RangeFinder_Backend(_state, _params)
{
    set_status(RangeFinder::Status::NoData);
}

bool AG_RangeFinder_HC_SR04::check_pins()
{
    check_trigger_pin();
    return check_echo_pin() && trigger_pin > 0;
}

void AG_RangeFinder_HC_SR04::check_trigger_pin()
{
...
bool AG_RangeFinder_HC_SR04::check_echo_pin()
{
...
*/
bool AG_RangeFinder_HC_SR04::detect(AG_RangeFinder_Params &_params)
{
    if (_params.pin == -1) {
        return false;
    }
...
/*
  update distance_cm
 */
void AG_RangeFinder_HC_SR04::update(void)
{
