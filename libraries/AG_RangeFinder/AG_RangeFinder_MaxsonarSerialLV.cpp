...
AG_RangeFinder_MaxsonarSerialLV::AG_RangeFinder_MaxsonarSerialLV(
    RangeFinder::RangeFinder_State &_state,
    AG_RangeFinder_Params &_params):
    AG_RangeFinder_Backend_Serial(_state, _params)
{
    params.scaling.set_default(0.0254f);
}

// read - return last value measured by sensor
bool AG_RangeFinder_MaxsonarSerialLV::get_reading(float &reading_m)
{
    if (uart == nullptr) {
        return false;
    }
