...
AG_RangeFinder_Benewake_TFMiniPlus::AG_RangeFinder_Benewake_TFMiniPlus(
...
AG_RangeFinder_Backend *AG_RangeFinder_Benewake_TFMiniPlus::detect(
        RangeFinder::RangeFinder_State &_state, AG_RangeFinder_Params &_params,
        AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev)
{
    if (!dev) {
        return nullptr;
    ...
    AG_RangeFinder_Benewake_TFMiniPlus *sensor
        = new AG_RangeFinder_Benewake_TFMiniPlus(_state, _params, std::move(dev));
...
bool AG_RangeFinder_Benewake_TFMiniPlus::init()
{
    ...
    _dev->register_periodic_callback(20000,
                                     FUNCTOR_BIND_MEMBER(&AG_RangeFinder_Benewake_TFMiniPlus::timer, void));
...
void AG_RangeFinder_Benewake_TFMiniPlus::update()
{
    WITH_SEMAPHORE(_sem);
...
void AG_RangeFinder_Benewake_TFMiniPlus::process_raw_measure(le16_t distance_raw, le16_t strength_raw,
...
bool AG_RangeFinder_Benewake_TFMiniPlus::check_checksum(uint8_t *arr, int pkt_len)
{
    uint8_t checksum = 0;
    int i;
...
void AG_RangeFinder_Benewake_TFMiniPlus::timer()
{
