...
const AG_Param::GroupInfo AG_RangeFinder_Params::var_info[] = {
    // @Param: TYPE
    ...
    // @User: Standard
    AP_GROUPINFO_FLAGS("TYPE", 1, AG_RangeFinder_Params, type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @User: Standard
    AP_GROUPINFO("PIN",     2, AG_RangeFinder_Params, pin, -1),
    ...
    // @Increment: 0.001
    // @User: Standard
    AP_GROUPINFO("SCALING", 3, AG_RangeFinder_Params, scaling, 3.0f),
    ...
    // @Increment: 0.001
    // @User: Standard
    AP_GROUPINFO("OFFSET",  4, AG_RangeFinder_Params, offset, 0.0f),
    ...
    // @User: Standard
    AP_GROUPINFO("FUNCTION", 5, AG_RangeFinder_Params, function, 0),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MIN_CM",  6, AG_RangeFinder_Params, min_distance_cm, 20),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MAX_CM",  7, AG_RangeFinder_Params, max_distance_cm, 700),
    ...
    // @User: Standard
    AP_GROUPINFO("STOP_PIN", 8, AG_RangeFinder_Params, stop_pin, -1),
    ...
    // @Values: 0:No,1:Yes
    // @User: Standard
    AP_GROUPINFO("RMETRIC", 10, AG_RangeFinder_Params, ratiometric, 1),
    ...
    // @Range: 0 32767
    // @User: Standard
    AP_GROUPINFO("PWRRNG", 11, AG_RangeFinder_Params, powersave_range, 0),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("GNDCLEAR", 12, AG_RangeFinder_Params, ground_clearance_cm, RANGEFINDER_GROUND_CLEARANCE_CM_DEFAULT),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("ADDR", 23, AG_RangeFinder_Params, address, 0),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("POS", 49, AG_RangeFinder_Params, pos_offset, 0.0f),
    ...
    // @User: Advanced
    AP_GROUPINFO("ORIENT", 53, AG_RangeFinder_Params, orientation, AP_RANGEFINDER_DEFAULT_ORIENTATION),

    AP_GROUPEND
};

AG_RangeFinder_Params::AG_RangeFinder_Params(void) {
