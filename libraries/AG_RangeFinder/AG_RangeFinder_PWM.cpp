...
*/
AG_RangeFinder_PWM::AG_RangeFinder_PWM(RangeFinder::RangeFinder_State &_state,
...
*/
bool AG_RangeFinder_PWM::detect()
{
    return true;
}

// read - return last value measured by sensor
bool AG_RangeFinder_PWM::get_reading(float &reading_m)
{
...
bool AG_RangeFinder_PWM::check_pin()
{
...
void AG_RangeFinder_PWM::check_stop_pin()
{
...
bool AG_RangeFinder_PWM::check_pins()
{
    check_stop_pin();
    return check_pin();
}
...
*/
void AG_RangeFinder_PWM::update(void)
{
    ...
    if (!get_reading(state.distance_m)) {
        ...
        if (AG_HAL::millis() - state.last_reading_ms > 200) {
            set_status(RangeFinder::Status::NoData);
        }
        return;
    }
...
bool AG_RangeFinder_PWM::out_of_range(void) const {
