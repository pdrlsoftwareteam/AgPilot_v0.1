...
#define AG_UAVCAN_SW_VERS_MAJOR 1
#define AG_UAVCAN_SW_VERS_MINOR 0

#define AG_UAVCAN_HW_VERS_MAJOR 1
#define AG_UAVCAN_HW_VERS_MINOR 0

#define AG_UAVCAN_MAX_LED_DEVICES 4
...
#define UC_REGISTRY_BINDER(ClassName_, DataType_) \
    class ClassName_ : public AG_UAVCAN::RegistryBinder<DataType_> { \
        typedef void (*CN_Registry)(AG_UAVCAN*, uint8_t, const ClassName_&); \
        public: \
            ClassName_() : RegistryBinder() {} \
            DISABLE_W_CAST_FUNCTION_TYPE_PUSH \
            ClassName_(AG_UAVCAN* uc,  CN_Registry ffunc) : \
...
#define UC_CLIENT_CALL_REGISTRY_BINDER(ClassName_, DataType_) \
    class ClassName_ : public AG_UAVCAN::ClientCallRegistryBinder<DataType_> { \
        typedef void (*CN_Registry)(AG_UAVCAN*, uint8_t, const ClassName_&); \
        public: \
...
class AG_UAVCAN : public AG_CANDriver, public AG_ESC_Telem_Backend {
    friend class AG_UAVCAN_DNA_Server;
public:
    AG_UAVCAN();
    ~AG_UAVCAN();
    ...
    static AG_UAVCAN *get_uavcan(uint8_t driver_index);
    bool prearm_check(char* fail_msg, uint8_t fail_msg_len) const;

    void init(uint8_t driver_index, bool enable_filters) override;
    bool add_interface(AG_HAL::CANIface* can_iface) override;

    uavcan::Node<0>* get_node() { return _node; }
    uint8_t get_driver_index() const { return _driver_index; }

    FUNCTOR_TYPEDEF(ParamGetSetIntCb, bool, AG_UAVCAN*, const uint8_t, const char*, int32_t &);
    FUNCTOR_TYPEDEF(ParamGetSetFloatCb, bool, AG_UAVCAN*, const uint8_t, const char*, float &);
    FUNCTOR_TYPEDEF(ParamSaveCb, void, AG_UAVCAN*,  const uint8_t, bool);
    ...
    protected:
        typedef void (*Registry)(AG_UAVCAN* _ap_uavcan, uint8_t _node_id, const RegistryBinder& _cb);
        AG_UAVCAN* _uc;
        Registry _ffunc;
    ...
    public:
        ...
        RegistryBinder(AG_UAVCAN* uc, Registry ffunc) :
            _uc(uc),
            _ffunc(ffunc),
            msg(nullptr) {}
    ...
    protected:
        typedef void (*ClientCallRegistry)(AG_UAVCAN* _ap_uavcan, uint8_t _node_id, const ClientCallRegistryBinder& _cb);
        AG_UAVCAN* _uc;
    ...
    public:
        ...
        ClientCallRegistryBinder(AG_UAVCAN* uc, ClientCallRegistry ffunc) :
            _uc(uc),
            _ffunc(ffunc),
            rsp(nullptr) {}
...
private:
    ...
    AG_UAVCAN_DNA_Server *_dna_server;
    ...
    struct {
        led_device devices[AG_UAVCAN_MAX_LED_DEVICES];
    ...
    // send GNSS Fix and yaw, same thing AG_GPS_UAVCAN would receive
    void gnss_send_fix();
    void gnss_send_yaw();
    ...
    */
    ...
    static void handle_hobbywing_GetEscID(AG_UAVCAN* ap_uavcan, uint8_t node_id, const HobbywingESCIDCb &cb);
    static void handle_hobbywing_StatusMsg1(AG_UAVCAN* ap_uavcan, uint8_t node_id, const HobbywingStatus1Cb &cb);
    static void handle_hobbywing_StatusMsg2(AG_UAVCAN* ap_uavcan, uint8_t node_id, const HobbywingStatus2Cb &cb);
#endif // AP_DRONECAN_HOBBYWING_ESC_ENABLED

#if AP_DRONECAN_HIMARK_SERVO_ENABLED
    bool himark_enabled;
    static void handle_himark_servoinfo(AG_UAVCAN* ap_uavcan, uint8_t node_id, const HimarkServoInfoCb &cb);
#endif
    
    // incoming button handling
    static void handle_button(AG_UAVCAN* ap_uavcan, uint8_t node_id, const ButtonCb &cb);
    static void handle_traffic_report(AG_UAVCAN* ap_uavcan, uint8_t node_id, const TrafficReportCb &cb);
    static void handle_actuator_status(AG_UAVCAN* ap_uavcan, uint8_t node_id, const ActuatorStatusCb &cb);
    static void handle_actuator_status_Volz(AG_UAVCAN* ap_uavcan, uint8_t node_id, const ActuatorStatusVolzCb &cb);
    static void handle_ESC_status(AG_UAVCAN* ap_uavcan, uint8_t node_id, const ESCStatusCb &cb);
    static bool is_esc_data_index_valid(const uint8_t index);
    static void handle_debug(AG_UAVCAN* ap_uavcan, uint8_t node_id, const DebugCb &cb);
    static void handle_param_get_set_response(AG_UAVCAN* ap_uavcan, uint8_t node_id, const ParamGetSetCb &cb);
    static void handle_param_save_response(AG_UAVCAN* ap_uavcan, uint8_t node_id, const ParamExecuteOpcodeCb &cb);
};
