...
#include <AG_ONVIF/onvifDeviceBindingProxy.h>
#include <AG_ONVIF/onvifMediaBindingProxy.h>
#include <AG_ONVIF/onvifPTZBindingProxy.h>
...
public:
    ...
    static AG_ONVIF *get_singleton() { return _singleton; }
