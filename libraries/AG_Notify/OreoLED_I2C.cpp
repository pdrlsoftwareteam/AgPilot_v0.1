...
bool OreoLED_I2C::mode_failsafe_radio()
{
    ...
    return AG_Notify::flags.failsafe_radio;
}
...
bool OreoLED_I2C::mode_failsafe_gcs()
{
    ...
    return AG_Notify::flags.failsafe_gcs;
}
...
bool OreoLED_I2C::mode_failsafe_batt()
{
    ...
    return AG_Notify::flags.failsafe_battery;
}
...
bool OreoLED_I2C::mode_auto_flight()
{
    ...
    case OreoLED_Aircraft:
        ...
        if ((AG_Notify::flags.pre_arm_check && AG_Notify::flags.pre_arm_gps_check) || AG_Notify::flags.armed) {
    ...
    return AG_Notify::flags.autopilot_mode;
}
