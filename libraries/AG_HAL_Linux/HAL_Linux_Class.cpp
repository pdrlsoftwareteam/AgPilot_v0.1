...
#include <AG_HAL/utility/RCOutput_Tap.h>
...
void HAL_Linux::run(int argc, char* const argv[], Callbacks* callbacks) const
{
    ...
    // NOTE: See commit 9f5b4ffca ("AG_HAL_Linux_Class: Correct
    ...
    if (module_path != nullptr) {
        AG_Module::init(module_path);
    }
#endif

#if AP_MODULE_SUPPORTED
    AG_Module::call_hook_setup_start();
#endif
    callbacks->setup();
#if AP_MODULE_SUPPORTED
    AG_Module::call_hook_setup_complete();
#endif
