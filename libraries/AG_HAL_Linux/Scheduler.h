...
class Scheduler : public AG_HAL::Scheduler {
public:
    Scheduler();

    static Scheduler *from(AG_HAL::Scheduler *scheduler) {
...
private:
    ...
    AG_HAL::MemberProc _timer_proc[LINUX_SCHEDULER_MAX_TIMER_PROCS];
    uint8_t _num_timer_procs;
    volatile bool _in_timer_proc;

    AG_HAL::MemberProc _io_proc[LINUX_SCHEDULER_MAX_IO_PROCS];
