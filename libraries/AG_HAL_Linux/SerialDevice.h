...
public: 
    ...
    virtual AG_HAL::UARTDriver::flow_control get_flow_control(void) { return AG_HAL::UARTDriver::FLOW_CONTROL_ENABLE; }
    virtual void set_flow_control(AG_HAL::UARTDriver::flow_control flow_control_setting)
    {
