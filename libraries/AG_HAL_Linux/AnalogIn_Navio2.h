...
class AnalogSource_Navio2: public AG_HAL::AnalogSource {
public:
...
class AnalogIn_Navio2: public AG_HAL::AnalogIn {
public:
    AnalogIn_Navio2();
    void init() override;
...
private:
    ...
    AG_HAL::AnalogSource *_board_voltage_pin = nullptr;
    AG_HAL::AnalogSource *_servorail_pin = nullptr;
