...
class RCOutput_Disco : public AG_HAL::RCOutput {
public:
    RCOutput_Disco(AG_HAL::OwnPtr<AG_HAL::I2CDevice> dev);
    ~RCOutput_Disco() {}

    static RCOutput_Bebop *from(AG_HAL::RCOutput *rcoutput)
    {
        // this is used by AG_BattMonitor_Bebop to get obs data. We
