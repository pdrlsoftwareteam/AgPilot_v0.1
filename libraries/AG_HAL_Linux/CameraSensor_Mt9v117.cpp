...
{
    if (!_dev) {
        AG_HAL::panic("Could not find I2C bus for CameraSensor_Mt9v117");
    }
    ...
    case MT9V117_QVGA:
        ...
        break;
    default:
        AG_HAL::panic("mt9v117: unsupported resolution\n");
        break;
    }
...
{
    AG_HAL::DigitalSource *gpio_source;
    uint16_t id;
    ...
    if (id != MT9V117_CHIP_ID) {
        AG_HAL::panic("Mt9v117: bad chip id 0x%04x\n", id);
    }
    _soft_reset();
    _apply_patch();
    _set_basic_settings();
