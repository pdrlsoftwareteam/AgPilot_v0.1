...
class DigitalSource_Sysfs : public AG_HAL::DigitalSource {
...
/**
 * Generic implementation of AG_HAL::GPIO for Linux based boards.
 */
class GPIO_Sysfs : public AG_HAL::GPIO {
...
public:
    ...
    static GPIO_Sysfs *from(AG_HAL::GPIO *gpio) {
     ...
     * pointer.
     */
    AG_HAL::DigitalSource *channel(uint16_t vpin) override;
