/*
 * PDRLFlashProgramHelper.h
 *
 *  Created on: 26-May-2025
 *      Author: kunal
 */

#ifndef LIBRARIES_PDRL_FWBACKUP_PDRLFLASHPROGRAMHELPER_H_
#define LIBRARIES_PDRL_FWBACKUP_PDRLFLASHPROGRAMHELPER_H_

#include "AP_FlashIface/AP_FlashIface_Abstract.h"

class PDRL_FlashProgramHelper : public AP_FlashIface
{
public:
    bool init() override;
...
#endif /* LIBRARIES_PDRL_FWBACKUP_PDRLFLASHPROGRAMHELPER_H_ */
